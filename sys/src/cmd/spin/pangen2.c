...
static void
new_case(Element *e, int m, int b)
{	int j; CaseCache *nc;
...
{	Lextok *v; extern int runsafe;
	...
	case   NAME: return (n->sym->context || (n->sym->hidden&64))?0:1;
