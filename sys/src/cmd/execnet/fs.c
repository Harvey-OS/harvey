 ...
 *			ctl				control messages (like
 *connect)
 *			data				data
 *			err				errors
 *			local				local address (pid of
 *command)
...
Tab tab[] = {
    "/",     DMDIR | 0555, "exec",   DMDIR | 0555, "clone",  0666,
    nil,     DMDIR | 0555, "ctl",    0666,         "data",   0666,
...
char* statusstr[] = {
    "Closed", "Exec", "Established", "Hangup",
};
