...
static void
_memline(Memimage* dst, Point p0, Point p1, int end0, int end1, int radius,
...
static void
llineop(Memimage* dst, Rectangle screenr, Rectangle clipr, void* etc,
        int insave)
{
	struct Lline* ll;
	Point p0, p1;
...
void
memline(Memimage* dst, Point p0, Point p1, int end0, int end1, int radius,
