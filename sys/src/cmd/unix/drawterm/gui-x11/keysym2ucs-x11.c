...
static struct codepair {
...
} keysymtab[] =
    {
     ...
     {0x04de, 0x309b}, /*                 voicedsound ゛ KATAKANA-HIRAGANA
                          VOICED SOUND MARK */
     ...
     {0x05c2,
      0x0622}, /*          Arabic_maddaonalef آ ARABIC LETTER ALEF WITH MADDA
                  ABOVE */
     {0x05c3,
      0x0623}, /*          Arabic_hamzaonalef أ ARABIC LETTER ALEF WITH HAMZA
                  ABOVE */
     {0x05c4, 0x0624}, /*           Arabic_hamzaonwaw ؤ ARABIC LETTER WAW WITH
                          HAMZA ABOVE */
     {0x05c5,
      0x0625}, /*       Arabic_hamzaunderalef إ ARABIC LETTER ALEF WITH HAMZA
                  BELOW */
     ...
     {0x06b4,
      0x0404}, /*                Ukrainian_IE Є CYRILLIC CAPITAL LETTER
                  UKRAINIAN IE */
     {0x06b5,
      0x0405}, /*               Macedonia_DSE Ѕ CYRILLIC CAPITAL LETTER DZE */
     {0x06b6,
      0x0406}, /*                 Ukrainian_I І CYRILLIC CAPITAL LETTER
                  BYELORUSSIAN-UKRAINIAN I */
     {0x06b7,
     ...
     {0x06f8,
      0x042c}, /*           Cyrillic_SOFTSIGN Ь CYRILLIC CAPITAL LETTER SOFT
                  SIGN */
     {0x06f9,
     ...
     {0x06ff,
      0x042a}, /*           Cyrillic_HARDSIGN Ъ CYRILLIC CAPITAL LETTER HARD
                  SIGN */
     ...
     {0x07a2, 0x0388}, /*         Greek_EPSILONaccent Έ GREEK CAPITAL LETTER
                          EPSILON WITH TONOS */
     {0x07a3,
      0x0389}, /*             Greek_ETAaccent Ή GREEK CAPITAL LETTER ETA WITH
                  TONOS */
     {0x07a4, 0x038a}, /*            Greek_IOTAaccent Ί GREEK CAPITAL LETTER
                          IOTA WITH TONOS */
     ...
     {0x07b1,
      0x03ac}, /*           Greek_alphaaccent ά GREEK SMALL LETTER ALPHA WITH
                  TONOS */
     ...
     {0x07b3, 0x03ae}, /*             Greek_etaaccent ή GREEK SMALL LETTER ETA
                          WITH TONOS */
     {0x07b4,
      0x03af}, /*            Greek_iotaaccent ί GREEK SMALL LETTER IOTA WITH
                  TONOS */
     {0x07b5,
      0x03ca}, /*          Greek_iotadieresis ϊ GREEK SMALL LETTER IOTA WITH
                  DIALYTIKA */
     {0x07b6,
      0x0390}, /*    Greek_iotaaccentdieresis ΐ GREEK SMALL LETTER IOTA WITH
                  DIALYTIKA AND TONOS */
     ...
     {0x07bb,
      0x03ce}, /*           Greek_omegaaccent ώ GREEK SMALL LETTER OMEGA WITH
                  TONOS */
     {0x07c1,
     ...
     {0x08a2,
      0x250c}, /*              topleftradical ┌ BOX DRAWINGS LIGHT DOWN AND
                  RIGHT */
     {0x08a3,
     ...
     {0x09e9, 0x240b}, /*                          vt ␋ SYMBOL FOR VERTICAL
                          TABULATION */
     {0x09ea, 0x2518}, /*              lowrightcorner ┘ BOX DRAWINGS LIGHT UP
                          AND LEFT */
     {0x09eb, 0x2510}, /*               uprightcorner ┐ BOX DRAWINGS LIGHT DOWN
                          AND LEFT */
     {0x09ec,
      0x250c}, /*                upleftcorner ┌ BOX DRAWINGS LIGHT DOWN AND
                  RIGHT */
     {0x09ed, 0x2514}, /*               lowleftcorner └ BOX DRAWINGS LIGHT UP
                          AND RIGHT */
     ...
     {0x09f6, 0x2534}, /*                        bott ┴ BOX DRAWINGS LIGHT UP
                          AND HORIZONTAL */
     {0x09f7,
      0x252c}, /*                        topt ┬ BOX DRAWINGS LIGHT DOWN AND
                  HORIZONTAL */
     {0x09f8,
     ...
     {0x0de3, 0x0e43}, /*          Thai_saraaimaimuan ใ THAI CHARACTER SARA AI
                          MAIMUAN */
     ...
     {0x0edc, 0x11b0}, /*        Hangul_J_RieulKiyeog ᆰ HANGUL JONGSEONG
                          RIEUL-KIYEOK */
     {0x0edd,
     ...
     {0x0ee0, 0x11b4}, /*         Hangul_J_RieulTieut ᆴ HANGUL JONGSEONG
                          RIEUL-THIEUTH */
     {0x0ee1, 0x11b5}, /*        Hangul_J_RieulPhieuf ᆵ HANGUL JONGSEONG
                          RIEUL-PHIEUPH */
     {0x0ee2,
     ...
     {0x0ef4, 0x3184}, /*   Hangul_SunkyeongeumPhieuf ㆄ HANGUL LETTER
                          KAPYEOUNPHIEUPH */
     {0x0ef5,
