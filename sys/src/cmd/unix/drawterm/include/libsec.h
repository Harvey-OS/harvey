...
DigestState* hmac_md5(uchar*, uint32_t, uchar*, uint32_t, uchar*, DigestState*);
...
void genprime(mpint* p, int n,
              int accuracy); // generate an n bit probable prime
void gensafeprime(mpint* p, mpint* alpha, int n,
                  int accuracy); // prime and generator
void genstrongprime(mpint* p, int n,
                    int accuracy); // generate an n bit strong prime
...
uchar* X509gen(RSApriv* priv, char* subj, uint32_t valid[2], int* certlen);
