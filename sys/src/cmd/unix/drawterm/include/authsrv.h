...
enum { ANAMELEN = 28, /* maximum size of name in previous proto */
       ...
       OKEYDBLEN = ANAMELEN + DESKEYLEN + 4 +
	           2, /* length of an entry in old key file */
       KEYDBLEN = OKEYDBLEN + SECRETLEN, /* length of an entry in key file */
       OMD5LEN = 16,
};

/* encryption numberings (anti-replay) */
enum { AuthTreq = 1,    /* ticket request */
 ...
 *  Nvram interface
 */
enum { NVwrite = 1 << 0,      /* always prompt and rewrite nvram */
