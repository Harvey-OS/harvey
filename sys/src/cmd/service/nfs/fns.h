...
int	getdnsdom(ulong, void*, int);
int	getdom(ulong, void*, int);
ulong	getip(void*, int);
...
Fid*	newfid(Session*);
long	niread(int, void*, long);
long	niwrite(int, void*, long);
Unixidmap*	pair2idmap(char*, char*);
void	panic(char*, ...);
...
void	strprint(int);
char*	strstore(char*);
int	system(Waitmsg*, char*, char**);
int	systeml(Waitmsg*, char*, ...);
void	unlock(Lock*);
...
Xfile*	xfile(ulong, void*, int);
int	xfopen(Xfid*, int);
int	xfpurgeuid(Session*, char*);
Xfile*	xfroot(void*, int);
int	xfstat(Xfid*, Dir*);
