...
SmbOpTableEntry smboptable[256] = {
    [SMB_COM_CREATE_DIRECTORY] {
	    "SMB_COM_CREATE_DIRECTORY", smbcomcreatedirectory
    },
    [SMB_COM_DELETE_DIRECTORY] {
	    "SMB_COM_DELETE_DIRECTORY", smbcomdeletedirectory
    },
    ...
    [SMB_COM_QUERY_INFORMATION] {
	    "SMB_COM_QUERY_INFORMATION", smbcomqueryinformation
    },
    [SMB_COM_SET_INFORMATION] {
	    "SMB_COM_SET_INFORMATION", smbcomsetinformation
    },
    ...
    [SMB_COM_CHECK_DIRECTORY] {
	    "SMB_COM_CHECK_DIRECTORY", smbcomcheckdirectory
    },
    ...
    [SMB_COM_QUERY_INFORMATION2] {
	    "SMB_COM_QUERY_INFORMATION2", smbcomqueryinformation2
    },
    ...
    [SMB_COM_TREE_DISCONNECT] {
	    "SMB_COM_TREE_DISCONNECT", smbcomtreedisconnect
    },
    [SMB_COM_NEGOTIATE] { "SMB_COM_NEGOTIATE", smbnegotiate },
    [SMB_COM_SESSION_SETUP_ANDX] {
	    "SMB_COM_SESSION_SETUP_ANDX", smbcomsessionsetupandx
    },
    [SMB_COM_LOGOFF_ANDX] { "SMB_COM_LOGOFF_ANDX", nil },
    [SMB_COM_TREE_CONNECT_ANDX] {
	    "SMB_COM_TREE_CONNECT_ANDX", smbcomtreeconnectandx
    },
...
SmbTrans2OpTableEntry smbtrans2optable[] = {
    ...
    [SMB_TRANS2_QUERY_FS_INFORMATION] {
	    "SMB_TRANS2_QUERY_FS_INFORMATION", smbtrans2queryfsinformation
    },
    [SMB_TRANS2_SET_FS_INFORMATION] { "SMB_TRANS2_SET_FS_INFORMATION", nil },
    [SMB_TRANS2_QUERY_PATH_INFORMATION] {
	    "SMB_TRANS2_QUERY_PATH_INFORMATION", smbtrans2querypathinformation
    },
    [SMB_TRANS2_SET_PATH_INFORMATION] {
	    "SMB_TRANS2_SET_PATH_INFORMATION", smbtrans2setpathinformation
    },
    [SMB_TRANS2_QUERY_FILE_INFORMATION] {
	    "SMB_TRANS2_QUERY_FILE_INFORMATION", smbtrans2queryfileinformation
    },
    [SMB_TRANS2_SET_FILE_INFORMATION] {
	    "SMB_TRANS2_SET_FILE_INFORMATION", smbtrans2setfileinformation
    },
    ...
    [SMB_TRANS2_REPORT_DFS_INCONSISTENCY] {
	    "SMB_TRANS2_REPORT_DFS_INCONSISTENCY", nil
    },
};
