...
\ifx\initex\undefined  \def\initex{} % next lines are skipped if format loaded
  ...
  \font\bigtrip=trip at 20pt \textfont3=\bigtrip % this will be extension font
...
\tracingcommands2\tracingrestores+2\write-1{log file only}
...
{\output{\dimen 9=\ht200\count5=\dimen9\global\countz=\outputpenalty
  ...
  \kern-50pt
  A\hfill\vadjust{\special{\the\prevdepth}\penalty-5000}%
...
\message{\fontname\ip}
\rip
\textfont1=\font \scriptfont1=\smalltrip \scriptscriptfont1=\bigtrip % [sick]
...
\global\postdisplaypenalty-\predisplaysize*
...
\endt\def\test#1{\let\test= }\test. \show\test
...
\def\trap#1{\def#1{danger}\global\let\trap#1\show#1\trap}\def\unbalanced
  {\halign\lb}\unbalanced#\cr\relax\expandafter\trap\cr\show\cr\trap}
