...
#define noptions ( 3 ) 
  ...
  do {
    ...
    {
      printversionandexit ( "This is PLtoTF, Version 3.5" , nil , "D.E. Knuth" 
      ) ;
    } 
...
#endif
{
  ...
  if ( verbose ) 
  {
    Fputs(stdout, "This is PLtoTF, Version 3.5" ) ;
    fprintf(stdout, "%s\n", versionstring ) ;
  } 
...
#endif
{
  ...
  r = 8 ;
      ...
      
    {
      if ( charsonline > 0 ) 
      fprintf(stdout, "%c\n", ' ' ) ;
      Fputs(stdout, "An octal (\"O\") or hex (\"H\") value is needed here" ) ;
      showerrorcontext () ;
    } 
    do {
	getnext () ;
