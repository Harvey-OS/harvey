...
maxheaderbytes=100;vfsize=50000;maxstack=100;maxparamwords=30;
maxligsteps=32000;maxkerns=15000;hashsize=15077;{:3}type{23:}
byte=0..255;ASCIIcode=32..127;{:23}{66:}fourbytes=record b0:byte;
b1:byte;b2:byte;b3:byte;end;{:66}{71:}fixword=integer;{:71}{78:}
headerindex=0..maxheaderbytes;indx=0..32767;{:78}{81:}pointer=0..1032;
{:81}var{5:}vplfile:text;{:5}{21:}vffile:packed file of 0..255;
tfmfile:packed file of 0..255;{:21}{24:}xord:array[char]of ASCIIcode;
{:24}{27:}line:integer;goodindent:integer;indent:integer;level:integer;
{:27}{29:}leftln,rightln:boolean;limit:0..bufsize;loc:0..bufsize;
buffer:array[1..bufsize]of char;inputhasended:boolean;{:29}{31:}
charsonline:0..8;{:31}{36:}curchar:ASCIIcode;{:36}{44:}
start:array[1..100]of 0..666;dictionary:array[0..666]of ASCIIcode;
startptr:0..100;dictptr:0..666;{:44}{46:}
curname:array[1..20]of ASCIIcode;namelength:0..20;nameptr:0..100;{:46}
{47:}nhash:array[0..140]of 0..100;curhash:0..140;{:47}{52:}
equiv:array[0..100]of byte;curcode:byte;{:52}{67:}curbytes:fourbytes;
zerobytes:fourbytes;{:67}{75:}fractiondigits:array[1..7]of integer;{:75}
{77:}headerbytes:array[headerindex]of byte;headerptr:headerindex;
...
{89:}indexvar:array[pointer]of byte;excess:byte;{:89}{91:}c:byte;
...
extralocneeded:boolean;{:167}{175:}vcount:integer;{:175}{186:}
verbose:cinttype;{:186}{189:}vplname,tfmname,vfname:cstring;{:189}{182:}
...
longoptions[currentoption].val:=0;currentoption:=currentoption+1;{:183}
{184:}longoptions[currentoption].name:='version';
longoptions[currentoption].hasarg:=0;longoptions[currentoption].flag:=0;
longoptions[currentoption].val:=0;currentoption:=currentoption+1;{:184}
{185:}longoptions[currentoption].name:='verbose';
longoptions[currentoption].hasarg:=0;
longoptions[currentoption].flag:=addressof(verbose);
longoptions[currentoption].val:=1;currentoption:=currentoption+1;{:185}
{188:}longoptions[currentoption].name:=0;
longoptions[currentoption].hasarg:=0;longoptions[currentoption].flag:=0;
...
end else if getoptreturnval=63 then begin usage(1,'vptovf');
...
printversionandexit('This is VPtoVF, Version 1.4',nil,'D.E. Knuth');end;
...
usage(1,'vptovf');end;vplname:=extendfilename(cmdline(optind),'vpl');
...
'tfm');end else begin tfmname:=extendfilename(cmdline(optind+1),'tfm');
end;end else begin vfname:=basenamechangesuffix(vplname,'.vpl','.vf');
tfmname:=basenamechangesuffix(vplname,'.vpl','.tfm');end;end;{:182}
procedure initialize;var{25:}k:integer;{:25}{48:}h:0..140;{:48}{79:}
d:headerindex;{:79}{83:}c:byte;{:83}begin kpsesetprogname(argv[0]);
parsearguments;{6:}reset(vplfile,vplname);
if verbose then begin write('This is VPtoVF, Version 1.4');
writeln(versionstring);end;{:6}{22:}rewritebin(vffile,vfname);
...
begin if fabs(x/designunits)>=16.0 then begin write(
