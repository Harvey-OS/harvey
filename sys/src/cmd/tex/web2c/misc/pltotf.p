...
maxheaderbytes=100;maxparamwords=30;maxligsteps=32500;maxkerns=15000;
hashsize=15077;{:3}type{17:}byte=0..255;ASCIIcode=32..127;{:17}{57:}
...
tfmfile:packed file of 0..255;{:15}{18:}xord:array[char]of ASCIIcode;
...
{79:}indexvar:array[pointer]of byte;excess:byte;{:79}{81:}c:byte;{:81}
{98:}lkstepended:boolean;krnptr:0..maxkerns;{:98}{109:}
sevenunsafe:boolean;{:109}{114:}delta:fixword;{:114}{118:}
ligptr:0..maxligsteps;hash:array[0..hashsize]of 0..66048;
...
ec:byte;lh:byte;lf:0..32767;notfound:boolean;tempwidth:fixword;{:129}
{132:}j:0..maxheaderbytes;p:pointer;q:1..4;parptr:0..maxparamwords;
{:132}{138:}labeltable:array[0..256]of record rr:-1..32767;cc:byte;end;
labelptr:0..256;sortptr:0..256;lkoffset:0..256;t:0..32767;
extralocneeded:boolean;{:138}{152:}verbose:cinttype;{:152}{155:}
tfmname,plname:cstring;{:155}{148:}procedure parsearguments;
const noptions=3;var longoptions:array[0..noptions]of getoptstruct;
...
longoptions[currentoption].val:=0;currentoption:=currentoption+1;{:149}
{150:}longoptions[currentoption].name:='version';
longoptions[currentoption].hasarg:=0;longoptions[currentoption].flag:=0;
longoptions[currentoption].val:=0;currentoption:=currentoption+1;{:150}
{151:}longoptions[currentoption].name:='verbose';
longoptions[currentoption].hasarg:=0;
longoptions[currentoption].flag:=addressof(verbose);
longoptions[currentoption].val:=1;currentoption:=currentoption+1;{:151}
{154:}longoptions[currentoption].name:=0;
longoptions[currentoption].hasarg:=0;longoptions[currentoption].flag:=0;
...
end else if getoptreturnval=63 then begin usage(1,'pltotf');
...
printversionandexit('This is PLtoTF, Version 3.5',nil,'D.E. Knuth');end;
until getoptreturnval=-1;
if(optind+1<>argc)and(optind+2<>argc)then begin writeln(stderr,
'pltotf: Need one or two file arguments.');usage(1,'pltotf');end;
...
{:40}{69:}d:headerindex;{:69}{73:}c:byte;{:73}
begin kpsesetprogname(argv[0]);parsearguments;{6:}reset(plfile,plname);
if verbose then begin write('This is PLtoTF, Version 3.5');
writeln(versionstring);end;{:6}{16:}rewritebin(tfmfile,tfmname);{:16}
{20:}for k:=0 to 127 do xord[chr(k)]:=127;xord[' ']:=32;xord['!']:=33;
