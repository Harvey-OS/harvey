...
MFbasedefault:^char;{:775}{782:}jobname:strnumber;logopened:boolean;
texmflogname:strnumber;{:782}{785:}gfext:strnumber;{:785}{791:}
gffile:bytefile;outputfilename:strnumber;{:791}{796:}
...
halfbuf:gfindex;gflimit:gfindex;gfptr:gfindex;gfoffset:integer;{:1152}
{1162:}bocc,bocp:integer;{:1162}{1183:}baseident:strnumber;{:1183}
{1188:}basefile:wordfile;{:1188}{1203:}readyalready:integer;{:1203}
{1214:}editnamestart:poolpointer;editnamelength,editline:integer;{:1214}
procedure initialize;var{19:}i:integer;{:19}{130:}k:integer;{:130}
...
for i:=0 to 126 do xord[xchr[i]]:=i;{:23}{69:}
if interactionoption=4 then interaction:=3 else interaction:=
interactionoption;{:69}{72:}deletionsallowed:=true;errorcount:=0;{:72}
{75:}helpptr:=0;useerrhelp:=false;errhelp:=0;{:75}{92:}interrupt:=0;
...
speclog[28]:=1;{:131}{138:}specatan[1]:=27855475;specatan[2]:=14718068;
...
waslomax:=0;washimin:=memmax;panicking:=false;endif('TEXMF_DEBUG'){:179}
{191:}for k:=1 to 41 do internal[k]:=0;intptr:=41;{:191}{199:}
...
procedure printvisiblechar(s:ASCIIcode);
...
procedure printchar(s:ASCIIcode);label 10;var k:ASCIIcode;l:0..255;
begin k:=s;if{49:}(k<32)or(k>126){:49}
then begin if selector>4 then begin printvisiblechar(s);goto 10;end;
printvisiblechar(94);printvisiblechar(94);
...
if(s<256)then printchar(s)else begin j:=strstart[s];
...
83:print(273);end;print(274);println;fflush(stdout);goto 10;end{:81};
...
endif('TEXMF_DEBUG')history:=3;jumpout;end;end;{:88}{89:}
procedure overflow(s:strnumber;n:integer);begin normalizeselector;
begin if interaction=3 then;printnl(261);print(285);end;print(s);
printchar(61);printint(n);printchar(93);begin helpptr:=2;
helpline[1]:=286;helpline[0]:=287;end;
begin if interaction=3 then interaction:=2;if logopened then error;
ifdef('TEXMF_DEBUG')if interaction>0 then debughelp;
endif('TEXMF_DEBUG')history:=3;jumpout;end;end;{:89}{90:}
...
begin if interaction=3 then interaction:=2;if logopened then error;
ifdef('TEXMF_DEBUG')if interaction>0 then debughelp;
endif('TEXMF_DEBUG')history:=3;jumpout;end;end;{:90}{:4}{30:}
{[34:]if baseident=0 then begin writeln(stdout,'Buffer size exceeded!');
...
strstart[0]:=0;{48:}for k:=0 to 255 do begin begin strpool[poolptr]:=k;
incr(poolptr);end;g:=makestring;strref[g]:=127;end{:48};{51:}
namelength:=strlen(poolname);nameoffile:=xmalloc(1+namelength+1);
strcpy(nameoffile+1,poolname);
if aopenin(poolfile,kpsemfpoolformat)then begin c:=false;repeat{52:}
...
30:if a<>518645105 then begin;writeln(stdout,
...
writeln(stdout,'! I can''t read mf.pool; bad path?');aclose(poolfile);
...
rounddecimals:=halfp(a+1);end;{:102}{107:}
...
goto 10;end;a:=b;b:=q;c:=d;d:=r;end;10:end;{:117}{121:}
...
y:=y+q;end;decr(k){:123};until k=0;squarert:=halfp(q);end;end;{:121}
...
printint(w.qqqq.b3);end;endif('TEXMF_DEBUG'){:157}{162:}{217:}
...
procedure runaway;begin if scannerstatus>2 then begin printnl(634);
case scannerstatus of 3:print(635);4,5:print(636);6:print(637);end;
...
if r>toint(p+1)then{170:}begin mem[p].hh.lh:=r-p;rover:=p;goto 40;
end{:170};if r=p then if mem[p+1].hh.rh<>p then{171:}
begin rover:=mem[p+1].hh.rh;t:=mem[p+1].hh.lh;mem[rover+1].hh.lh:=t;
mem[t+1].hh.rh:=rover;goto 40;end{:171};mem[p].hh.lh:=q-p{:169};
p:=mem[p+1].hh.rh;until p=rover;
if s=1073741824 then begin getnode:=268435455;goto 10;end;
if lomemmax+2<himemmin then if lomemmax+2<=268435455 then{168:}
...
mem[rover+1].hh.rh:=268435455;oldrover:=rover;while p<>oldrover do{174:}
...
<>p)then clobbered:=true;if clobbered then begin printnl(316);
...
318);printint(p);end;while(p<=lomemmax)and not freearr[p]do incr(p);
...
waslomax:=lomemmax;washimin:=himemmin;end;endif('TEXMF_DEBUG'){:180}
{185:}ifdef('TEXMF_DEBUG')procedure searchmem(p:halfword);var q:integer;
...
printint(q);printchar(41);end;end{:209};end;endif('TEXMF_DEBUG'){:185}
{189:}procedure printop(c:quarterword);
...
16:if m<=2 then if m=1 then print(651)else if m<1 then print(453)else
print(652)else if m=53 then print(653)else if m=44 then print(654)else
print(655);
4:if m<=1 then if m=1 then print(658)else print(454)else if m=9770 then
print(656)else print(657);{:684}{689:}61:case m of 1:print(660);
2:printchar(64);3:print(661);others:print(659)end;{:689}{696:}
56:if m>=9770 then if m=9770 then print(672)else if m=9920 then print(
673)else print(674)else if m<2 then print(675)else if m=2 then print(676
)else print(677);{:696}{710:}3:if m=0 then print(687)else print(613);
{:710}{741:}1,2:case m of 1:print(714);2:print(451);3:print(715);
others:print(716)end;{:741}{894:}
33,34,37,55,45,50,36,43,54,48,51,52:printop(m);{:894}{1014:}
30:printtype(m);{:1014}{1019:}85:if m=0 then print(908)else print(909);
{:1019}{1025:}23:case m of 0:print(271);1:print(272);2:print(273);
others:print(915)end;{:1025}{1028:}
21:if m=0 then print(916)else print(917);{:1028}{1038:}
22:case m of 0:print(931);1:print(932);2:print(933);3:print(934);
others:print(935)end;{:1038}{1043:}
31,62:begin if c=31 then print(938)else print(939);print(940);
print(hash[m].rh);end;41:if m=0 then print(941)else print(942);
10:print(943);53,44,49:begin printcmdmod(16,c);print(944);println;
showtokenlist(mem[mem[m].hh.rh].hh.rh,0,1000,0);end;5:print(945);
40:print(intname[m]);{:1043}{1053:}
68:if m=1 then print(952)else if m=0 then print(953)else print(954);
66:if m=6 then print(955)else print(956);
67:if m=0 then print(957)else print(958);{:1053}{1080:}
25:if m<1 then print(988)else if m=1 then print(989)else print(990);
{:1080}{1102:}20:case m of 0:print(1000);1:print(1001);2:print(1002);
3:print(1003);others:print(1004)end;{:1102}{1109:}
76:case m of 0:print(1022);1:print(1023);2:print(1025);3:print(1027);
5:print(1024);6:print(1026);7:print(1028);11:print(1029);
others:print(1030)end;{:1109}{1180:}
29:if m=16 then print(1055)else print(1054);{:1180}others:print(600)end;
...
mem[q+s+1].int:=serialno;end{:586};mem[q+s].hh.b1:=halfp(s)+5;
...
if(mem[q].hh.lh=0)or(verbosity>0)then printdependency(p,t)else print(760
...
end;end{:806};4:begin printchar(34);print(v);printchar(34);end;
6,8,9,11:{804:}
if verbosity<=1 then printtype(t)else begin if selector=3 then if
internal[13]<=0 then begin selector:=1;printtype(t);print(758);
selector:=3;end;case t of 6:printpen(v,283,false);
8:printpath(v,759,false);9:printpath(v,283,false);11:begin curedges:=v;
...
begin if(maxc[17]div 4096>=maxc[18])then t:=17 else t:=18;{816:}
...
printnl(763);if v>0 then printchar(45);
...
if t=17 then printchar(61)else print(764);printdependency(s,t);
...
end;end{:815};end{:812};20,21:confusion(762);
...
begin x1:=half(x1+xicorr);x2:=half(x2+xicorr);x3:=half(x3+xicorr);
r:=half(r+xicorr);y1:=half(y1+etacorr);y2:=half(y2+etacorr);
y3:=half(y3+etacorr);s:=half(s+etacorr);l:=15;end{:313};
...
move[moveptr]:=2;end{:320};goto 30;end else if u<s then begin{319:}
begin incr(move[moveptr]);incr(moveptr);move[moveptr]:=1;end{:319};
goto 30;end;incr(l);end;r:=r-xicorr;s:=s-etacorr;
...
edgeandweight:integer;j:integer;n:integer;
...
if sum<>m1-m0 then confusion(48);endif('TEXMF_DEBUG'){380:}
...
begin compromise:=half(goodval(u+u,-u-v));end;{:432}{433:}
...
ifdef('TEXMF_DEBUG')if(m<>mm1)or(moveptr<>n1-n0)then confusion(50);
endif('TEXMF_DEBUG')move[0]:=d0+envmove[1]-mm0;
...
ifdef('TEXMF_DEBUG')if(m<>mm1)or(moveptr<>n1-n0)then confusion(49);
endif('TEXMF_DEBUG')move[0]:=d0+envmove[0]-mm0;
...
603)else begin printnl(curinput.namefield);print(58);printint(line);
print(58);end;printchar(32){:637};{644:}begin l:=tally;tally:=0;
...
case curinput.indexfield of 16:printnl(604);17:{639:}begin printnl(609);
p:=paramstack[curinput.limitfield];
if p<>0 then if mem[p].hh.rh=1 then printexp(p,0)else showtokenlist(p,0,
20,tally);print(610);end{:639};18:printnl(605);
19:if curinput.locfield=0 then printnl(606)else printnl(607);
20:printnl(608);21:begin println;
...
if inputptr=stacksize then overflow(611,stacksize);end;
...
others:confusion(796)end;end;{:855}function curtok:halfword;
...
procedure beginfilereading;begin if inopen=15 then overflow(612,15);
...
if curinput.indexfield<>inopen then confusion(613);
...
if cursym=0 then begin if interaction=3 then;printnl(261);print(619);
end else begin begin if interaction=3 then;printnl(261);print(620);end;
end;print(621);begin helpptr:=4;helpline[3]:=622;helpline[2]:=623;
helpline[1]:=624;helpline[0]:=625;end;case scannerstatus of{664:}
2:begin print(626);helpline[3]:=627;cursym:=9763;end;3:begin print(628);
helpline[3]:=629;
if warninginfo=0 then cursym:=9767 else begin cursym:=9759;
eqtb[9759].rh:=warninginfo;end;end;4,5:begin print(630);
if scannerstatus=5 then print(hash[warninginfo].rh)else
printvariablename(warninginfo);cursym:=9765;end;6:begin print(631);
print(hash[warninginfo].rh);print(632);helpline[3]:=633;cursym:=9764;
end;{:664}end;inserror;end{:663}else begin begin if interaction=3 then;
printnl(261);print(614);end;printint(warninginfo);begin helpptr:=3;
helpline[2]:=615;helpline[1]:=616;helpline[0]:=617;end;
if cursym=0 then helpline[2]:=618;cursym:=9766;inserror;end;
...
then printnl(648);println;first:=curinput.startfield;begin;print(42);
...
end else fatalerror(649);end{:679};
...
begin if interaction=3 then;printnl(261);print(641);end;
begin helpptr:=3;helpline[2]:=642;helpline[1]:=643;helpline[0]:=644;end;
...
begin begin if interaction=3 then;printnl(261);print(638);end;
begin helpptr:=2;helpline[1]:=639;helpline[0]:=640;end;
...
printnl(261);print(645);end;begin helpptr:=2;helpline[1]:=646;
...
first:=curinput.limitfield;begin;print(650);terminput;end;
...
printnl(261);print(662);end;begin helpptr:=3;helpline[2]:=663;
helpline[1]:=664;helpline[0]:=665;end;
if cursym>0 then helpline[2]:=666 else if curcmd=39 then begin if strref
...
begin helpptr:=5;helpline[4]:=667;helpline[3]:=668;helpline[2]:=669;
helpline[1]:=670;helpline[0]:=671;end;backerror;end;end;{:693}{694:}
...
begin helpptr:=2;helpline[1]:=918;helpline[0]:=919;end;backerror;
end else begin begin if interaction=3 then;printnl(261);print(920);end;
print(hash[rdelim].rh);print(921);begin helpptr:=3;helpline[2]:=922;
helpline[1]:=923;helpline[0]:=924;end;error;end;10:end;{:1032}{1011:}
...
begin begin if interaction=3 then;printnl(261);print(678);end;
begin helpptr:=2;helpline[1]:=679;helpline[0]:=680;end;error;
...
interaction=3 then;printnl(261);print(681);end;begin helpptr:=1;
helpline[0]:=682;end;backerror;base:=9770;end;{704:}
repeat mem[q].hh.rh:=getavail;q:=mem[q].hh.rh;mem[q].hh.lh:=base+k;
getsymbol;p:=getnode(2);mem[p+1].int:=base+k;mem[p].hh.lh:=cursym;
if k=150 then overflow(683,150);incr(k);mem[p].hh.rh:=r;r:=p;getnext;
...
if k=150 then overflow(683,150);incr(k);getsymbol;mem[p].hh.lh:=cursym;
mem[p].hh.rh:=r;r:=p;getnext;if c=4 then if curcmd=69 then begin c:=5;
p:=getnode(2);if k=150 then overflow(683,150);mem[p+1].int:=9770+k;
...
printnl(498)else printnl(499);printint(n);print(699);
...
printmacroname(arglist,macroname);if n=3 then print(661);
...
print(705);end;printmacroname(arglist,macroname);begin helpptr:=3;
helpline[2]:=706;helpline[1]:=707;helpline[0]:=708;end;
...
then begin missingerr(44);begin helpptr:=3;helpline[2]:=709;
helpline[1]:=710;helpline[0]:=704;end;backerror;curcmd:=82;
end else begin missingerr(hash[rdelim].rh);begin helpptr:=2;
helpline[1]:=711;helpline[0]:=704;end;backerror;end{:727};40:{728:}
begin p:=getavail;
...
print(700);end;printmacroname(arglist,macroname);printchar(59);
printnl(701);print(hash[rdelim].rh);print(298);begin helpptr:=3;
helpline[2]:=702;helpline[1]:=703;helpline[0]:=704;end;error;end;
...
if arglist=0 then arglist:=p else mem[tail].hh.rh:=p;tail:=p;incr(n);
if curcmd<>69 then begin missingerr(478);print(712);
printmacroname(arglist,macroname);begin helpptr:=1;helpline[0]:=713;end;
...
missingerr(hash[rdelim].rh);begin helpptr:=2;helpline[1]:=711;
helpline[0]:=704;end;backerror;end;getxnext;end;end{:735};
...
if maxparamstack>150 then overflow(683,150);end;
...
printnl(261);print(720);end;printcmdmod(2,curmod);begin helpptr:=1;
helpline[0]:=721;end;error;end else begin while curmod<>2 do passtext;
...
print(684);end;begin helpptr:=2;helpline[1]:=685;helpline[0]:=686;end;
...
printnl(261);print(688);end;begin helpptr:=2;helpline[1]:=689;
helpline[0]:=690;end;error;end else resumeiteration;end{:712};6:{713:}
...
printnl(261);print(691);end;begin helpptr:=1;helpline[0]:=692;end;
...
until p<>0;if p<>mem[loopptr].hh.lh then fatalerror(695);stopiteration;
end{:714}else if curcmd<>83 then begin missingerr(59);begin helpptr:=2;
helpline[1]:=693;helpline[0]:=694;end;backerror;end;end{:713};7:;
...
if curtype<>4 then begin disperr(0,696);begin helpptr:=2;
helpline[1]:=697;helpline[0]:=698;end;putgetflusherror(0);
...
if maxparamstack>150 then overflow(683,150);end;paramstack[paramptr]:=p;
...
while true do begin if q=0 then confusion(714);
...
helpline[1]:=717;helpline[0]:=694;end;backerror;end;end;{:747}{748:}
...
if curexp=30 then print(718)else print(719);enddiagnostic(false);
...
begin disperr(0,722);print(s);print(305);begin helpptr:=4;
helpline[3]:=723;helpline[2]:=724;helpline[1]:=725;helpline[0]:=307;end;
...
helpline[2]:=726;helpline[1]:=669;helpline[0]:=727;end;backerror;end;
...
begin if curtype<>16 then badfor(733);pp:=getnode(4);
mem[pp+1].int:=curexp;getxnext;scanexpression;
if curtype<>16 then badfor(734);mem[pp+2].int:=curexp;
if curcmd<>75 then begin missingerr(489);begin helpptr:=2;
helpline[1]:=735;helpline[0]:=736;end;backerror;end;getxnext;
scanexpression;if curtype<>16 then badfor(737);mem[pp+3].int:=curexp;
...
helpline[2]:=728;helpline[1]:=729;helpline[0]:=730;end;backerror;
...
if internal[7]>65536 then{762:}begin begindiagnostic;printnl(732);
...
begin areadelimiter:=poolptr;extdelimiter:=0;
...
nameoffile[namelength+1]:=0;end;{:774}{778:}
procedure packbufferedname(n:smallnumber;a,b:integer);var k:integer;
c:ASCIIcode;j:integer;begin if n+b-a+6>maxint then b:=a+maxint-n-6;k:=0;
...
MFbasedefault[j]];incr(k);if k<=maxint then nameoffile[k]:=xchr[c];end;
if k<=maxint then namelength:=k else namelength:=maxint;
nameoffile[namelength+1]:=0;end;{:778}{780:}
...
begin if interaction=2 then;if s=739 then begin if interaction=3 then;
printnl(261);print(740);end else begin if interaction=3 then;
printnl(261);print(741);end;printfilename(curname,curarea,curext);
print(742);if e=743 then showcontext;printnl(744);print(s);
if interaction<2 then fatalerror(745);;begin;print(746);terminput;end;
...
if jobname=0 then jobname:=747;packjobname(748);
while not aopenout(logfile)do{789:}begin selector:=1;
promptfilename(750,748);end{:789};
texmflogname:=amakenamestring(logfile);selector:=2;logopened:=true;
{790:}begin write(logfile,'This is METAFONT, Version 2.7182');
write(logfile,versionstring);print(baseident);print(751);
...
printdd(m mod 60);end{:790};inputstack[inputptr]:=curinput;printnl(749);
...
var tempstr:strnumber;k:integer;begin{795:}
while(curinput.indexfield>15)and(curinput.locfield=0)do endtokenlist;
if(curinput.indexfield>15)then begin begin if interaction=3 then;
printnl(261);print(753);end;begin helpptr:=3;helpline[2]:=754;
helpline[1]:=755;helpline[0]:=756;end;error;end;
...
if curext=743 then begin curext:=283;
packfilename(curname,curarea,curext);end;
if aopenin(inputfile[curinput.indexfield],kpsemfformat)then begin k:=1;
beginname;while(k<=namelength)and(morename(nameoffile[k]))do incr(k);
endname;goto 30;end;endfilereading;promptfilename(739,743);end;
...
ifdef('INIMF')if iniversion and dumpoption then begin begin if poolptr+
basedefaultlength>maxpoolptr then begin if poolptr+basedefaultlength>
poolsize then overflow(257,poolsize-initpoolptr);
maxpoolptr:=poolptr+basedefaultlength;end;end;
for k:=1 to basedefaultlength-5 do begin strpool[poolptr]:=xord[
MFbasedefault[k]];incr(poolptr);end;jobname:=makestring;end;
endif('INIMF')openlogfile;end;
...
print(curinput.namefield);fflush(stdout);{794:}begin line:=1;
...
begin begin if interaction=3 then;printnl(261);print(s);end;print(766);
printcmdmod(curcmd,curmod);printchar(39);begin helpptr:=4;
helpline[3]:=767;helpline[2]:=768;helpline[1]:=769;helpline[0]:=770;end;
...
procedure badsubscript;begin disperr(0,782);begin helpptr:=3;
helpline[2]:=783;helpline[1]:=784;helpline[0]:=785;end;flusherror(0);
end;{:849}{851:}procedure obliterated(q:halfword);
begin begin if interaction=3 then;printnl(261);print(786);end;
showtokenlist(q,0,1000,0);print(787);begin helpptr:=5;helpline[4]:=788;
helpline[3]:=789;helpline[2]:=790;helpline[1]:=791;helpline[0]:=792;end;
...
print(802);end;begin helpptr:=2;helpline[1]:=803;helpline[0]:=574;end;
...
begin if curtype<>14 then begin disperr(0,805);begin helpptr:=5;
helpline[4]:=806;helpline[3]:=807;helpline[2]:=808;helpline[1]:=809;
helpline[0]:=810;end;putgetflusherror(0);curx:=0;cury:=0;
end else begin p:=mem[curexp+1].int;{873:}
if mem[p].hh.b0=16 then curx:=mem[p+1].int else begin disperr(p,811);
begin helpptr:=5;helpline[4]:=812;helpline[3]:=807;helpline[2]:=808;
helpline[1]:=809;helpline[0]:=810;end;putgeterror;recyclevalue(p);
curx:=0;end;
if mem[p+2].hh.b0=16 then cury:=mem[p+3].int else begin disperr(p+2,813)
;begin helpptr:=5;helpline[4]:=814;helpline[3]:=807;helpline[2]:=808;
helpline[1]:=809;helpline[0]:=810;end;putgeterror;recyclevalue(p+2);
...
if(curtype<>16)or(curexp<0)then begin disperr(0,817);begin helpptr:=1;
helpline[0]:=818;end;putgetflusherror(65536);end;t:=3;end{:876}
else{877:}begin scanexpression;if curtype>14 then{878:}
begin if curtype<>16 then begin disperr(0,811);begin helpptr:=5;
helpline[4]:=812;helpline[3]:=807;helpline[2]:=808;helpline[1]:=809;
helpline[0]:=810;end;putgetflusherror(0);end;x:=curexp;
if curcmd<>82 then begin missingerr(44);begin helpptr:=2;
helpline[1]:=819;helpline[0]:=820;end;backerror;end;getxnext;
scanexpression;if curtype<>16 then begin disperr(0,813);
begin helpptr:=5;helpline[4]:=814;helpline[3]:=807;helpline[2]:=808;
helpline[1]:=809;helpline[0]:=810;end;putgetflusherror(0);end;
...
helpline[2]:=815;helpline[1]:=816;helpline[0]:=694;end;backerror;end;
...
35:{897:}begin if interaction<=1 then fatalerror(831);beginfilereading;
...
335)else print(832)else print(833);printchar(41);end;{:900}{901:}
procedure badunary(c:quarterword);begin disperr(0,834);printop(c);
printknownorunknowntype(curtype,curexp);begin helpptr:=3;
helpline[2]:=835;helpline[1]:=836;helpline[0]:=837;end;putgeterror;end;
...
if badchar then begin disperr(0,839);if c=47 then begin helpptr:=1;
helpline[0]:=840;end else begin helpptr:=1;helpline[0]:=841;end;
putgeterror;end;if n>4095 then begin begin if interaction=3 then;
printnl(261);print(842);end;printint(n);printchar(41);begin helpptr:=1;
helpline[0]:=843;end;putgeterror;end{:914};end;flushcurexp(n*65536);end;
...
printop(c);printchar(40);printexp(0,0);print(838);enddiagnostic(false);
end{:902};
...
disperr(0,834);if c>=94 then printop(c);
printknownorunknowntype(mem[p].hh.b0,p);
if c>=94 then print(478)else printop(c);
printknownorunknowntype(curtype,curexp);begin helpptr:=3;
helpline[2]:=835;helpline[1]:=844;helpline[0]:=845;end;putgeterror;end;
...
disperr(p,854);begin helpptr:=3;helpline[2]:=855;helpline[1]:=856;
...
if curtype<>16 then begin disperr(0,857);begin helpptr:=3;
helpline[2]:=858;helpline[1]:=859;helpline[0]:=537;end;
...
;printnl(261);print(863);end;begin helpptr:=3;helpline[2]:=864;
...
printnl(261);print(860);end;begin helpptr:=3;helpline[2]:=861;
helpline[1]:=862;helpline[0]:=537;end;putgeterror;10:end;{:963}{966:}
...
begin begin if aritherror then cleararith;end;
if internal[7]>131072 then{924:}begin begindiagnostic;printnl(846);
printexp(p,0);printchar(41);printop(c);printchar(40);printexp(0,0);
print(838);enddiagnostic(false);end{:924};{926:}
...
31:takepart(53+half(r-mem[curexp+1].int));end{:939}
...
begin helpptr:=1;helpline[0]:=847;end end else begin helpptr:=2;
helpline[1]:=848;helpline[0]:=849;end;disperr(0,850);
putgetflusherror(31);
...
curexp;unstashcurexp(p);if v=0 then{950:}begin disperr(0,780);
begin helpptr:=2;helpline[1]:=852;helpline[0]:=853;end;putgeterror;
end{:950}
...
begin begindiagnostic;printnl(846);printscaled(n);printchar(47);
printscaled(d);print(851);printexp(0,0);print(838);enddiagnostic(false);
...
if internal[27]<=0 then gfext:=1050 else begin oldsetting:=selector;
selector:=5;printchar(46);printint(makescaled(internal[27],59429463));
print(1051);gfext:=makestring;selector:=oldsetting;end{:1164};
begin if jobname=0 then openlogfile;packjobname(gfext);
while not bopenout(gffile)do promptfilename(752,gfext);
...
selector:=5;print(1049);printint(roundunscaled(internal[14]));
...
until mm=268435456;if w<>0 then printnl(1053);
...
if internal[11]>0 then printedges(1052,true,xoff,yoff);end;{:1165}{995:}
...
printnl(261);print(893);end;print(895);printscaled(mem[p+1].int);
printchar(41);begin helpptr:=2;helpline[1]:=894;helpline[0]:=892;end;
...
print(890);end;begin helpptr:=2;helpline[1]:=891;helpline[0]:=892;end;
putgeterror;goto 30;45:begin if interaction=3 then;printnl(261);
print(893);end;begin helpptr:=2;helpline[1]:=894;helpline[0]:=892;end;
...
{:1003}end;{1002:}disperr(lhs,283);disperr(0,887);
...
printchar(41);begin helpptr:=2;helpline[1]:=888;helpline[0]:=889;end;
...
if internal[7]>131072 then{997:}begin begindiagnostic;printnl(846);
printexp(lhs,0);print(882);printexp(0,0);print(838);
...
begin if curtype<>20 then begin disperr(0,879);begin helpptr:=2;
helpline[1]:=880;helpline[0]:=881;end;error;doequation;
...
enddiagnostic(false);end{:998};if mem[lhs].hh.lh>9769 then{999:}
if curtype=16 then internal[mem[lhs].hh.lh-(9769)]:=curexp else begin
disperr(0,883);print(intname[mem[lhs].hh.lh-(9769)]);print(884);
begin helpptr:=2;helpline[1]:=885;helpline[0]:=886;end;putgeterror;
...
end else begin begin if interaction=3 then;printnl(261);print(896);end;
begin helpptr:=2;helpline[1]:=897;helpline[0]:=898;end;putgeterror;end;
flushlist(p);if curcmd<82 then{1016:}begin begin if interaction=3 then;
printnl(261);print(899);end;begin helpptr:=5;helpline[4]:=900;
helpline[3]:=901;helpline[2]:=902;helpline[1]:=903;helpline[0]:=904;end;
if curcmd=42 then helpline[2]:=905;putgeterror;scannerstatus:=2;
repeat getnext;{743:}
if curcmd=39 then begin if strref[curmod]<127 then if strref[curmod]>1
...
helpline[0]:=910;end;backerror;end;getxnext;scanexpression;
if curtype<>16 then begin disperr(0,911);begin helpptr:=2;
helpline[1]:=912;helpline[0]:=913;end;putgetflusherror(0);
end else{1022:}begin initrandoms(curexp);
if selector>=2 then begin oldsetting:=selector;selector:=2;printnl(914);
...
print(920);end;if cursym=0 then print(925)else print(hash[cursym].rh);
print(926);begin helpptr:=1;helpline[0]:=927;end;backerror;
...
begin helpptr:=3;helpline[2]:=928;helpline[1]:=669;helpline[0]:=929;end;
...
begin repeat if intptr=maxinternal then overflow(930,maxinternal);
...
begin repeat getxnext;scanexpression;printnl(761);printexp(0,2);
flushcurexp(0);until curcmd<>82;end;{:1040}{1041:}procedure disptoken;
begin printnl(936);if cursym=0 then{1042:}
...
if eqtb[cursym].lh>=86 then print(937);printcmdmod(curcmd,curmod);
...
printvariablename(p);if mem[p].hh.b0>22 then print(661);print(949);
...
printvariablename(p);
if mem[p].hh.b0=17 then printchar(61)else print(764);
...
print(950);end;if interaction<3 then begin helpptr:=0;decr(errorcount);
end else begin helpptr:=1;helpline[0]:=951;end;
...
if curtype<>t then{1055:}begin disperr(0,959);begin helpptr:=2;
helpline[1]:=960;helpline[0]:=961;end;if t=6 then helpline[1]:=962;
...
interaction=3 then;printnl(261);print(963);end;begin helpptr:=1;
helpline[0]:=961;end;putgetflusherror(0);end;end{:1056};
...
printnl(261);print(786);end;showtokenlist(t,0,1000,0);print(964);
printtype(mem[p].hh.b0);printchar(41);begin helpptr:=2;helpline[1]:=965;
helpline[0]:=966;end;putgeterror;end else curedges:=mem[p+1].int;
...
begin disperr(0,967);begin helpptr:=4;helpline[3]:=968;helpline[2]:=969;
helpline[1]:=970;helpline[0]:=966;end;putgetflusherror(0);end{:1060}
...
0,971);begin helpptr:=2;helpline[1]:=972;helpline[0]:=966;end;
...
if curtype<>9 then begin disperr(0,971);begin helpptr:=2;
helpline[1]:=973;helpline[0]:=966;end;putgetflusherror(0);
...
begin begin if interaction=3 then;printnl(261);print(974);end;
begin helpptr:=2;helpline[1]:=975;helpline[0]:=966;end;putgeterror;
...
then goto 30 else printstrange(976)else printstrange(977);
begin helpptr:=3;helpline[2]:=978;helpline[1]:=979;helpline[0]:=980;end;
...
then;printnl(261);print(997);end;print(intname[m]);print(998);
begin helpptr:=1;helpline[0]:=999;end;putgeterror;
...
}begin disperr(0,967);begin helpptr:=4;helpline[3]:=968;
helpline[2]:=969;helpline[1]:=970;helpline[0]:=966;end;
...
varflag:=73;scanprimary;if curtype<>20 then{1060:}begin disperr(0,967);
begin helpptr:=4;helpline[3]:=968;helpline[2]:=969;helpline[1]:=970;
helpline[0]:=966;end;putgetflusherror(0);end{:1060}else begin e:=curexp;
...
45:curexp:=curexp*65536;50:disperr(0,981);begin helpptr:=1;
helpline[0]:=982;end;putgetflusherror(0);flushtokenlist(e);end;10:end;
...
goto 10;45:begin if interaction=3 then;printnl(261);print(983);end;
begin helpptr:=2;helpline[1]:=984;helpline[0]:=985;end;putgeterror;
10:end;{:1073}{1074:}procedure docull;label 45,10;var e:halfword;
keeping:0..1;w,win,wout:integer;begin w:=1;getxnext;varflag:=67;
scanprimary;if curtype<>20 then{1060:}begin disperr(0,967);
begin helpptr:=4;helpline[3]:=968;helpline[2]:=969;helpline[1]:=970;
helpline[0]:=966;end;putgetflusherror(0);end{:1060}else begin e:=curexp;
...
print(986);end;begin helpptr:=1;helpline[0]:=987;end;putgeterror;
flushtokenlist(e);end;10:end;{:1074}{1082:}procedure domessage;
var m:0..2;begin m:=curmod;getxnext;scanexpression;
if curtype<>4 then begin disperr(0,696);begin helpptr:=1;
helpline[0]:=991;end;putgeterror;
end else case m of 0:begin printnl(283);print(curexp);end;1:{1086:}
...
helpptr:=1;helpline[0]:=992;
end else begin if interaction<3 then longhelpseen:=true;
begin helpptr:=4;helpline[3]:=993;helpline[2]:=994;helpline[1]:=995;
helpline[0]:=996;end;end;putgeterror;useerrhelp:=false;end{:1086};
2:{1083:}
...
then begin c:=strpool[strstart[curexp]];goto 40;end;disperr(0,1005);
begin helpptr:=2;helpline[1]:=1006;helpline[0]:=1007;end;
...
begin begin if interaction=3 then;printnl(261);print(1008);end;
if(c>32)and(c<127)then print(c)else if c=256 then print(1009)else begin
print(1010);printint(c);end;print(1011);case chartag[c]of 1:print(1012);
2:print(1013);3:print(1002);end;begin helpptr:=2;helpline[1]:=1014;
helpline[0]:=966;end;putgeterror;end{:1105};end;{:1104}{1106:}
...
printnl(261);print(1031);end;begin helpptr:=1;helpline[0]:=1032;end;
...
print(1031);end;begin helpptr:=1;helpline[0]:=1032;end;error;ll:=ll;
...
if curtype<>16 then begin disperr(0,1033);begin helpptr:=2;
helpline[1]:=1034;helpline[0]:=307;end;putgetflusherror(0);end;
kern[nk]:=curexp;k:=0;while kern[k]<>curexp do incr(k);
if k=nk then begin if nk=maxkerns then overflow(1030,maxkerns);incr(nk);
...
printnl(261);print(1019);end;begin helpptr:=1;helpline[0]:=1020;end;
backerror;ligkern[nl].b1:=0;ligkern[nl].b2:=0;ligkern[nl].b3:=0;
ligkern[nl].b0:=129;end;
if nl=ligtablesize then overflow(1021,ligtablesize);incr(nl);
if curcmd=82 then goto 22;
if ligkern[nl-1].b0<128 then ligkern[nl-1].b0:=128;30:end{:1107};
2:{1113:}begin if ne=256 then overflow(1002,256);c:=getcode;
settag(c,3,ne);if curcmd<>81 then begin missingerr(58);begin helpptr:=1;
helpline[0]:=1035;end;backerror;end;exten[ne].b0:=getcode;
if curcmd<>82 then begin missingerr(44);begin helpptr:=1;
helpline[0]:=1035;end;backerror;end;exten[ne].b1:=getcode;
if curcmd<>82 then begin missingerr(44);begin helpptr:=1;
helpline[0]:=1035;end;backerror;end;exten[ne].b2:=getcode;
if curcmd<>82 then begin missingerr(44);begin helpptr:=1;
helpline[0]:=1035;end;backerror;end;exten[ne].b3:=getcode;incr(ne);
end{:1113};3,4:begin c:=curmod;getxnext;scanexpression;
if(curtype<>16)or(curexp<32768)then begin disperr(0,1015);
begin helpptr:=2;helpline[1]:=1016;helpline[0]:=1017;end;putgeterror;
end else begin j:=roundunscaled(curexp);
if curcmd<>81 then begin missingerr(58);begin helpptr:=1;
helpline[0]:=1018;end;backerror;end;if c=3 then{1114:}
repeat if j>headersize then overflow(1003,headersize);
headerbyte[j]:=getcode;incr(j);until curcmd<>82{:1114}else{1115:}
repeat if j>maxfontdimen then overflow(1004,maxfontdimen);
while j>np do begin incr(np);param[np]:=0;end;getxnext;scanexpression;
if curtype<>16 then begin disperr(0,1036);begin helpptr:=1;
...
begin disperr(0,1056);begin helpptr:=1;helpline[0]:=1057;end;
...
selector:=5;print(1067);print(jobname);printchar(32);
...
begin if poolptr+1>maxpoolptr then begin if poolptr+1>poolsize then
overflow(257,poolsize-initpoolptr);maxpoolptr:=poolptr+1;end;end;
baseident:=makestring;strref[baseident]:=127;packjobname(738);
while not wopenout(basefile)do promptfilename(1068,738);printnl(1069);
print(wmakenamestring(basefile));flushstring(strptr-1);printnl(283);
print(baseident){:1200};{1190:}dumpint(518645105);dumpint(0);
...
w.b3:=strpool[k+3];dumpqqqq(w);println;printint(strptr);print(1064);
...
dumpint(varused);dumpint(dynused);println;printint(x);print(1065);
...
dumpint(stcount);println;printint(stcount);print(1066){:1196};{1198:}
...
print(865);end;printcmdmod(curcmd,curmod);printchar(39);
begin helpptr:=5;helpline[4]:=866;helpline[3]:=867;helpline[2]:=868;
helpline[1]:=869;helpline[0]:=870;end;backerror;getxnext;end;end{:990}
...
begin if internal[1]>0 then begin printnl(283);print(curexp);
fflush(stdout);end;if internal[34]>0 then{1179:}
begin if outputfilename=0 then initgf;gfstring(1058,curexp);end{:1179};
end{:994}else if curtype<>1 then begin disperr(0,875);begin helpptr:=3;
helpline[2]:=876;helpline[1]:=877;helpline[0]:=878;end;putgeterror;end;
...
24:dorandomseed;{:1020}{1023:}23:begin println;interaction:=curmod;
if interaction=0 then kpsemaketexdiscarderrors:=1 else
kpsemaketexdiscarderrors:=0;{70:}
...
printnl(261);print(871);end;begin helpptr:=6;helpline[5]:=872;
helpline[4]:=873;helpline[3]:=874;helpline[2]:=868;helpline[1]:=869;
helpline[0]:=870;end;backerror;scannerstatus:=2;repeat getnext;{743:}
if curcmd=39 then begin if strref[curmod]<127 then if strref[curmod]>1
then decr(strref[curmod])else flushstring(curmod);end{:743};
...
print(906);end;begin helpptr:=2;helpline[1]:=907;helpline[0]:=686;end;
...
procedure tfmwarning(m:smallnumber);begin printnl(1037);
print(intname[m]);print(1038);printscaled(perturbation);print(1039);end;
{:1123}{1128:}procedure fixdesignsize;var d:scaled;
begin d:=internal[26];
if(d<65536)or(d>=134217728)then begin if d<>0 then printnl(1040);
...
{1133:}procedure tfmqqqq(x:fourquarters);begin putbyte(x.b0,tfmfile);
...
goto 10;end;40:curinput.locfield:=j;openbasefile:=true;10:end;{:779}
function loadbasefile:boolean;label 6666,10;var k:integer;p,q:halfword;
x:integer;w:fourquarters;begin{1191:}undumpint(x);
if x<>518645105 then goto 6666;undumpint(x);if x<>0 then goto 6666;
...
undumpint(x);if x<>15 then goto 6666{:1191};{1193:}begin undumpint(x);
...
getxnext;scanexpression;if(curcmd=82)and(curtype>=16)then{830:}
begin p:=getnode(2);mem[p].hh.b0:=14;mem[p].hh.b1:=11;initbignode(p);
q:=mem[p+1].int;stashin(q);getxnext;scanexpression;
if curtype<16 then begin disperr(0,771);begin helpptr:=4;
...
printnl(261);print(776);end;printint(groupline);print(777);
begin helpptr:=2;helpline[1]:=778;helpline[0]:=779;end;backerror;
...
begin begin if interaction=3 then;printnl(261);print(780);end;
begin helpptr:=1;helpline[0]:=781;end;error;end{:838}
...
print(712);printcmdmod(37,c);begin helpptr:=1;helpline[0]:=713;end;
...
helpline[2]:=793;helpline[1]:=794;helpline[0]:=795;putgetflusherror(0);
end;flushnodelist(q);goto 30{:852};end{:844};others:begin badexp(765);
...
helpline[2]:=797;helpline[1]:=798;helpline[0]:=694;end;backerror;end;
...
if curcmd<>64 then begin missingerr(93);begin helpptr:=3;
helpline[2]:=799;helpline[1]:=798;helpline[0]:=694;end;backerror;end;
...
begin 20:if(curcmd<30)or(curcmd>43)then badexp(800);scanprimary;
...
begin 20:if(curcmd<30)or(curcmd>43)then badexp(801);scansecondary;
...
20:if(curcmd<30)or(curcmd>43)then badexp(804);scantertiary;
...
if(curtype<>16)or(curexp<49152)then begin disperr(0,822);
begin helpptr:=1;helpline[0]:=823;end;putgetflusherror(65536);end{:883};
...
helpline[0]:=821;end;backerror;end;30:end{:881}
...
print(824);end;begin helpptr:=3;helpline[2]:=825;helpline[1]:=826;
helpline[0]:=827;end;putgeterror;d:=47;mem[q+6].int:=65536;y:=65536;end;
...
if curtype<>2 then begin disperr(0,828);begin helpptr:=2;
helpline[1]:=829;helpline[0]:=830;end;putgetflusherror(31);curtype:=2;
...
if jobname=0 then openlogfile;packjobname(1041);
while not bopenout(tfmfile)do promptfilename(1042,1041);
...
putbyte(headerbyte[k],tfmfile);end{:1135};{1136:}
...
for k:=0 to 255 do if skiptable[k]<ligtablesize then begin printnl(1044)
;printint(k);print(1045);ll:=skiptable[k];repeat lll:=ligkern[ll].b0;
...
for k:=0 to nk-1 do put4bytes(tfmfile,dimenout(kern[k])){:1139};{1140:}
...
if tfmchanged>0 then begin if tfmchanged=1 then printnl(1046)else begin
printnl(40);printint(tfmchanged);print(1047);end;print(1048);end{:1140};
...
endif('STAT')printnl(1043);print(metricfilename);printchar(46);
...
if gfptr>0 then writegf(0,gfptr-1){:1156};printnl(1059);
print(outputfilename);print(557);printint(totalchars);print(1060);
if totalchars<>1 then printchar(115);print(1061);
printint(gfoffset+gfptr);print(1062);bclose(gffile);end{:1182};
end{:1206};if logopened then begin writeln(logfile);aclose(logfile);
selector:=selector-2;if selector=1 then begin printnl(1070);
...
while openparens>0 do begin print(1071);decr(openparens);end;
while condptr<>0 do begin printnl(1072);printcmdmod(2,curif);
if ifline<>0 then begin print(1073);printint(ifline);end;print(1074);
...
then begin selector:=1;printnl(1075);selector:=3;end;
if c=1 then begin ifdef('INIMF')if iniversion then begin storebasefile;
goto 10;end;endif('INIMF')printnl(1076);goto 10;end;10:end;{:1209}
{1210:}ifdef('INIMF')procedure initprim;begin{192:}primitive(408,40,1);
...
primitive(489,75,0);{:211}{683:}primitive(651,16,1);primitive(652,16,2);
primitive(653,16,53);primitive(654,16,44);primitive(655,16,49);
primitive(453,16,0);eqtb[9765]:=eqtb[cursym];primitive(656,4,9770);
primitive(657,4,9920);primitive(658,4,1);primitive(454,4,0);
eqtb[9764]:=eqtb[cursym];{:683}{688:}primitive(659,61,0);
primitive(660,61,1);primitive(64,61,2);primitive(661,61,3);{:688}{695:}
primitive(672,56,9770);primitive(673,56,9920);primitive(674,56,10070);
primitive(675,56,1);primitive(676,56,2);primitive(677,56,3);{:695}{709:}
primitive(687,3,0);primitive(613,3,1);{:709}{740:}primitive(714,1,1);
primitive(451,2,2);eqtb[9766]:=eqtb[cursym];primitive(715,2,3);
primitive(716,2,4);{:740}{893:}primitive(346,33,30);
...
primitive(335,30,14);{:1013}{1018:}primitive(908,85,0);
primitive(909,85,1);{:1018}{1024:}primitive(271,23,0);
primitive(272,23,1);primitive(273,23,2);primitive(915,23,3);{:1024}
{1027:}primitive(916,21,0);primitive(917,21,1);{:1027}{1037:}
primitive(931,22,0);primitive(932,22,1);primitive(933,22,2);
primitive(934,22,3);primitive(935,22,4);{:1037}{1052:}
primitive(952,68,1);primitive(953,68,0);primitive(954,68,2);
primitive(955,66,6);primitive(956,66,16);primitive(957,67,0);
primitive(958,67,1);{:1052}{1079:}primitive(988,25,0);
primitive(989,25,1);primitive(990,25,2);{:1079}{1101:}
primitive(1000,20,0);primitive(1001,20,1);primitive(1002,20,2);
primitive(1003,20,3);primitive(1004,20,4);{:1101}{1108:}
primitive(1022,76,0);primitive(1023,76,1);primitive(1024,76,5);
primitive(1025,76,2);primitive(1026,76,6);primitive(1027,76,3);
primitive(1028,76,7);primitive(1029,76,11);primitive(1030,76,128);
{:1108}{1176:}primitive(1054,29,4);primitive(1055,29,16);{:1176};end;
...
mem[memtop].hh.lh:=268435455;{:324}{475:}mem[3].hh.lh:=0;
mem[3].hh.rh:=0;mem[4].hh.lh:=1;mem[4].hh.rh:=0;
for k:=5 to 11 do mem[k]:=mem[4];mem[12].int:=0;mem[0].hh.rh:=0;
mem[0].hh.lh:=0;mem[1].int:=0;mem[2].int:=0;{:475}{587:}serialno:=0;
mem[13].hh.rh:=13;mem[14].hh.lh:=13;mem[13].hh.lh:=0;mem[14].hh.rh:=0;
{:587}{702:}mem[21].hh.b1:=0;mem[21].hh.rh:=9768;eqtb[9768].rh:=21;
eqtb[9768].lh:=41;{:702}{759:}eqtb[9758].lh:=91;hash[9758].rh:=731;
{:759}{911:}mem[17].hh.b1:=11;{:911}{1116:}mem[20].int:=1073741824;
{:1116}{1127:}mem[16].int:=0;mem[15].hh.lh:=0;{:1127}{1185:}
if iniversion then baseident:=1063;{:1185}end;endif('INIMF'){:1210}
{1212:}ifdef('TEXMF_DEBUG')procedure debughelp;label 888,10;
var k,l,m,n:integer;begin while true do begin;printnl(1077);
...
others:print(63)end;end;end;10:end;endif('TEXMF_DEBUG'){:1212}{:1202}
{1204:}begin bounddefault:=250000;boundname:='main_memory';
...
memtop:=0+mainmemory;memmax:=memtop;xmallocarray(gfbuf,gfbufsize);
ifdef('INIMF')if iniversion then begin xmallocarray(mem,memtop-0);end;
endif('INIMF')history:=3;;if readyalready=314159 then goto 1;{14:}
...
if(255<255)or(268435455<65535)then bad:=17;{:154}{204:}
if 9769+maxinternal>268435455 then bad:=21;{:204}{214:}
if 10220>268435455 then bad:=22;{:214}{310:}
if 15*11>bistacksize then bad:=31;{:310}{553:}
if 20+17*45>bistacksize then bad:=32;{:553}{777:}
if basedefaultlength>maxint then bad:=41;{:777}
...
write(stdout,'This is METAFONT, Version 2.7182');
write(stdout,versionstring);if baseident>0 then print(baseident);
println;fflush(stdout);{:61}{783:}jobname:=0;logopened:=false;{:783}
{792:}outputfilename:=0;{:792};{1211:}begin{657:}begin inputptr:=0;
maxinstack:=0;inopen:=0;openparens:=0;maxbufstack:=0;paramptr:=0;
maxparamstack:=0;first:=1;curinput.startfield:=1;curinput.indexfield:=0;
