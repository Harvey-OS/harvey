/* this file was automatically generated from vesa.txt originally */
 ...
 * /public/doc/vesa/cvt1.1.pdf is the Coordinated Video Timings spec.
 *
...
static Mode vesa1680x1050x60 = { 	/* untested, generated by vesacvt */
	.name = "1680x1050@60Hz",
	.x = 1680,
	.y = 1050,

	.shb = 1680,
	.shs = 1680+48,		/* 48 is hfporch */
	.ehs = 1680+48+32,	/* 32 is hsync */
	.ehb = 1680+160,
	.ht  = 1680+160,	/* 160 is hfporch+hsync+hbporch */

	.vbs = 1050,
	.vrs = 1050+3,		/* 3 is vfporch */
	.vre = 1050+3+6,	/* 6 is vsync */
	.vbe = 1050+31,
	.vt  = 1050+31,		/* 31 is vfporch+vsync+vbporch */

	.frequency = 119250000,

	.hsync = '+',		/* reduced blanking cvt */
	.vsync = '-',
	.interlace = 0,
};
...
static Mode vesa1920x1200x60 = {		/* untested */
	.name = "1920x1200@60Hz",
	.x = 1920,
	.y = 1200,

	/* h front porch 48, h sync 32, h back porch 80 */
	.shb = 1920,
	.shs = 1920+48,		/* sync start */
	.ehs = 1920+48+32,
	.ehb = 1920+48+32+80,
	.ht =  1920+48+32+80,

	/* v front porch 3, v sync 6, v back porch 26 */
	.vbs = 1200,
	.vrs = 1200+3,		/* retrace (sync) start */
	.vre = 1200+3+6,
	.vbe = 1200+3+6+26,
	.vt  = 1200+3+6+26,
