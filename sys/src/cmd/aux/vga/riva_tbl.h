...
static unsigned RivaTableFIFO[][2] = {{0x00000000, 0x80000000},
...
static unsigned nv3TablePFIFO[][2] = {{0x00000140, 0x00000000},
...
static unsigned nv3TablePGRAPH[][2] = {{0x00000020, 0x1230001F},
...
static unsigned nv3TablePRAMIN[][2] = {{0x00000500, 0x00010000},
...
static unsigned nv4TableFIFO[][2] = {{0x00003800, 0x80000014}};
static unsigned nv4TablePFIFO[][2] = {{0x00000140, 0x00000000},
                                      {0x00000480, 0x00000000},
                                      {0x00000494, 0x00000000},
                                      {0x00000481, 0x00000000},
                                      ...
                                      {0x00000140, 0x00000001}};
static unsigned nv4TablePGRAPH[][2] = {{0x00000020, 0x1231C001},
...
static unsigned nv4TablePGRAPH_8BPP[][2] = {{0x000001C9, 0x00111111},
                                            {0x00000186, 0x00001010},
                                            {0x0000020C, 0x03020202}};
static unsigned nv4TablePGRAPH_15BPP[][2] = {{0x000001C9, 0x00226222},
                                             {0x00000186, 0x00002071},
                                             {0x0000020C, 0x09080808}};
static unsigned nv4TablePGRAPH_16BPP[][2] = {{0x000001C9, 0x00556555},
                                             {0x00000186, 0x000050C2},
                                             {0x0000020C, 0x0C0B0B0B}};
static unsigned nv4TablePGRAPH_32BPP[][2] = {{0x000001C9, 0x0077D777},
                                             {0x00000186, 0x000070E5},
                                             {0x0000020C, 0x0E0D0D0D}};
static unsigned nv4TablePRAMIN[][2] = {{0x00000000, 0x80000010},
...
static unsigned nv10TableFIFO[][2] = {{0x00003800, 0x80000014}};
static unsigned nv10TablePFIFO[][2] = {{0x00000140, 0x00000000},
                                       {0x00000480, 0x00000000},
                                       {0x00000494, 0x00000000},
                                       {0x00000481, 0x00000000},
                                       {0x0000048B, 0x00000000},
                                       ...
                                       {0x00000495, 0x00000001},
                                       {0x00000140, 0x00000001}};
static unsigned nv10TablePGRAPH[][2] = {{0x00000020, 0x0003FFFF},
...
static unsigned nv10TablePGRAPH_8BPP[][2] = {{0x000001C9, 0x00111111},
                                             {0x00000186, 0x00001010},
                                             {0x0000020C, 0x03020202}};
static unsigned nv10TablePGRAPH_15BPP[][2] = {{0x000001C9, 0x00226222},
                                              {0x00000186, 0x00002071},
                                              {0x0000020C, 0x09080808}};
static unsigned nv10TablePGRAPH_16BPP[][2] = {{0x000001C9, 0x00556555},
                                              {0x00000186, 0x000050C2},
                                              {0x0000020C, 0x000B0B0C}};
static unsigned nv10TablePGRAPH_32BPP[][2] = {{0x000001C9, 0x0077D777},
                                              {0x00000186, 0x000070E5},
                                              {0x0000020C, 0x0E0D0D0D}};
static unsigned nv10tri05TablePGRAPH[][2] = {{(0x00000E00 / 4), 0x00000000},
...
static unsigned nv10TablePRAMIN[][2] = {{0x00000000, 0x80000010},
                                        {0x00000001, 0x80011145},
                                        {0x00000002, 0x80000011},
                                        {0x00000003, 0x80011146},
                                        {0x00000004, 0x80000012},
