...
static i32
doreadbios(char* buf, i32 len, i32 offset)
{
	char file[64];
...
char*
readbios(i32 len, i32 offset)
{
	static char bios[0x10000];
	static i32 biosoffset;
	static i32 bioslen;
	int n;
