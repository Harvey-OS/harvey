...
extern os_error* Drawfile_Render(drawfile_render_flags flags,
                                 drawfile_diagram const* diagram, int size,
                                 os_trfm const* trfm, wimp_box const* clip,
                                 int flatness);
...
extern os_error* Drawfile_Bbox(drawfile_bbox_flags flags,
                               drawfile_diagram const* diagram, int size,
                               os_trfm const* trfm, wimp_box* bbox);
...
extern void Drawfile_QueryBox(drawfile_info* info, wimp_box* rect,
                              BOOL screenUnits);
