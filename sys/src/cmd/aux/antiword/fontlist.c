...
vAdd2FontInfoList(const font_block_type* pFontBlock)
{
	...
	NO_DBG_DEC_C(pFontBlock->ucFontNumber != 0, pFontBlock->ucFontNumber);
	NO_DBG_DEC_C(pFontBlock->usFontSize != DEFAULT_FONT_SIZE,
	             pFontBlock->usFontSize);
	NO_DBG_DEC_C(pFontBlock->ucFontColor != 0, pFontBlock->ucFontColor);
	NO_DBG_HEX_C(pFontBlock->usFontStyle != 0x00, pFontBlock->usFontStyle);
