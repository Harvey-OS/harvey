...
#define usGetWord(i, a)                                                        \
	((unsigned short)((unsigned int)(a[(i) + 1]) << 8 |                    \
	                  (unsigned int)(a[i])))
#define ulGetLong(i, a)                                                        \
	((unsigned long)(a[i]) | (unsigned long)(a[(i) + 1]) << 8 |            \
	 (unsigned long)(a[(i) + 2]) << 16 |                                   \
	 (unsigned long)(a[(i) + 3]) << 24)
#define usGetWordBE(i, a)                                                      \
	((unsigned short)((unsigned int)(a[i]) << 8 |                          \
	                  (unsigned int)(a[(i) + 1])))
#define ulGetLongBE(i, a)                                                      \
	((unsigned long)(a[(i) + 3]) | (unsigned long)(a[(i) + 2]) << 8 |      \
	 (unsigned long)(a[(i) + 1]) << 16 | (unsigned long)(a[i]) << 24)
/* Font style macros */
...
#define bIsTableBorderBottom(x)                                                \
	(((x)&TABLE_BORDER_BOTTOM) == TABLE_BORDER_BOTTOM)
