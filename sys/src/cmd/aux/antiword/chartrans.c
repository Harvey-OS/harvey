...
static const USHORT usCp1250[] = {
    ...
    0x20ac, 0x003f, 0x201a, 0x003f, 0x201e, 0x2026, 0x2020, 0x2021, 0x003f,
    0x2030, 0x0160, 0x2039, 0x015a, 0x0164, 0x017d, 0x0179, 0x003f, 0x2018,
    0x2019, 0x201c, 0x201d, 0x2022, 0x2013, 0x2014, 0x003f, 0x2122, 0x0161,
...
static const USHORT usCp1251[] = {
    ...
    0x2019, 0x201c, 0x201d, 0x2022, 0x2013, 0x2014, 0x00f3, 0x2122, 0x0459,
...
static const USHORT usCp1252[] = {
    ...
    0x20ac, 0x003f, 0x201a, 0x0192, 0x201e, 0x2026, 0x2020, 0x2021, 0x02c6,
    0x2030, 0x0160, 0x2039, 0x0152, 0x003f, 0x017d, 0x003f, 0x003f, 0x2018,
    0x2019, 0x201c, 0x201d, 0x2022, 0x2013, 0x2014, 0x02dc, 0x2122, 0x0161,
    0x203a, 0x0153, 0x003f, 0x017e, 0x0178, 0x00a0, 0x00a1, 0x00a2, 0x00a3,
...
static const USHORT usMacRoman[] = {
    ...
    0x2202, 0x2211, 0x220f, 0x03c0, 0x222b, 0x00aa, 0x00ba, 0x2126, 0x00e6,
    ...
    0x2044, 0x00a4, 0x2039, 0x203a, 0xfb01, 0xfb02, 0x2021, 0x00b7, 0x201a,
    0x201e, 0x2030, 0x00c2, 0x00ca, 0x00c1, 0x00cb, 0x00c8, 0x00cd, 0x00ce,
    0x00cf, 0x00cc, 0x00d3, 0x00d4, 0x003f, 0x00d2, 0x00da, 0x00db, 0x00d9,
    0x0131, 0x02c6, 0x02dc, 0x00af, 0x02d8, 0x02d9, 0x02da, 0x00b8, 0x02dd,
    0x02db, 0x02c7,
};

static const USHORT usPrivateArea[] = {
    0x0020, 0x0021, 0x2200, 0x0023, 0x2203, 0x0025, 0x0026, 0x220d, 0x0028,
    ...
    0x003b, 0x003c, 0x2019, 0x003e, 0x003f, 0x201d, 0x201c, 0x0392, 0x03a7,
    ...
    0x03c2, 0x03a9, 0x039e, 0x03a8, 0x0396, 0x005b, 0x2234, 0x005d, 0x22a5,
    0x005f, 0x003f, 0x03b1, 0x03b2, 0x03c7, 0x03b4, 0x03b5, 0x03c6, 0x03b3,
    ...
    0x03b6, 0x007b, 0x007c, 0x007d, 0x223c, 0x003f, 0x003f, 0x003f, 0x003f,
    0x003f, 0x003f, 0x003f, 0x003f, 0x003f, 0x003f, 0x003f, 0x003f, 0x003f,
    0x003f, 0x003f, 0x003f, 0x003f, 0x003f, 0x003f, 0x003f, 0x2022, 0x003f,
    0x003f, 0x003f, 0x003f, 0x003f, 0x003f, 0x003f, 0x003f, 0x003f, 0x003f,
    0x003f, 0x003f, 0x20ac, 0x03d2, 0x2032, 0x2264, 0x2044, 0x221e, 0x0192,
    0x2663, 0x2666, 0x2665, 0x2660, 0x2194, 0x2190, 0x2191, 0x2192, 0x2193,
    0x00b0, 0x00b1, 0x2033, 0x2265, 0x00d7, 0x221d, 0x2202, 0x2022, 0x00f7,
    0x2260, 0x2261, 0x2248, 0x2026, 0x007c, 0x23af, 0x21b5, 0x2135, 0x2111,
    0x211c, 0x2118, 0x2297, 0x2295, 0x2205, 0x2229, 0x222a, 0x2283, 0x2287,
    0x2284, 0x2282, 0x2286, 0x2208, 0x2209, 0x2220, 0x2207, 0x00ae, 0x00a9,
    0x2122, 0x220f, 0x221a, 0x22c5, 0x00ac, 0x2227, 0x2228, 0x21d4, 0x21d0,
    0x21d1, 0x21d2, 0x21d3, 0x22c4, 0x3008, 0x00ae, 0x00a9, 0x2122, 0x2211,
...
pGetCharTableRecord(USHORT usUnicode)
{
	...
	tKey.ucLocal = 0;
	return (char_table_type*)bsearch(&tKey, atCharTable, tNextPosFree,
	                                 sizeof(atCharTable[0]), iCompare);
...
bReadCharacterMappingTable(FILE* pFile)
{
	...
	while(fgets(szLine, (int)sizeof(szLine), pFile)) {
		if(szLine[0] == '#' || szLine[0] == '\r' || szLine[0] == '\n') {
		...
		if(uiLocal > 0xff || ulUnicode > 0xffff) {
			werr(0, "Syntax error in: '%02x %04lx'", uiLocal,
			     ulUnicode);
			continue;
		}
	...
	if(tNextPosFree != 0) {
		...
		qsort(atCharTable, tNextPosFree, sizeof(atCharTable[0]),
		      iCompare);
