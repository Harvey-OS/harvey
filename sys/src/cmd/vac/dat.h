...
enum { BytesPerEntry = 100, /* estimate of bytes per dir entries - determines
                               number of index entries in the block */
       FullPercentage =
	   80, /* don't allocate in block if more than this percentage full */
