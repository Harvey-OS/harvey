...
enum { Selborder = 4,   /* border of selected window */
...
struct Mouseinfo {
	...
	uint32_t
	    lastcounter; /* serial no. of last mouse event sent to client */
	int lastb;       /* last button state we received */
	unsigned char
	    qfull; /* filled the queue; no more recording until client comes
	              back */
};
