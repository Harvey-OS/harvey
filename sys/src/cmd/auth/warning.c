...
void	douser(Fs*, char*);
void	dodir(Fs*);
int	mail(Fs*, char*, char*, i32);
int	mailin(Fs*, char*, i32, char*, char*);
void	complain(char*, ...);
i32	readnumfile(char*);
void	writenumfile(char*, i32);
 ...
 */
int
mailin(Fs *f, char *user, i32 et, char *l, char *e)
{
	int n;
	int rcvrs;
	char *p;
 ...
 */
int
mail(Fs *f, char *rcvr, char *user, i32 et)
{
	int pid, i, fd;
	int pfd[2];
	char *ct, *p;
...
void
writenumfile(char *file, i32 num)
{
	int fd;
