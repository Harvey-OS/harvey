...
static char* feedback[] = {"alpha", "bravo",   "charlie", "delta",
...
initPAKparams(void)
{
	...
	pak->p = strtomp(
	    "C41CFBE4D4846F67A3DF7DE9921A49D3B42DC33728427AB159CEC8CBB"
	    "DB12B5F0C244F1A734AEB9840804EA3C25036AD1B61AFF3ABBC247CD4B38422456"
	    "7A86"
	    ...
	    nil, 16, nil);
	pak->r =
	    strtomp("DF310F4E54A5FEC5D86D3E14863921E834113E060F90052AD332B3241"
	            "CEF2497EFA0303D6344F7C819691A0F9C4A773815AF8EAECFB7EC1D98F"
	            "039F17A32A7E"
	            "887D97251A927D093F44A55577F4D70444AEBD06B9B45695EC23962B17"
	            "5F266895C67D"
	            "21C4656848614D888A4",
	            nil, 16, nil);
	pak->g = strtomp(
	    "2F1C308DC46B9A44B52DF7DACCE1208CCEF72F69C743ADD4D23271734"
	    "44ED6E65E074694246E07F9FD4AE26E0FDDD9F54F813C40CB9BCD4338EA6F242AB"
	    "94CD"
	    "410E676C290368A16B1A3594877437E516C53A6EEE5493A038A017E955E218E781"
	    "9734"
...
PAKserver(SConn* conn, char* S, char* mess, PW** pwp)
{
	...
	char* C, ks[41], *kc, *hexm, * hexmu = nil, * hexsigma = nil,
	                               * hexHi = nil;
	uint8_t digest[SHA1dlen];
	mpint* H = mpnew(0), * Hi = mpnew(0);
