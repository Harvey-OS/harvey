...
/*
 *
 * ROWS and COLUMNS set the dimensions of the horizontal and vertical tab
 *arrays.
 * The way I've implemented both kinds of tabs leaves something to be desired,
 *but
 * it was simple and should be good enough for now. If arrays are going to be
 *used
