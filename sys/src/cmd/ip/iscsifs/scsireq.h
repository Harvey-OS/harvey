...
enum {					/* SCSI command codes */
	...
	ScmdReportlun = 0xA0,	/* report luns */
...
long SRreportlun(ScsiReq*, uchar*, long);
...
long SRfwaddr(ScsiReq*, uchar, uchar, uchar, uchar*);	/* old CD-R/CD-RW commands */
...
long iscsirequest(struct Iscsi*, ScsiPtr*, ScsiPtr*, int*);
