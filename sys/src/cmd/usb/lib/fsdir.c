...
static void
fsclone(Usbfs* unused, Fid *o, Fid *n)
{
	int qd;
	Dev *dev;
...
static int
fswalk(Usbfs* unused, Fid *fid, char *name)
{
	Qid q;
	int qd, qf;
	int i;
...
static int
fsopen(Usbfs* unused, Fid *fid, int mode)
{
	int qd;
	int rc;
	Dev *dev;
...
static int
dirgen(Usbfs* unused, Qid qunused, int n, Dir *d, void * vunused)
{
	int i;
	Dev *dev;
	char *nm;
...
static i32
fsread(Usbfs* unused, Fid *fid, void *data, i32 cnt, i64 off)
{
	int qd;
	int rc;
	Dev *dev;
	Qid q;
	i32 (*xfsread)(Usbfs *fs, Fid *f, void *data, i32 count, i64 );
...
static i32
fswrite(Usbfs* unused, Fid *fid, void *data, i32 cnt, i64 off)
{
	int qd;
	int rc;
	Dev *dev;
	i32 (*xfswrite)(Usbfs *fs, Fid *f, void *data, i32 count, i64 );
...
static int
fsstat(Usbfs* unused, Qid qid, Dir *d)
{
	int qd;
	int rc;
	Dev *dev;
