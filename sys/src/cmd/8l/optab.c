...
uint8_t ynop[] = {Ynone,   Ynone, Zpseudo, 1,       Ynone,   Yml, Zpseudo,
                  1,       Ynone, Yrf,     Zpseudo, 1,       Yml, Ynone,
                  Zpseudo, 1,     Yrf,     Ynone,   Zpseudo, 1,   0};
...
uint8_t yincl[] = {Ynone, Yrl, Z_rp, 1, Ynone, Yml, Zo_m, 2, 0};
...
uint8_t ymovl[] = {
    Yrl,  Yml, Zr_m,   1, Yml,  Yrl, Zm_r,   1, Yi0,    Yrl, Zclr,   1 + 2,
    //	Yi0,	Yml,	Zibo_m,	2,	// shorter but slower AND $0,dst
    Yi32, Yrl, Zil_rp, 1, Yi32, Yml, Zilo_m, 2, Yiauto, Yrl, Zaut_r, 2,     0};
uint8_t ym_rl[] = {Ym, Yrl, Zm_r, 1, 0};
uint8_t yrl_m[] = {Yrl, Ym, Zr_m, 1, 0};
uint8_t ymb_rl[] = {Ymb, Yrl, Zm_r, 1, 0};
...
uint8_t yimul[] = {Yml, Ynone, Zm_o, 2,      Yi8, Yrl, Zib_rr,
                   1,   Yi32,  Yrl,  Zil_rr, 1,   0};
uint8_t ybyte[] = {Yi32, Ynone, Zbyte, 1, 0};
...
uint8_t ycall[] = {Ynone, Yml, Zo_m, 2, Ynone, Ybr, Zcall, 1, 0};
uint8_t yjmp[] = {Ynone, Yml, Zo_m, 2, Ynone, Ybr, Zjmp, 1, 0};
