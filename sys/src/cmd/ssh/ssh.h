...
// extern Cipher cipherrc4;		/* deprecated */
...
/* config.c */
void	conninit(Conn *conn, int fd, char *user, char *host);
Cipher*	findcipher(char *name, Cipher **list, int nlist);
