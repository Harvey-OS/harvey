...
struct Header
{
	...
	u8	*sf;	/* start of frame; do better later */
	u8	*ss;	/* start of scan; do better later */
...
static
void
huffmantables(Header *h, u8 *b, int n)
{
	int l, mt;
...
static
void
quanttables(Header *h, u8 *b, int n)
{
	int l, m;
