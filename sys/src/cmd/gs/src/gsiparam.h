...
#define public_st_gs_pixel_image() /* in gximage.c */                          \
	gs_public_st_ptrs1(st_gs_pixel_image, gs_pixel_image_t,                \
	                   "gs_data_image_t", pixel_image_enum_ptrs,           \
	                   pixel_image_reloc_ptrs, ColorSpace)
...
#define public_st_gs_image1() /* in gximage1.c */                              \
	gs_public_st_suffix_add0(st_gs_image1, gs_image1_t, "gs_image1_t",     \
	                         image1_enum_ptrs, image1_reloc_ptrs,          \
	                         st_gs_pixel_image)
...
void
     ...
     * if num_components = N < 0, sets the first -N elements of Decode to (1,
     * 0);
...
void gs_image_t_init_adjust(gs_image_t* pim, const gs_color_space* pcs,
                            bool adjust);
#define gs_image_t_init(pim, pcs) gs_image_t_init_adjust(pim, pcs, true)
void gs_image_t_init_mask_adjust(gs_image_t* pim, bool write_1s, bool adjust);
