...
/* Copyright (C) 1989, 1995, 1996, 1997, 1999, 2000, 2002 Aladdin Enterprises.
  All rights reserved.
...
#define font_proc_define_font(proc) int proc(gs_font_dir*, gs_font*)
...
#define font_proc_decode_glyph(proc) gs_char proc(gs_font*, gs_glyph)
...
#define font_proc_glyph_outline(proc)                                          \
	int proc(gs_font* font, int WMode, gs_glyph glyph,                     \
...
#define font_proc_init_fstack(proc) int proc(gs_text_enum_t*, gs_font*)
...
#define public_st_gs_font()             /* in gsfont.c */                      \
	gs_public_st_complex_only(st_gs_font, gs_font, "gs_font", 0,           \
...
#define public_st_gs_font_ptr_element() /* in gsfont.c */                      \
	gs_public_st_element(st_gs_font_ptr_element, gs_font*, "gs_font *[]",  \
	                     font_ptr_element_enum_ptrs,                       \
	                     font_ptr_element_reloc_ptrs, st_gs_font_ptr)

/* Allocate and minimally initialize a font. */
/* Does not set: FontMatrix, FontType, key_name, font_name. */
gs_font* gs_font_alloc(gs_memory_t* mem, gs_memory_type_ptr_t pstype,
...
#define gs_font_base_common                                                     \
	...
	gs_encoding_index_t                                                     \
	    nearest_encoding_index /* (may be >= 0 even if */ /* encoding_index \
	                                                         = -1) */
...
#define public_st_gs_font_base() /* in gsfont.c */                             \
	gs_public_st_suffix_add1_final(st_gs_font_base, gs_font_base,          \
	                               "gs_font_base", font_base_enum_ptrs,    \
	                               font_base_reloc_ptrs, gs_font_finalize, \
...
gs_font_base* gs_font_base_alloc(gs_memory_t* mem, gs_memory_type_ptr_t pstype,
                                 const gs_font_procs* procs, gs_font_dir* dir,
                                 client_name_t cname);
