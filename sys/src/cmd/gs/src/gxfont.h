...
#define public_st_gs_font_info() /* in gsfont.c */                                                                                                                                                                                  \
	BASIC_PTRS(gs_font_info_ptrs){GC_CONST_STRING_ELT(gs_font_info_t, Copyright), GC_CONST_STRING_ELT(gs_font_info_t, Notice), GC_CONST_STRING_ELT(gs_font_info_t, FamilyName), GC_CONST_STRING_ELT(gs_font_info_t, FullName)}; \
...
#define gs_font_base_common                 \
	...
	gs_encoding_index_t nearest_encoding_index /* (may be >= 0 even if */ /* encoding_index = -1) */
