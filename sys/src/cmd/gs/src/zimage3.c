...
zimage3(i_ctx_t* i_ctx_p)
{
	...
	if((code = pixel_image_params(i_ctx_p, pDataDict,
	                              ...
	                              false)) < 0 ||
	   (mcode = code =
	        data_image_params(imemory, pMaskDict, &image.MaskDict, &ip_mask,
	                          false, 1, 12, false)) < 0 ||
...
const op_def zimage3_op_defs[] = {op_def_begin_ll3(),
                                  {"1.image3", zimage3},
                                  {"1.image4", zimage4},
                                  op_def_end(0)};
