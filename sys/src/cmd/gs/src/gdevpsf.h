...
struct psf_glyph_enum_s {
	...
	struct su_ {
		union sus_ {
			...
			const byte*
			    bits; /* if CID or TT subset given by a bitmap */
		} selected;
		uint size;
	} subset;
...
typedef int (*glyph_data_proc_t)(gs_font_base*, gs_glyph, gs_glyph_data_t*,
                                 gs_font_type1**);

/* Check that all selected glyphs can be written. */
int psf_check_outline_glyphs(gs_font_base* pfont, psf_glyph_enum_t* ppge,
 ...
 */
int psf_get_outline_glyphs(psf_outline_glyphs_t* pglyphs, gs_font_base* pfont,
...
int psf_type1_glyph_data(gs_font_base*, gs_glyph, gs_glyph_data_t*,
                         gs_font_type1**);
int psf_get_type1_glyphs(psf_outline_glyphs_t* pglyphs, gs_font_type1* pfont,
                         gs_glyph* subset_glyphs, uint subset_size);
