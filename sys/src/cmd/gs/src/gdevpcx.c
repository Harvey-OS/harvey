...
private
dev_proc_print_page(pcx256_print_page);

private
const gx_device_procs pcxgray_procs = prn_color_procs(
    gdev_prn_open, gdev_prn_output_page, gdev_prn_close,
    gx_default_gray_map_rgb_color, gx_default_gray_map_color_rgb);
const gx_device_printer gs_pcxgray_device = {prn_device_body(
    gx_device_printer, pcxgray_procs, "pcxgray", DEFAULT_WIDTH_10THS,
    DEFAULT_HEIGHT_10THS, X_DPI, Y_DPI, 0, 0, 0, 0, /* margins */
...
private
dev_proc_print_page(pcx16_print_page);

private
const gx_device_procs pcx16_procs =
    prn_color_procs(gdev_prn_open, gdev_prn_output_page, gdev_prn_close,
                    pc_4bit_map_rgb_color, pc_4bit_map_color_rgb);
const gx_device_printer gs_pcx16_device = {prn_device_body(
    gx_device_printer, pcx16_procs, "pcx16", DEFAULT_WIDTH_10THS,
    DEFAULT_HEIGHT_10THS, X_DPI, Y_DPI, 0, 0, 0, 0, /* margins */
...
private
const gx_device_procs pcx256_procs =
    prn_color_procs(gdev_prn_open, gdev_prn_output_page, gdev_prn_close,
                    pc_8bit_map_rgb_color, pc_8bit_map_color_rgb);
const gx_device_printer gs_pcx256_device = {prn_device_body(
    gx_device_printer, pcx256_procs, "pcx256", DEFAULT_WIDTH_10THS,
    DEFAULT_HEIGHT_10THS, X_DPI, Y_DPI, 0, 0, 0, 0, /* margins */
...
private
dev_proc_print_page(pcx24b_print_page);

private
const gx_device_procs pcx24b_procs =
    prn_color_procs(gdev_prn_open, gdev_prn_output_page, gdev_prn_close,
                    gx_default_rgb_map_rgb_color, gx_default_rgb_map_color_rgb);
const gx_device_printer gs_pcx24b_device =
    prn_device(pcx24b_procs, "pcx24b", DEFAULT_WIDTH_10THS,
               DEFAULT_HEIGHT_10THS, X_DPI, Y_DPI, 0, 0, 0, 0, /* margins */
...
private
dev_proc_print_page(pcxcmyk_print_page);

private
const gx_device_procs pcxcmyk_procs = {
    gdev_prn_open, NULL,                        /* get_initial_matrix */
    NULL,                                       /* sync_output */
    gdev_prn_output_page, gdev_prn_close, NULL, /* map_rgb_color */
    cmyk_1bit_map_color_rgb, NULL,              /* fill_rectangle */
    NULL,                                       /* tile_rectangle */
    NULL,                                       /* copy_mono */
    NULL,                                       /* copy_color */
    NULL,                                       /* draw_line */
    NULL,                                       /* get_bits */
    gdev_prn_get_params, gdev_prn_put_params, cmyk_1bit_map_cmyk_color,
    NULL, /* get_xfont_procs */
    NULL, /* get_xfont_device */
    NULL, /* map_rgb_alpha_color */
    gx_page_device_get_page_device};
const gx_device_printer gs_pcxcmyk_device = {prn_device_body(
    gx_device_printer, pcxcmyk_procs, "pcxcmyk", DEFAULT_WIDTH_10THS,
    DEFAULT_HEIGHT_10THS, X_DPI, Y_DPI, 0, 0, 0, 0, /* margins */
...
private
int pcx_write_page(gx_device_printer*, FILE*, pcx_header*, bool);
...
pcx16_print_page(gx_device_printer* pdev, FILE* file)
{
	...
	memcpy((byte*)header.palette, pcx_ega_palette, sizeof(pcx_ega_palette));
...
pcx256_print_page(gx_device_printer* pdev, FILE* file)
{
	...
	assign_ushort(header.palinfo,
	              (pdev->color_info.num_components > 1 ? palinfo_color
	                                                   : palinfo_gray));
