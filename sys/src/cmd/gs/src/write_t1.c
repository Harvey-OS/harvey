...
static void
write_word_entry(FAPI_font *a_fapi_font, WRF_output *a_output, const char *a_name, int a_index, int a_divisor)
{
	int16_t x;
	WRF_wbyte(a_output, '/');
...
static void
write_array_entry_with_count(FAPI_font *a_fapi_font, WRF_output *a_output, const char *a_name, int a_index, int a_count, int a_divisor)
{
	int i;
...
static void
write_array_entry(FAPI_font *a_fapi_font, WRF_output *a_output, const char *a_name, int a_index, int a_divisor)
{
...
*/
int32_t
FF_serialize_type1_font(FAPI_font *a_fapi_font, unsigned char *a_buffer, int32_t a_buffer_size)
{
	WRF_output output;
