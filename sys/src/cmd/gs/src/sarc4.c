...
private_st_arcfour_state(); /* creates a gc object for our state, defined in
                               sarc4.h */
...
/* stream template */
const stream_template s_arcfour_template = {&st_arcfour_state, NULL,
                                            s_arcfour_process, 1, 1};
