...
#define device_procs(get_color_mapping_procs)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                \
	{                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \
		psd_prn_open, gx_default_get_initial_matrix, NULL, /* sync_output */ gdev_prn_output_page, /* output_page */ gdev_prn_close, /* close */ NULL, /* map_rgb_color - not used */ psd_map_color_rgb, /* map_color_rgb */ NULL, /* fill_rectangle */ NULL, /* tile_rectangle */ NULL, /* copy_mono */ NULL, /* copy_color */ NULL, /* draw_line */ NULL, /* get_bits */ psd_get_params, /* get_params */ psd_put_params, /* put_params */ NULL, /* map_cmyk_color - not used */ NULL, /* get_xfont_procs */ NULL, /* get_xfont_device */ NULL, /* map_rgb_alpha_color */ gx_page_device_get_page_device, /* get_page_device */ NULL, /* get_alpha_bits */ NULL, /* copy_alpha */ NULL, /* get_band */ NULL, /* copy_rop */ NULL, /* fill_path */ NULL, /* stroke_path */ NULL, /* fill_mask */ NULL, /* fill_trapezoid */ NULL, /* fill_parallelogram */ NULL, /* fill_triangle */ NULL, /* draw_thin_line */ NULL, /* begin_image */ NULL, /* image_data */ NULL, /* end_image */ NULL, /* strip_tile_rectangle */ NULL, /* strip_copy_rop */ NULL, /* get_clipping_box */ NULL, /* begin_typed_image */ NULL, /* get_bits_rectangle */ NULL, /* map_color_rgb_alpha */ NULL, /* create_compositor */ NULL, /* get_hardware_params */ NULL, /* text_begin */ NULL, /* finish_copydevice */ NULL, /* begin_transparency_group */ NULL, /* end_transparency_group */ NULL, /* begin_transparency_mask */ NULL, /* end_transparency_mask */ NULL, /* discard_transparency_layer */ get_color_mapping_procs, /* get_color_mapping_procs */ psd_get_color_comp_index, /* get_color_comp_index */ psd_encode_color, /* encode_color */ psd_decode_color, /* decode_color */ NULL, /* pattern_manage */ NULL, /* fill_rectangle_hl_color */ NULL, /* include_color_space */ NULL, /* fill_linear_color_scanline */ NULL, /* fill_linear_color_trapezoid */ NULL, /* fill_linear_color_triangle */ psd_update_spot_equivalent_colors /* update_spot_equivalent_colors */ \
	}
 ...
 */
private
const gx_device_procs spot_rgb_procs = device_procs(get_psdrgb_color_mapping_procs);
 ...
 */
private
const gx_device_procs spot_cmyk_procs = device_procs(get_psd_color_mapping_procs);
...
psd_write_header(psd_write_ctx *xc, psd_device *pdev)
{
	...
	psd_write_32(xc, 12 + (chan_names_len + (chan_names_len % 2)) + (12 + (14 * (xc->num_channels - xc->base_bytes_pp))) + 28);
...
#define convert_color(component) ((bits16)((65535 * ((double)(frac_1 - pdev->equiv_cmyk_colors.color[sep_num].component)) / frac_1)))
