...
#define cs_proc_num_components(proc) int proc(const gs_color_space*)
#define cs_num_components(pcs) (*(pcs)->type->num_components)(pcs)
...
#define cs_base_space(pcs) (*(pcs)->type->base_space)(pcs)
...
#define cs_init_color(pcc, pcs) (*(pcs)->type->init_color)(pcc, pcs)
...
#define cs_proc_restrict_color(proc)                                           \
	void proc(gs_client_color*, const gs_color_space*)
#define cs_restrict_color(pcc, pcs) ((pcs)->type->restrict_color(pcc, pcs))
...
#define cs_concrete_space(pcs, pis) (*(pcs)->type->concrete_space)(pcs, pis)
...
#define cs_proc_concretize_color(proc)                                         \
	int proc(const gs_client_color*, const gs_color_space*, frac*,         \
	         const gs_imager_state*)
...
#define cs_proc_install_cspace(proc) int proc(const gs_color_space*, gs_state*)
...
#define cs_proc_set_overprint(proc) int proc(const gs_color_space*, gs_state*)
	cs_proc_set_overprint((*set_overprint));

/* Adjust reference counts of indirect color space components. */

#define cs_proc_adjust_cspace_count(proc) void proc(const gs_color_space*, int)
#define cs_adjust_cspace_count(pgs, delta)                                     \
	(*(pgs)->color_space->type->adjust_cspace_count)((pgs)->color_space,   \
	                                                 delta)
...
#define cs_proc_serialize(proc) int proc(const gs_color_space*, stream*)
#define cs_serialize(pcs, s) (*(pcs)->type->serialize)(pcs, s)
 ...
 */
void gs_cspace_init(gs_color_space* pcs, const gs_color_space_type* pcstype,
                    gs_memory_t* mem, bool isheap);
int gs_cspace_alloc(gs_color_space** ppcspace,
                    const gs_color_space_type* pcstype, gs_memory_t* mem);
