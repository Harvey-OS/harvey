...
#define max_value_rgb(rgb_depth, gray_depth) \
	(rgb_depth >= 8 ? 255 : rgb_depth == 4 ? 15 : rgb_depth == 2 ? 3 : rgb_depth == 1 ? 1 : (1 << gray_depth) - 1)
