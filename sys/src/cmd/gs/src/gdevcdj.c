...
private
int cdj_param_check_bytes(gs_param_list *, gs_param_name, const byte *, uint, bool);
private
...
#define bjcversion(p) (((gx_device_bjc *)pdev)->ptype == BJC800 ? BJC_BJC800_VERSION : BJC_BJC600_VERSION)
#define bjcversionstring(p) (((gx_device_bjc *)pdev)->ptype == BJC800 ? BJC_BJC800_VERSIONSTR : BJC_BJC600_VERSIONSTR)
...
#define cdj_device(procs, dev_name, x_dpi, y_dpi, bpp, print_page, correction, shingling, depletion)                                  \
	{                                                                                                                             \
		prn_hp_colour_device(gx_device_cdj, procs, dev_name, x_dpi, y_dpi, bpp, print_page, correction), shingling, depletion \
	}

#define pjxl_device(procs, dev_name, x_dpi, y_dpi, bpp, print_page, printqual, rendertype)                                     \
	{                                                                                                                      \
		prn_hp_colour_device(gx_device_pjxl, procs, dev_name, x_dpi, y_dpi, bpp, print_page, 0), printqual, rendertype \
	}
...
#define bjc600_device(procs, dev_name, x_dpi, y_dpi, bpp, print_page, t, mf, mt, mws, mw, pq, dt, cc, pc, mp)                                   \
	{                                                                                                                                       \
		bjc_device(gx_device_bjc600, procs, dev_name, x_dpi, y_dpi, bpp, print_page, 0), t, 0., { mf, mt, mws, mw, pq, dt, cc, pc, mp } \
	}
#define bjc800_device(procs, dev_name, x_dpi, y_dpi, bpp, print_page, t, mf, mt, mws, mw, pq, dt, cc, pc)                                   \
	{                                                                                                                                   \
		bjc_device(gx_device_bjc800, procs, dev_name, x_dpi, y_dpi, bpp, print_page, 0), t, 0., { mf, mt, mws, mw, pq, dt, cc, pc } \
	}

#define hp_colour_procs(proc_colour_open, proc_get_params, proc_put_params)                                                                                                                                                                                                                                                                                   \
	{                                                                                                                                                                                                                                                                                                                                                     \
		proc_colour_open, gx_default_get_initial_matrix, gx_default_sync_output, gdev_prn_output_page, gdev_prn_close, gdev_pcl_map_rgb_color, gdev_pcl_map_color_rgb, NULL, /* fill_rectangle */ NULL, /* tile_rectangle */ NULL, /* copy_mono */ NULL, /* copy_color */ NULL, /* draw_line */ gx_default_get_bits, proc_get_params, proc_put_params \
	}

#define cmyk_colour_procs(proc_colour_open, proc_get_params, proc_put_params)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \
	{                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         \
		proc_colour_open, gx_default_get_initial_matrix, gx_default_sync_output, gdev_prn_output_page, gdev_prn_close, NULL /* map_rgb_color */, NULL /* map_color_rgb */, NULL /* fill_rectangle */, NULL /* tile_rectangle */, NULL /* copy_mono */, NULL /* copy_color */, NULL /* draw_line */, gx_default_get_bits, proc_get_params, proc_put_params, gdev_cmyk_map_cmyk_color, NULL, /* get_xfont_procs */ NULL, /* get_xfont_device */ NULL, /* map_rgb_alpha_color */ NULL, /* get_page_device */ NULL, /* get_alpha_bits */ NULL, /* copy_alpha */ NULL, /* get_band */ NULL, /* copy_rop */ NULL, /* fill_path */ NULL, /* stroke_path */ NULL, /* fill_mask */ NULL, /* fill_trapezoid */ NULL, /* fill_parallelogram */ NULL, /* fill_triangle */ NULL, /* draw_thin_line */ NULL, /* begin_image */ NULL, /* image_data */ NULL, /* end_image */ NULL, /* strip_tile_rectangle */ NULL, /* strip_copy_rop */ NULL, /* get_clipping_box */ NULL, /* begin_typed_image */ NULL, /* get_bits_rectangle */ NULL, /* map_color_rgb_alpha */ NULL, /* create_compositor */ NULL, /* get_hardware_params */ NULL, /* text_begin */ NULL, /* finish_copydevice */ NULL, /* begin_transparency_group */ NULL, /* end_transparency_group */ NULL, /* begin_transparency_mask */ NULL, /* end_transparency_mask */ NULL, /* discard_transparency_layer */ NULL, /* get_color_mapping_procs */ NULL, /* get_color_comp_index */ gdev_cmyk_map_cmyk_color, /* encode_color */ gdev_cmyk_map_color_cmyk /* decode_color */ \
	}
...
private
int put_param_string(gs_param_list *, const byte *,
		     gs_param_string *, const stringParamDescription *, int *, int);
private
int get_param_string(gs_param_list *, const byte *,
...
{ /* Change the margins if necessary. */
	...
	case PJXL180:
		...
		break;
	case ESC_P:
		m = (gdev_pcl_paper_size(pdev) == PAPER_SIZE_A4 ? ep_a4 : ep_letter);
		break;
	case BJC600:
	case BJC800:
     ...
     */
		...
		/**/ {
			...
			byte pdimen = (byte)(pdev->height / pdev->y_pixels_per_inch * 10. - bjcm[3] * 10. - bjcm[1] * 10. + .5) + 1;
			do {
				--pdimen;
				bjcm[1] = pdev->height / pdev->y_pixels_per_inch - bjcm[3] - (float)pdimen / 10.;
...
bjc_get_params(gx_device *pdev, gs_param_list *plist)
{
	...
	code = get_param_string(plist, (unsigned char *)BJC_OPTION_PRINTQUALITY, &pquality,
				(bjc->ptype == BJC800 ? bjc800_printQualityStrings : bjc600_printQualityStrings), bjcparams.printQuality,
				true, code);
	...
	if((ncode = (bjcparams.mediaWeight_isSet ? param_write_int(plist, BJC_OPTION_MEDIAWEIGHT,
...
bjc_put_params(gx_device *pdev, gs_param_list *plist)
{
	...
	code = put_param_string(plist, (unsigned char *)BJC_OPTION_PRINTQUALITY, &pquality,
				(bjc->ptype == BJC800 ? bjc800_printQualityStrings : bjc600_printQualityStrings), &params->printQuality, code);
...
bjc_init_page(gx_device_printer *pdev, FILE *f)
{
	...
	pagemargins[0] = (byte)((float)pdev->height / pdev->y_pixels_per_inch * 10 + .5);
...
/* Set printing method. */
	...
	if(0) {
		...
		printmeth[2] = (bjcparams.printQuality == BJC_QUALITY_HIGH ? 0x10 : 0) + (bjcparams.mediaType >= BJC_MEDIA_ENVELOPE ? 1 : bjc600thickpaper());
...
hp_colour_print_page(gx_device_printer *pdev, FILE *prn_stream, int ptype)
{
	...
	ep_storage_size_words = (plane_size * (num_comps + 1)) / W * img_rows + 16; /* Redundant space for sentinel and aligning. */
...
#define BOFFSET (dev_t_margin(pdev) - bjc->printLimit)
   ...
   * mode can give both computational and PCL file size advantages. */
	 ...
	 * an obscure bug in the printer's firmware */
		...
		default:
			start_rows = (num_comps == 1) ? HEAD_ROWS_MONO - 1 : HEAD_ROWS_COLOUR - 1;
			break;
		}
...
gdev_cmyk_map_cmyk_color(gx_device *pdev, const gx_color_value cv[])
{
	...
	case 1:
		color = (cyan | magenta | yellow | black) > gx_max_color_value / 2 ? (gx_color_index)1 : (gx_color_index)0;
		break;
...
gdev_cmyk_map_rgb_color(gx_device *pdev, const gx_color_value cv[])
{
	...
	if(gx_color_value_to_byte(r & g & b) == 0xff) {
		...
		case 8:
			return ((uint32_t)c * lum_red_weight * 10 + (uint32_t)m * lum_green_weight * 10 + (uint32_t)y * lum_blue_weight * 10) >> (gx_color_value_bits + 2);
			/*NOTREACHED*/
			break;
		}
	}
	...
	if(cmyk > 0) {
		...
		if(bpp == 24) {
			...
			while(in > start) {
				...
				*--out = (b0 << 2) + ((b0 >> 4) & 0x03);
				*--out = ((b1 & 0x0f) << 4) + ((b0 >> 6) << 2) + ((b1 >> 2) & 0x03);
...
gdev_prn_rasterwidth(const gx_device_printer *pdev, int pixelcount)
{
	...
	return (pixelcount ? (uint)raster_width : (uint)((raster_width * pdev->color_info.depth + 7) >> 3));
}
