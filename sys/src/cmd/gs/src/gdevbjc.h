...
#define BJC_MARGINS_LETTER                                                     \
	(float)(6.5 / 25.4), (float)BJC_LOWER_LIMIT, (float)(6.5 / 25.4),      \
	    (float)BJC_PRINT_LIMIT
#define BJC_MARGINS_A4                                                         \
	(float)(3.4 / 25.4), (float)BJC_LOWER_LIMIT, (float)(3.4 / 25.4),      \
	    (float)BJC_PRINT_LIMIT
#define BJC_MARGINS_A3                                                         \
	(float)(4.0 / 25.4), (float)BJC_LOWER_LIMIT, (float)(4.0 / 25.4),      \
	    (float)BJC_A3_PRINT_LIMIT
