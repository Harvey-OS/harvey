...
#define build_function_proc(proc)                                              \
	int proc(i_ctx_t* i_ctx_p, const ref* op,                              \
	         const gs_function_params_t* params, int depth,                \
 ...
 */
int fn_build_float_array_forced(const ref* op, const char* kstr, bool required,
