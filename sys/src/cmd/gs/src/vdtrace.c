...
private
void
vd_flatten(double p0x, double p0y, double p1x, double p1y, double p2x, double p2y, double p3x, double p3y)
{
#ifdef DEBUG
	double flat = 0.5;
...
void
vd_impl_curveto(double x1, double y1, double x2, double y2, double x3, double y3)
{
...
void
vd_impl_quad(double x0, double y0, double x1, double y1, double x2, double y2, double x3, double y3, int w, unsigned int c)
{
	NullRET;
	vd_trace1->setcolor(vd_trace1, c);
	vd_trace1->setlinewidth(vd_trace1, w);
...
void
vd_impl_curve(double x0, double y0, double x1, double y1, double x2, double y2, double x3, double y3, int w, unsigned long c)
{
	NullRET;
	vd_trace1->setcolor(vd_trace1, c);
	vd_trace1->setlinewidth(vd_trace1, w);
