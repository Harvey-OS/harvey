...
/* Copyright (C) 1992, 1995, 1996, 1999 Aladdin Enterprises.  All rights
  reserved.
...
#define gs_init1() gs_main_init1(gs_main_instance_default())

#define gs_init2() gs_main_init2(gs_main_instance_default())

#define gs_add_lib_path(path)                                                  \
	gs_main_add_lib_path(gs_main_instance_default(), path)

#define gs_set_lib_paths() gs_main_set_lib_paths(gs_main_instance_default())
...
#define gs_run_string_with_length(str, len, ue, pec, peo)                      \
	gs_main_run_string_with_length(gs_main_instance_default(), str, len,   \
	                               ue, pec, peo)
...
#define gs_run_string_continue(str, len, ue, pec, peo)                         \
	gs_main_run_string_continue(gs_main_instance_default(), str, len, ue,  \
	                            pec, peo)
