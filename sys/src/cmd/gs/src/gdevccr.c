...
#define ccr_prn_device(procs, dev_name, margin, num_comp, depth, max_gray, max_rgb, print_page)                                                                                                                                           \
	{                                                                                                                                                                                                                                 \
		prn_device_body(gx_device_ccr, procs, dev_name, DEFAULT_WIDTH_10THS_A3, DEFAULT_HEIGHT_10THS_A3, X_DPI, Y_DPI, margin, margin, margin, margin, num_comp, depth, max_gray, max_rgb, max_gray + 1, max_rgb + 1, print_page) \
	}
