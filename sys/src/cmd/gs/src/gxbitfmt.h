...
#define GB_COLORS_STANDARD_ALL (GB_COLORS_GRAY | GB_COLORS_RGB | GB_COLORS_CMYK)
#define GB_COLORS_ALL (GB_COLORS_NATIVE | GB_COLORS_STANDARD_ALL)
...
#define GB_ALPHA_ALL (GB_ALPHA_NONE | GB_ALPHA_FIRST | GB_ALPHA_LAST)
...
#define GB_DEPTH_ALL                                                           \
	(GB_DEPTH_1 | GB_DEPTH_2 | GB_DEPTH_4 | GB_DEPTH_8 | GB_DEPTH_12 |     \
	 GB_DEPTH_16)
#define GB_DEPTH_NAMES                                                         \
	"depth_1", "depth_2", "depth_4", "depth_8", "depth_12", "depth_16",    \
	    "?depth_unused1?", "?depth_unused2?"
...
#define GB_OPTIONS_DEPTH(opt)                                                  \
	((((opt) >> 8) & 0xf) | "\000\000\014\020"[((opt) >> 12) & 3])
...
#define GB_SELECT_ALL (GB_SELECT_PLANES)
#define GB_SELECT_NAMES "select_planes"
...
#define GB_RETURN_ALL (GB_RETURN_COPY | GB_RETURN_POINTER)
#define GB_RETURN_NAMES "return_copy", "return_pointer"
...
#define GB_ALIGN_ALL (GB_ALIGN_ANY | GB_ALIGN_STANDARD)
#define GB_ALIGN_NAMES "align_standard", "align_any"
...
#define GB_OFFSET_ALL (GB_OFFSET_0 | GB_OFFSET_SPECIFIED | GB_OFFSET_ANY)
...
#define GB_RASTER_ALL (GB_RASTER_STANDARD | GB_RASTER_SPECIFIED | GB_RASTER_ANY)
#define GB_RASTER_NAMES "raster_standard", "raster_specified", "raster_any"
