...
#define public_st_gs_font_cid_data() /* in gsfcid.c */                         \
	gs_public_st_suffix_add0_final(                                        \
	    st_gs_font_cid_data, gs_font_cid_data, "gs_font_cid_data",         \
	    font_cid_data_enum_ptrs, font_cid_data_reloc_ptrs,                 \
	    gs_font_finalize, st_cid_system_info)
#define st_gs_font_cid_data_num_ptrs st_cid_system_info_num_ptrs
...
#define public_st_gs_font_cid0() /* in gsfcid.c */                             \
	gs_public_st_composite_use_final(                                      \
	    st_gs_font_cid0, gs_font_cid0, "gs_font_cid0",                     \
...
#define public_st_gs_font_cid1() /* in gsfcid.c */                             \
	gs_public_st_composite_use_final(                                      \
	    st_gs_font_cid1, gs_font_cid1, "gs_font_cid1",                     \
...
#define public_st_gs_font_cid2() /* in gsfcid.c */                             \
	gs_public_st_composite_use_final(                                      \
	    st_gs_font_cid2, gs_font_cid2, "gs_font_cid2",                     \
