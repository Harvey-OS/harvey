...
#define GS_NOTIFY_PROC(proc) int proc(void* proc_data, void* event_data)
...
#define private_st_gs_notify_registration() /* in gsnotify.c */                \
	gs_private_st_ptrs2(                                                   \
	    st_gs_notify_registration, gs_notify_registration_t,               \
...
#define public_st_gs_notify_list() /* in gsnotify.c */                         \
	gs_public_st_ptrs1(st_gs_notify_list, gs_notify_list_t,                \
	                   "gs_notify_list_t", notify_list_enum_ptrs,          \
	                   notify_list_reloc_ptrs, first)
...
int gs_notify_unregister_calling(gs_notify_list_t* nlist, gs_notify_proc_t proc,
                                 void* proc_data,
