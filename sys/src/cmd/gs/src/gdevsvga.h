...
#define svga_color_device(procs, name, depth, maxv, dither, get_mode,          \
                          set_mode, set_page)                                  \
	{                                                                      \
		std_device_color_body(                                         \
		    gx_device_svga, &procs, name, 640, 480,                    \
		    480 / PAGE_HEIGHT_INCHES, 480 / PAGE_HEIGHT_INCHES,        \
		    /*dci_color(*/ depth, maxv, dither /*)*/),                 \
		    {0},                            /* std_procs */            \
		    get_mode, set_mode, set_page, 0 /*fixed_colors*/           \
	}
