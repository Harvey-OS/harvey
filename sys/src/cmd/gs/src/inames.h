...
name_table* names_init(uint32_t size, gs_ref_memory_t* imem);
...
name_index_t names_index(const name_table* nt,
                         const ref* pnref); /* ref => index */
name* names_index_ptr(const name_table* nt,
                      name_index_t nidx); /* index => name */
void names_index_ref(const name_table* nt, name_index_t nidx,
                     ref* pnref); /* index => ref */
...
void /*obj_header_t */* names_ref_sub_table(name_table* nt, const ref* pnref);
void /*obj_header_t */* names_index_sub_table(name_table* nt,
                                              name_index_t nidx);
void /*obj_header_t */* names_index_string_sub_table(name_table* nt,
                                                     name_index_t nidx);
