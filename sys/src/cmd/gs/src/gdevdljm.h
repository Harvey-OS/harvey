...
#define PCL_ANY_SPACING (PCL3_SPACING | PCL4_SPACING | PCL5_SPACING)
...
#define PCL_LJ_FEATURES (PCL_MODE0)

/* H-P LaserJet Plus */
#define PCL_LJplus_FEATURES (PCL_MODE0)

/* H-P LaserJet IIp, IId */
#define PCL_LJ2p_FEATURES (PCL_MODE2P | PCL_CAN_SET_PAPER_SIZE)
...
#define PCL_LJ3D_FEATURES                                                      \
	(PCL_MODE3 | PCL_HAS_DUPLEX | PCL_CAN_SET_PAPER_SIZE |                 \
	 PCL_CAN_PRINT_COPIES)
...
#define PCL_LP2563B_FEATURES (PCL_MODE0NS | PCL_CAN_SET_PAPER_SIZE)

/* OCE 9050 line printer */
#define PCL_OCE9050_FEATURES (PCL_MODE3NS | PCL_CAN_SET_PAPER_SIZE)
...
int dljet_mono_print_page_copies(gx_device_printer* pdev, FILE* prn_stream,
                                 int num_copies, int dots_per_inch,
                                 int features, const char* page_init);
