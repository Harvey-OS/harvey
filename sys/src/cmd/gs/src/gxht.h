...
/* Copyright (C) 1993, 1995, 1996, 1997, 1998 Aladdin Enterprises.  All rights
  reserved.
...
typedef struct gs_client_order_ht_procs_s {
	...
	int (*create_order)(gx_ht_order* porder, gs_state* pgs,
...
#define public_st_ht_component_element() /* in gsht1.c */                      \
	gs_public_st_element(st_ht_component_element, gs_halftone_component,   \
	                     "gs_halftone_component[]", ht_comp_elt_enum_ptrs, \
	                     ht_comp_elt_reloc_ptrs, st_halftone_component)
...
typedef struct gs_multiple_halftone_s {
	...
	uint num_comp;
	int (*get_colorname_string)(const gs_memory_t* mem,
...
#define st_halftone_max_ptrs                                                   \
	max(max(st_screen_halftone_max_ptrs,                                   \
	        st_colorscreen_halftone_max_ptrs),                             \
	    max(max(st_spot_halftone_max_ptrs,                                 \
	            st_threshold_halftone_max_ptrs),                           \
...
int gs_screen_init_memory(gs_screen_enum*, gs_state*, gs_screen_halftone*, bool,
                          gs_memory_t*);
