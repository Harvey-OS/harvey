...
#define return_if_interrupt(mem)                                               \
	{                                                                      \
		...
		if(icode_)                                                     \
			return gs_note_error(                                  \
			    (icode_ > 0 ? gs_error_interrupt : icode_));       \
	}
