...
/* Copyright (C) 1991, 1992, 1993, 1994, 1999 Aladdin Enterprises.  All rights
  reserved.
...
#define align_packed_per_ref (arch_align_ref_mod / arch_align_short_mod)
...
#define packed_next(prp) (r_is_packed(prp) ? prp + 1 : prp + packed_per_ref)
