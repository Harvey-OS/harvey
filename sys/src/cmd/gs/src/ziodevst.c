...
const gx_io_device gs_iodev_static = {
    "%static%", iodev_dtype_static, {iostatic_init, iodev_no_open_device, iostatic_open_file, iodev_no_fopen, iodev_no_fclose, iodev_no_delete_file, iodev_no_rename_file, iodev_no_file_status, iodev_no_enumerate_files, NULL, NULL, iodev_no_get_params, iodev_no_put_params}};
