                          ...
                          gs_mapping_proc gray_proc, bool remap)
{
	...
	ptran->green_component_num = gs_color_name_component_number(
	    dev, "Green", 5, ht_type_colorscreen);
...
{
	return gs_setcolortransfer_remap(pgs, red_proc, green_proc, blue_proc,
	                                 gray_proc, true);
}
