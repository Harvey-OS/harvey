...
#define private_st_pattern1_template() /* in gspcolor.c */                     \
	gs_private_st_suffix_add0(                                             \
	    st_pattern1_template, gs_pattern1_template_t,                      \
	    "gs_pattern1_template_t", pattern1_template_enum_ptrs,             \
	    pattern1_template_reloc_ptrs, st_pattern_template)
 ...
 */
extern int gs_cspace_build_Pattern1(gs_color_space** ppcspace,
 ...
 */
int gs_makepattern(gs_client_color*, const gs_client_pattern*, const gs_matrix*,
                   gs_state*, gs_memory_t*);
...
extern int gs_makepixmappattern(gs_client_color* pcc,
                                const gs_depth_bitmap* pbitmap, bool mask,
                                const gs_matrix* pmat, long id,
...
extern int gs_makebitmappattern_xform(gs_client_color* pcc,
                                      const gx_tile_bitmap* ptile, bool mask,
                                      const gs_matrix* pmat, long id,
                                      gs_state* pgs, gs_memory_t* mem);
