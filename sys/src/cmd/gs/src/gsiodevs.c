...
stdin_open(gx_io_device* iodev, const char* access, stream** ps,
           gs_memory_t* mem)
{
	return stdio_open(iodev, access, ps, mem, 'r', mem->gs_lib_ctx->fstdin,
	                  sread_file);
}
...
stdout_open(gx_io_device* iodev, const char* access, stream** ps,
            gs_memory_t* mem)
{
	return stdio_open(iodev, access, ps, mem, 'w', mem->gs_lib_ctx->fstdout,
	                  swrite_file);
}
...
stderr_open(gx_io_device* iodev, const char* access, stream** ps,
            gs_memory_t* mem)
{
	return stdio_open(iodev, access, ps, mem, 'w', mem->gs_lib_ctx->fstderr,
	                  swrite_file);
}
