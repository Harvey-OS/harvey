 ...
 */
#define ialloc_bytes(nbytes, cname) gs_alloc_bytes(imemory, nbytes, cname)
...
#define ifree_object(data, cname) gs_free_object(imemory, data, cname)
#define ifree_const_object(data, cname)                                        \
	gs_free_const_object(imemory, data, cname)
#define ialloc_string(nbytes, cname) gs_alloc_string(imemory, nbytes, cname)
...
#define ifree_ref_array(paref, cname) gs_free_ref_array(iimemory, paref, cname)
