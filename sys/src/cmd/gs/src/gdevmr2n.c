...
private
int
mem_gray_rop_copy_mono(gx_device* dev, const byte* data, int dx, int raster,
...
private
int
mem_gray_rop_strip_tile_rectangle(gx_device* dev, const gx_strip_bitmap* tiles,
...
int
mem_gray_strip_copy_rop(gx_device* dev, const byte* sdata, int sourcex,
...
#ifdef DEBUG
	if(gs_debug_c('b'))
		trace_copy_rop("mem_gray_strip_copy_rop", dev, sdata, sourcex,
