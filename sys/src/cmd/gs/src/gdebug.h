...
/* Copyright (C) 1989, 1992, 1993, 1994, 1995, 1996, 1997, 1998 Aladdin
...
#define if_debug0(c, s)                                                        \
	BEGIN if(gs_debug_c(c)) dlprintf(s);                                   \
	END
#define if_debug1(c, s, a1)                                                    \
	BEGIN if(gs_debug_c(c)) dlprintf1(s, a1);                              \
	END
#define if_debug2(c, s, a1, a2)                                                \
	BEGIN if(gs_debug_c(c)) dlprintf2(s, a1, a2);                          \
	END
#define if_debug3(c, s, a1, a2, a3)                                            \
	BEGIN if(gs_debug_c(c)) dlprintf3(s, a1, a2, a3);                      \
	END
#define if_debug4(c, s, a1, a2, a3, a4)                                        \
	BEGIN if(gs_debug_c(c)) dlprintf4(s, a1, a2, a3, a4);                  \
	END
#define if_debug5(c, s, a1, a2, a3, a4, a5)                                    \
	BEGIN if(gs_debug_c(c)) dlprintf5(s, a1, a2, a3, a4, a5);              \
	END
#define if_debug6(c, s, a1, a2, a3, a4, a5, a6)                                \
	BEGIN if(gs_debug_c(c)) dlprintf6(s, a1, a2, a3, a4, a5, a6);          \
	END
#define if_debug7(c, s, a1, a2, a3, a4, a5, a6, a7)                            \
	BEGIN if(gs_debug_c(c)) dlprintf7(s, a1, a2, a3, a4, a5, a6, a7);      \
	END
#define if_debug8(c, s, a1, a2, a3, a4, a5, a6, a7, a8)                        \
	BEGIN if(gs_debug_c(c)) dlprintf8(s, a1, a2, a3, a4, a5, a6, a7, a8);  \
	END
#define if_debug9(c, s, a1, a2, a3, a4, a5, a6, a7, a8, a9)                    \
	BEGIN if(gs_debug_c(c))                                                \
	    dlprintf9(s, a1, a2, a3, a4, a5, a6, a7, a8, a9);                  \
	END
#define if_debug10(c, s, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)              \
	BEGIN if(gs_debug_c(c))                                                \
	    dlprintf10(s, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10);            \
	END
#define if_debug11(c, s, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11)         \
	BEGIN if(gs_debug_c(c))                                                \
	    dlprintf11(s, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11);       \
	END
#define if_debug12(c, s, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12)    \
	BEGIN if(gs_debug_c(c))                                                \
	    dlprintf12(s, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12);  \
	END
#else
