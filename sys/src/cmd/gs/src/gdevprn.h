...
#define gx_prn_device_common                                                                                                  \
	byte skip[max(sizeof(gx_device_memory), sizeof(gx_device_clist)) - sizeof(gx_device) + sizeof(double) /* padding */]; \
...
#define prn_device_body_rest2_(print_page, print_page_copies)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \
	...
	, /* std_procs */ {0}, /* skip */ {print_page, print_page_copies, {gx_default_create_buf_device, gx_default_size_buf_device, gx_default_setup_buf_device, gx_default_destroy_buf_device}, gdev_prn_default_get_space_params, gx_default_start_render_thread, gx_default_open_render_device, gx_default_close_render_device, gx_default_buffer_page}, {PRN_MAX_BITMAP, PRN_BUFFER_SPACE, {BAND_PARAMS_INITIAL_VALUES}, 0 /*false*/, /* params_are_read_only */ BandingAuto /* banding_type */}, {0}, /* fname */ 0 /*false*/, /* OpenOutputFile */ 0 /*false*/, /* ReopenPerPage */ 0 /*false*/, /* page_uses_transparency */ 0 /*false*/, -1, /* Duplex[_set] */ 0 /*false*/, 0, 0, 0, /* file_is_new ... buf */ 0, 0, 0, 0, 0 /*false*/, 0, 0, /* buffer_memory ... clist_dis'_mask */ \
	{                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
		0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \
	} /* ... orig_procs */
...
#define prn_device_margins(procs, dname, w10, h10, xdpi, ydpi, lo, to, lm, bm, rm, tm, color_bits, print_page)                                     \
	{                                                                                                                                          \
		prn_device_std_margins_body(gx_device_printer, procs, dname, w10, h10, xdpi, ydpi, lo, to, lm, bm, rm, tm, color_bits, print_page) \
	}
...
#define prn_device_margins_copies(procs, dname, w10, h10, xdpi, ydpi, lo, to, lm, bm, rm, tm, color_bits, print_page_copies)                                     \
	{                                                                                                                                                        \
		prn_device_std_margins_body_copies(gx_device_printer, procs, dname, w10, h10, xdpi, ydpi, lo, to, lm, bm, rm, tm, color_bits, print_page_copies) \
	}
