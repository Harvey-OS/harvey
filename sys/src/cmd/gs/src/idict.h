...
#define dict_hash_mod_large(hash, size) \
	(size > dict_max_non_huge ? dict_hash_mod_rem(hash, size) : dict_hash_mod_mask(hash, size))
...
#define dict_hash_mod(h, s) \
	(gs_debug_c('.') ? dict_hash_mod_small(h, s) : dict_hash_mod_large(h, s))
#define dict_hash_mod_inline(h, s) \
	(gs_debug_c('.') ? dict_hash_mod_inline_small(h, s) : dict_hash_mod_inline_large(h, s))
#define dict_round_size(s) \
	(gs_debug_c('.') ? dict_round_size_small(s) : dict_round_size_large(s))
#else
