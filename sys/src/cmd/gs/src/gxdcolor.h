...
#define dev_color_proc_write(proc)                                             \
	int proc(const gx_device_color* pdevc,                                 \
...
#define gx_unset_dev_color(pgs) color_unset((pgs)->dev_color)
 ...
 * routines.
 */
extern int gx_dc_write_color(gx_color_index color, const gx_device* dev,
                             byte* pdata, uint* psize);

extern int gx_dc_read_color(gx_color_index* pcolor, const gx_device* dev,
