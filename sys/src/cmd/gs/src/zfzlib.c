...
zzlibE(i_ctx_t* i_ctx_p)
{
	...
	if(code < 0)
		return code;
	return filter_write(i_ctx_p, 0, &s_zlibE_template, (stream_state*)&zls,
	                    0);
}
...
zzlibD(i_ctx_t* i_ctx_p)
{
	...
	return filter_read(i_ctx_p, 0, &s_zlibD_template, (stream_state*)&zls,
	                   0);
}
...
const op_def zfzlib_op_defs[] = {op_def_begin_filter(),
                                 {"1zlibEncode", zzlibE},
                                 {"1zlibDecode", zzlibD},
