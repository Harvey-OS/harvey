...
#define private_st_jpeg_block() /* in sjpegc.c */                              \
	gs_private_st_ptrs2(st_jpeg_block, jpeg_block_t, "jpeg_block_t",       \
	                    jpeg_block_enum_ptrs, jpeg_block_reloc_ptrs, next, \
	                    data)
...
#define public_st_jpeg_compress_data() /* in sdcte.c */                        \
	gs_public_st_ptrs1(st_jpeg_compress_data, jpeg_compress_data,          \
	                   "JPEG compress data", jpeg_compress_data_enum_ptrs, \
	                   jpeg_compress_data_reloc_ptrs, blocks)
...
#define private_st_jpeg_decompress_data() /* in zfdctd.c */                    \
	gs_private_st_ptrs2(                                                   \
	    st_jpeg_decompress_data, jpeg_decompress_data,                     \
...
#define public_st_DCT_state() /* in sdctc.c */                                 \
	gs_public_st_const_strings1_ptrs1(                                     \
	    st_DCT_state, stream_DCT_state, "DCTEncode/Decode state",          \
	    dct_enum_ptrs, dct_reloc_ptrs, Markers, data.common)
/*
