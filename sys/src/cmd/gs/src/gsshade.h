...
#define private_st_shading_Fb() /* in gsshade.c */                             \
	gs_private_st_suffix_add1(st_shading_Fb, gs_shading_Fb_t,              \
	                          "gs_shading_Fb_t", shading_Fb_enum_ptrs,     \
	                          shading_Fb_reloc_ptrs, st_shading,           \
	                          params.Function)
...
#define private_st_shading_A() /* in gsshade.c */                              \
	gs_private_st_suffix_add1(st_shading_A, gs_shading_A_t,                \
	                          "gs_shading_A_t", shading_A_enum_ptrs,       \
	                          shading_A_reloc_ptrs, st_shading,            \
	                          params.Function)
...
#define private_st_shading_R() /* in gsshade.c */                              \
	gs_private_st_suffix_add1(st_shading_R, gs_shading_R_t,                \
	                          "gs_shading_R_t", shading_R_enum_ptrs,       \
	                          shading_R_reloc_ptrs, st_shading,            \
	                          params.Function)
...
#define private_st_shading_mesh() /* in gsshade.c */                           \
	gs_private_st_composite(st_shading_mesh, gs_shading_mesh_t,            \
	                        "gs_shading_mesh_t", shading_mesh_enum_ptrs,   \
	                        shading_mesh_reloc_ptrs)
...
#define private_st_shading_FfGt() /* in gsshade.c */                           \
	gs_private_st_composite_only(                                          \
	    st_shading_FfGt, gs_shading_FfGt_t, "gs_shading_FfGt_t",           \
	    shading_mesh_enum_ptrs, shading_mesh_reloc_ptrs)
...
#define private_st_shading_LfGt() /* in gsshade.c */                           \
	gs_private_st_composite_only(                                          \
	    st_shading_LfGt, gs_shading_LfGt_t, "gs_shading_LfGt_t",           \
	    shading_mesh_enum_ptrs, shading_mesh_reloc_ptrs)
...
#define private_st_shading_Cp() /* in gsshade.c */                             \
	gs_private_st_composite_only(                                          \
	    st_shading_Cp, gs_shading_Cp_t, "gs_shading_Cp_t",                 \
	    shading_mesh_enum_ptrs, shading_mesh_reloc_ptrs)
...
#define private_st_shading_Tpp() /* in gsshade.c */                            \
	gs_private_st_composite_only(                                          \
	    st_shading_Tpp, gs_shading_Tpp_t, "gs_shading_Tpp_t",              \
	    shading_mesh_enum_ptrs, shading_mesh_reloc_ptrs)
...
int gs_shading_A_init(gs_shading_t** ppsh, const gs_shading_A_params_t* params,
                      gs_memory_t* mem);
int gs_shading_R_init(gs_shading_t** ppsh, const gs_shading_R_params_t* params,
                      gs_memory_t* mem);
...
#endif
int gs_shading_fill_path_adjusted(const gs_shading_t* psh,
                                  /*const*/ gx_path* ppath,
