...
/* Copyright (C) 1993, 1995, 1996, 1997, 1999 Aladdin Enterprises.  All rights
  reserved.
...
#define pattern_proc_remap_color(proc) cs_proc_remap_color(proc)
 ...
 */
void gs_pattern_common_init(gs_pattern_template_t*, const gs_pattern_type_t*);
 ...
 * device color type.
 */
extern const gx_device_color_type_t gx_dc_pattern, gx_dc_pure_masked,
...
#define private_st_color_tile() /* in gxpcmap.c */                             \
	gs_private_st_ptrs2(st_color_tile, gx_color_tile, "gx_color_tile",     \
	                    color_tile_enum_ptrs, color_tile_reloc_ptrs,       \
	                    tbits.data, tmask.data)
#define private_st_color_tile_element() /* in gxpcmap.c */                     \
	gs_private_st_element(st_color_tile_element, gx_color_tile,            \
	                      "gx_color_tile[]", color_tile_elt_enum_ptrs,     \
	                      color_tile_elt_reloc_ptrs, st_color_tile)
...
#define private_st_device_pattern_accum() /* in gxpcmap.c */                   \
	gs_private_st_suffix_add3_final(                                       \
	    st_device_pattern_accum, gx_device_pattern_accum,                  \
	    "pattern accumulator", pattern_accum_enum, pattern_accum_reloc,    \
	    gx_device_finalize, st_device_forward, instance, bits, mask)

/* Allocate a pattern accumulator. */
gx_device_pattern_accum* gx_pattern_accum_alloc(gs_memory_t* memory,
                                                client_name_t);
...
int gx_pattern_cache_add_dummy_entry(gs_imager_state* pis,
...
void gx_pattern_cache_winnow(gx_pattern_cache*, bool (*)(gx_color_tile*, void*),
                             void*);
