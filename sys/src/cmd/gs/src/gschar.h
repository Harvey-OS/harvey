...
int
    ...
    gs_ashow_n_init(gs_show_enum*, gs_state*, floatp, floatp, const char*,
                    uint),
    gs_widthshow_n_init(gs_show_enum*, gs_state*, floatp, floatp, gs_char,
                        const char*, uint),
    gs_awidthshow_n_init(gs_show_enum*, gs_state*, floatp, floatp, gs_char,
                         floatp, floatp, const char*, uint),
    gs_kshow_n_init(gs_show_enum*, gs_state*, const char*, uint),
    gs_xyshow_n_init(gs_show_enum*, gs_state*, const char*, uint),
    gs_glyphshow_init(gs_show_enum*, gs_state*, gs_glyph),
    gs_cshow_n_init(gs_show_enum*, gs_state*, const char*, uint),
...
gs_char gs_show_current_char(const gs_show_enum*),
...
int gs_setcachedevice2_double(gs_show_enum*, gs_state*,
                              const double* /*[10] */);
