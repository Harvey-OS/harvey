...
#define stc_proc_dither(name)                                                  \
	int name(stcolor_device* sdev, int npixel, byte* in, byte* buf,        \
	         byte* out)
...
#define STC_MODI                                                               \
	...
	, {"gsrgb", stc_gsrgb, DeviceRGB | STC_BYTE, 0, {0.0, 1.0}},           \
	    {"fsmono",                                                         \
	     stc_fs,                                                           \
	     DeviceGray | STC_LONG | 1 * STC_SCAN,                             \
	     3 + 3 * 1,                                                        \
	     {0.0, 16777215.0}},                                               \
	    {"fsrgb",                                                          \
	     stc_fs,                                                           \
	     DeviceRGB | STC_LONG | 1 * STC_SCAN,                              \
	     3 + 3 * 3,                                                        \
	     {0.0, 16777215.0}},                                               \
	    {"fsx4",                                                           \
	     stc_fs,                                                           \
	     DeviceCMYK | STC_LONG | 1 * STC_SCAN,                             \
	     3 + 3 * 4,                                                        \
	     {0.0, 16777215.0}},                                               \
	    {"fscmyk",                                                         \
	     stc_fscmyk,                                                       \
	    ...
	    {"fs2",                                                            \
	     stc_fs2,                                                          \
	     DeviceRGB | STC_BYTE | STC_WHITE | 1 * STC_SCAN,                  \
	     0,                                                                \
	     {0.0, 255.0}},
