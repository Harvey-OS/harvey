...
#define dci_extended_alpha_values(mcmp, nc, p, d, gi, mg, mc, dg, dc, ta, ga, sl, cn)                                                                                                                                                                                                                                                                                                                                                                                  \
	{                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
		mcmp /* max components */, nc /* number components */, p /* polarity */, d /* depth */, gi /* gray index */, mg /* max gray */, mc /* max color */, dg /* dither grays */, dc /* dither colors */, {ta, ga} /* antialias info text, graphics */, sl /* separable_and_linear */, {0} /* component shift */, {0} /* component bits */, {0} /* component mask */, cn /* process color name */, GX_CINFO_OPMODE_UNKNOWN /* opmode */, 0 /* process_cmps */ \
	}
...
#define dci_std_color_bits(nc, color_bits) \
	((nc) == 3                         \
	     ...
	     : ((nc) == 1                  \
		    ? 0                    \
		    : ((color_bits)-dci_std_gray_bits(nc, color_bits)) / ((nc) == 1 ? (1) : (nc)-1)))
...
#define gx_device_begin_image(dev, pis, pim, format, prect, pdcolor, pcpath, memory, pinfo) \
	((*dev_proc(dev, begin_image))(dev, pis, pim, format, prect, pdcolor, pcpath, memory, pinfo))
#define gx_device_begin_typed_image(dev, pis, pmat, pim, prect, pdcolor, pcpath, memory, pinfo) \
	((*dev_proc(dev, begin_typed_image))(dev, pis, pmat, pim, prect, pdcolor, pcpath, memory, pinfo))
