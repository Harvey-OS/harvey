...
#define psdf_image_param_names(acs, aa, af, de, di, ds, dt, dst, dstd, e, f, fns, r)                                                                                                                                                                                                                                   \
	...
	{                                                                                                                                                                                                                                                                                                              \
		pi(af, gs_param_type_bool, AutoFilter), pi(aa, gs_param_type_bool, AntiAlias), pi(de, gs_param_type_int, Depth), pi(ds, gs_param_type_bool, Downsample), pi(dst, gs_param_type_float, DownsampleThreshold), pi(e, gs_param_type_bool, Encode), pi(r, gs_param_type_int, Resolution), gs_param_item_end \
	}

private
const psdf_image_param_names_t Color_names = {
...
private
const psdf_image_param_names_t Gray_names = {
    psdf_image_param_names(
	...
	"GrayImageResolution")};
private
const psdf_image_param_names_t Mono_names = {
    psdf_image_param_names(
...
#undef pi
private
const int8_t *const AutoRotatePages_names[] = {
    psdf_arp_names, 0};
private
const int8_t *const ColorConversionStrategy_names[] = {
    psdf_ccs_names, 0};
private
const int8_t *const DownsampleType_names[] = {
    psdf_ds_names, 0};
private
const int8_t *const Binding_names[] = {
    psdf_binding_names, 0};
private
const int8_t *const DefaultRenderingIntent_names[] = {
    psdf_ri_names, 0};
private
const int8_t *const TransferFunctionInfo_names[] = {
    psdf_tfi_names, 0};
private
const int8_t *const UCRandBGInfo_names[] = {
    psdf_ucrbg_names, 0};
private
const int8_t *const CannotEmbedFontPolicy_names[] = {
    psdf_cefp_names, 0};
		      ...
		      const psdf_image_param_names_t *pnames, psdf_image_params *params)
{
	...
	if((code = gs_param_write_items(plist, params, NULL, items)) < 0 ||
	   ...
	   (code = psdf_write_name(plist, pnames->Filter,
				   (params->Filter == 0 ? pnames->filter_names[0].pname : params->Filter))) < 0
	   /* (Resolution) */
	   )
		DO_NOTHING;
	return code;
