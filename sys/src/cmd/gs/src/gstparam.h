...
#define GS_BLEND_MODE_NAMES                                                    \
	"Compatible", "Normal", "Multiply", "Screen", "Difference", "Darken",  \
	    "Lighten", "ColorDodge", "ColorBurn", "Exclusion", "HardLight",    \
	    "Overlay", "SoftLight", "Luminosity", "Hue", "Saturation", "Color"
...
#define GS_TRANSPARENCY_MASK_COMMON rc_header rc
...
#define GS_TRANSPARENCY_MASK_SUBTYPE_NAMES "Alpha", "Luminosity"
