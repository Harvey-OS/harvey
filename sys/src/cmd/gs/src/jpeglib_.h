...
typedef struct {
	...
	int component_index
	    [MAX_COMPS_IN_SCAN]; /* their SOF/comp_info[] indexes */
...
struct jpeg_decompress_struct {
	 ...
	 * fields.
	 * The application can supply a colormap by setting colormap non-NULL
	 * before
	 ...
	 * known.
	 * It is -1 when no data has yet been received, otherwise it is the
	 * point
...
struct jpeg_source_mgr {
	...
	JMETHOD(void, skip_input_data,
	        (j_decompress_ptr cinfo, long num_bytes));
	JMETHOD(boolean, resync_to_restart,
...
EXTERN(void) jpeg_CreateCompress
    JPP((j_compress_ptr cinfo, int version, size_t structsize));
EXTERN(void) jpeg_CreateDecompress
...
EXTERN(void) jpeg_set_colorspace
    JPP((j_compress_ptr cinfo, J_COLOR_SPACE colorspace));
EXTERN(void) jpeg_default_colorspace JPP((j_compress_ptr cinfo));
EXTERN(void) jpeg_set_quality
    JPP((j_compress_ptr cinfo, int quality, boolean force_baseline));
EXTERN(void) jpeg_set_linear_quality
    JPP((j_compress_ptr cinfo, int scale_factor, boolean force_baseline));
EXTERN(void) jpeg_add_quant_table
...
EXTERN(JDIMENSION) jpeg_write_scanlines
...
EXTERN(void) jpeg_write_marker
    JPP((j_compress_ptr cinfo, int marker, const JOCTET* dataptr,
...
EXTERN(int) jpeg_read_header
    JPP((j_decompress_ptr cinfo, boolean require_image));
...
EXTERN(void) jpeg_write_coefficients
...
EXTERN(boolean) jpeg_resync_to_restart
