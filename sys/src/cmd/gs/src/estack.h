...
#define r_is_estack_mark(ep) r_has_type_attrs(ep, t_null, a_executable)
...
#define make_op_estack(ep, proc) make_oper(ep, 0, proc)
#define push_op_estack(proc) (++esp, make_op_estack(esp, proc))
