...
#define private_st_pattern2_template() /* in gsptype2.c */                     \
	gs_private_st_suffix_add1(                                             \
	    st_pattern2_template, gs_pattern2_template_t,                      \
	    "gs_pattern2_template_t", pattern2_template_enum_ptrs,             \
	    pattern2_template_reloc_ptrs, st_pattern_template, Shading)
...
int gx_dc_pattern2_fill_path(const gx_device_color* pdevc, gx_path* ppath,
