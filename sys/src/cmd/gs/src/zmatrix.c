...
/* Copyright (C) 1989, 1995, 1997, 1999 Aladdin Enterprises.  All rights
  reserved.
...
/* Forward references */
private
int common_transform(i_ctx_t*, int (*)(gs_state*, floatp, floatp, gs_point*),
...
{
	return common_transform(i_ctx_p, gs_itransform,
...
{
	return common_transform(i_ctx_p, gs_idtransform,
...
const op_def zmatrix_op_defs[] = {{"1concat", zconcat},
