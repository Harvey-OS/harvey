...
/* Copyright (C) 1989, 1992, 1993, 1994, 1998 Aladdin Enterprises.  All rights
  reserved.
...
#define win_proc_copy_to_clipboard(proc) void proc(gx_device_win*)

#define win_proc_repaint(proc)                                                 \
	void proc(gx_device_win*, HDC, int, int, int, int, int, int)

#define win_proc_alloc_bitmap(proc) int proc(gx_device_win*, gx_device*)

#define win_proc_free_bitmap(proc) void proc(gx_device_win*)
