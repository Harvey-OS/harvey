...
#define struct_proc_clear_marks(proc)                                          \
	void proc(const gs_memory_t* cmem, void /*obj_header_t*/* pre,         \
...
#define struct_proc_enum_ptrs(proc)                                            \
	gs_ptr_type_t proc(                                                    \
	    const gs_memory_t* mem, EV_CONST void /*obj_header_t*/* ptr,       \
...
#define struct_proc_finalize(proc) void proc(void /*obj_header_t*/* ptr)
