...
#define gx_set_line_width(plp, wid) ((plp)->half_width = (wid) / 2)
#define gx_current_line_width(plp) ((plp)->half_width * 2)
int gx_set_miter_limit(gx_line_params*, floatp);

#define gx_current_miter_limit(plp) ((plp)->miter_limit)
...
#define gx_line_params_initial                                                 \
	0.0, gs_cap_butt, gs_join_miter, -1, 10.0, (float)0.20305866, 0.0,     \
	    0 /*false*/, {identity_matrix_body},                               \
	{                                                                      \
