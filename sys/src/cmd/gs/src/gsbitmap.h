...
#define public_st_gs_bitmap() /* in gspcolor.c */                              \
	gs_public_st_ptrs1(st_gs_bitmap, gs_bitmap, "client bitmap",           \
	                   bitmap_enum_ptrs, bitmap_reloc_ptrs, data)

#define public_st_gs_tile_bitmap() /* in gspcolor.c */                         \
	gs_public_st_suffix_add0_local(st_gs_tile_bitmap, gs_tile_bitmap,      \
	                               "client tile bitmap", bitmap_enum_ptrs, \
	                               bitmap_reloc_ptrs, st_gs_bitmap)

#define public_st_gs_depth_bitmap() /* in gspcolor.c */                        \
	gs_public_st_suffix_add0_local(                                        \
	    st_gs_depth_bitmap, gs_depth_bitmap, "client depth bitmap",        \
	    bitmap_enum_ptrs, bitmap_reloc_ptrs, st_gs_bitmap)

#define public_st_gs_tile_depth_bitmap() /* in gspcolor.c */                   \
	gs_public_st_suffix_add0_local(                                        \
	    st_gs_tile_depth_bitmap, gs_tile_depth_bitmap,                     \
	    "client tile_depth bitmap", bitmap_enum_ptrs, bitmap_reloc_ptrs,   \
	    st_gs_tile_bitmap)
