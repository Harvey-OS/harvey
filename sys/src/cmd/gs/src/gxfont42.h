...
struct gs_type42_data_s {
	...
	gs_type42_mtx_t
	    metrics[2];     /* hhea/hmtx, vhea/vmtx (indexed by WMode) */
...
#define public_st_gs_font_type42() /* in gstype42.c */                         \
	gs_public_st_suffix_add3_final(                                        \
	    st_gs_font_type42, gs_font_type42, "gs_font_type42",               \
	    font_type42_enum_ptrs, font_type42_reloc_ptrs, gs_font_finalize,   \
	    st_gs_font_base, data.proc_data, data.len_glyphs, data.gdcache)
...
int gs_type42_append(uint glyph_index, gs_imager_state* pis, gx_path* ppath,
...
int gs_type42_get_metrics(gs_font_type42* pfont, uint glyph_index,
                          float psbw[4]);
int gs_type42_wmode_metrics(gs_font_type42* pfont, uint glyph_index, int wmode,
                            float psbw[4]);
...
int gs_type42_get_outline_from_TT_file(gs_font_type42* pfont, stream* s,
...
int gs_type42_glyph_info_by_gid(gs_font* font, gs_glyph glyph,
