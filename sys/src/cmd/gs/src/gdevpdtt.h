...
#define private_st_pdf_text_enum()                                             \
	...
	gs_private_st_suffix_add2(st_pdf_text_enum, pdf_text_enum_t,           \
	                          "pdf_text_enum_t", pdf_text_enum_enum_ptrs,  \
	                          pdf_text_enum_reloc_ptrs, st_gs_text_enum,   \
	                          pte_default, cgp)
 ...
 */
int pdf_obtain_font_resource(pdf_text_enum_t* penum, const gs_string* pstr,
 ...
 */
int pdf_obtain_parent_type0_font_resource(gx_device_pdf* pdev,
 ...
 */
int pdf_add_ToUnicode(gx_device_pdf* pdev, gs_font* font,
 ...
 */
int pdf_encode_glyph(gs_font_base* bfont, gs_glyph glyph0, byte* buf,
                     int buf_size, int* char_code_length);
