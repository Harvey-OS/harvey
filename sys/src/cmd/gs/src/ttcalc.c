...
static const int32_t Roots[63] = {
    1,         1,         2,         3,         4,          5,
    8,         11,        16,        22,        32,         45,
    64,        90,        128,       181,       256,        362,
    512,       724,       1024,      1448,      2048,       2896,
    4096,      5892,      8192,      11585,     16384,      23170,
    32768,     46340,
    ...
    33554432,  47453132,  67108864,  94906265,  134217728,  189812531,
    268435456, 379625062, 536870912, 759250125, 1073741824, 1518500250,
    2147483647};

#ifdef LONG64

Int32
MulDiv(Int32 a, Int32 b, Int32 c)
{
	Int32 s;
...
Int32
MulDiv_Round(Int32 a, Int32 b, Int32 c)
{
	int s;
...
void
MulTo64(Int32 x, Int32 y, Int64* z)
{
	Int32 s;
