...
/* Stream template */
const stream_template s_MTFE_template = {&st_MTF_state, s_MTF_init,
                                         s_MTFE_process, 1, 1};
               ...
               stream_cursor_write* pw, bool last)
{
	...
	byte v0 = ss->prev.b[0], v1 = ss->prev.b[1], v2 = ss->prev.b[2],
	     v3 = ss->prev.b[3];
...
const stream_template s_MTFD_template = {
    &st_MTF_state, s_MTF_init, s_MTFD_process, 1, 1, NULL, NULL, s_MTF_init};
