...
#define t4693d_prn_device(name, depth, max_rgb)                                                                                                                                                                  \
	{                                                                                                                                                                                                        \
		prn_device_body(gx_device_printer, t4693d_procs, name, WIDTH_10THS, HEIGHT_10THS, X_DPI, Y_DPI, 0.25, 0.25, 0.25, 0.25, 3, depth, max_rgb, max_rgb, max_rgb + 1, max_rgb + 1, t4693d_print_page) \
	}
