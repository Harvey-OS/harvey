...
#define s_AXE_init_inline(ss) ((ss)->EndOfData = true, (ss)->count = 0)
...
#define s_AXD_init_inline(ss) ((ss)->min_left = 1, (ss)->odd = -1, 0)
...
#define s_PSSD_partially_init_inline(ss) ((ss)->depth = 0)
