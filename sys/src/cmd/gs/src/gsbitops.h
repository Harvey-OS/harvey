...
#define sample_load12_(value, sptr, sbit, sbpv)                                                                                                  \
	sample_load8_(value, sptr, sbit, sbpv) case 3 : value = ((sbit) ? ((*(sptr)&0xf) << 8) | (sptr)[1] : (*(sptr) << 4) | ((sptr)[1] >> 4)); \
	break;
...
#define sample_load16_(value, sptr, sbit, sbpv)                                              \
	sample_load12_(value, sptr, sbit, sbpv) case 4 : value = (*(sptr) << 8) | (sptr)[1]; \
	break;
...
#define sample_load32_(value, sptr, sbit, sbpv)                                                                  \
	sample_load16_(value, sptr, sbit, sbpv) case 6 : value = (*(sptr) << 16) | ((sptr)[1] << 8) | (sptr)[2]; \
	break;                                                                                                   \
	case 8:                                                                                                  \
...
#define sample_load64_(value, sptr, sbit, sbpv)                                                                                                                                                                                                                                                                                                                                                                                                   \
	sample_load32_(value, sptr, sbit, sbpv);                                                                                                                                                                                                                                                                                                                                                                                                  \
	case 10:                                                                                                                                                                                                                                                                                                                                                                                                                                  \
		value = ((gx_color_index)((sptr)[0]) << sample_bound_shift((value), 32)) | ((gx_color_index)((sptr)[1]) << 24) | ((gx_color_index)((sptr)[2]) << 16) | ((gx_color_index)((sptr)[3]) << 8) | (gx_color_index)((sptr)[4]);                                                                                                                                                                                                          \
		break;                                                                                                                                                                                                                                                                                                                                                                                                                            \
	case 12:                                                                                                                                                                                                                                                                                                                                                                                                                                  \
		value = ((gx_color_index)((sptr)[0]) << sample_bound_shift((value), 40)) | ((gx_color_index)((sptr)[1]) << sample_bound_shift((value), 32)) | ((gx_color_index)((sptr)[2]) << 24) | ((gx_color_index)((sptr)[3]) << 16) | ((gx_color_index)((sptr)[4]) << 8) | (gx_color_index)((sptr)[5]);                                                                                                                                       \
		break;                                                                                                                                                                                                                                                                                                                                                                                                                            \
	case 14:                                                                                                                                                                                                                                                                                                                                                                                                                                  \
		value = ((gx_color_index)((sptr)[0]) << sample_bound_shift((value), 48)) | ((gx_color_index)((sptr)[1]) << sample_bound_shift((value), 40)) | ((gx_color_index)((sptr)[2]) << sample_bound_shift((value), 32)) | ((gx_color_index)((sptr)[3]) << 24) | ((gx_color_index)((sptr)[4]) << 16) | ((gx_color_index)((sptr)[5]) << 8) | (gx_color_index)((sptr)[6]);                                                                    \
		break;                                                                                                                                                                                                                                                                                                                                                                                                                            \
	case 16:                                                                                                                                                                                                                                                                                                                                                                                                                                  \
		value = ((gx_color_index)((sptr)[0]) << sample_bound_shift((value), 56)) | ((gx_color_index)((sptr)[1]) << sample_bound_shift((value), 48)) | ((gx_color_index)((sptr)[2]) << sample_bound_shift((value), 40)) | ((gx_color_index)((sptr)[3]) << sample_bound_shift((value), 32)) | ((gx_color_index)((sptr)[4]) << 24) | ((gx_color_index)((sptr)[5]) << 16) | ((gx_color_index)((sptr)[6]) << 8) | (gx_color_index)((sptr)[7]); \
		break;
...
#define sample_store_next8(value, dptr, dbit, dbpv, dbbyte)                                      \
	sample_store_next8_(value, dptr, dbit, dbpv, dbbyte) case 2 : *(dptr)++ = (byte)(value); \
	break;                                                                                   \
	sample_end_
...
#define sample_store_next12_(value, dptr, dbit, dbpv, dbbyte)                                     \
	sample_store_next8_(value, dptr, dbit, dbpv, dbbyte) /* case 2 is deliberately omitted */ \
	    case 3 : sample_store_next_12_(value, dptr, dbit, dbbyte) break;
#define sample_store_next12(value, dptr, dbit, dbpv, dbbyte)                                      \
	sample_store_next12_(value, dptr, dbit, dbpv, dbbyte) case 2 : *(dptr)++ = (byte)(value); \
	break;                                                                                    \
	sample_end_
#define sample_store_next16(value, dptr, dbit, dbpv, dbbyte)                                             \
	sample_store_next12_(value, dptr, dbit, dbpv, dbbyte) case 4 : *(dptr)++ = (byte)((value) >> 8); \
	case 2:                                                                                          \
		*(dptr)++ = (byte)(value);                                                               \
		break;                                                                                   \
		sample_end_
#define sample_store_next32(value, dptr, dbit, dbpv, dbbyte)                                              \
	sample_store_next12_(value, dptr, dbit, dbpv, dbbyte) case 8 : *(dptr)++ = (byte)((value) >> 24); \
	case 6:                                                                                           \
		*(dptr)++ = (byte)((value) >> 16);                                                        \
	case 4:                                                                                           \
		*(dptr)++ = (byte)((value) >> 8);                                                         \
...
#define sample_store_next64(value, dptr, dbit, dbpv, dbbyte)                                                                            \
	sample_store_next12_(value, dptr, dbit, dbpv, dbbyte) case 16 : *(dptr)++ = (byte)((value) >> sample_bound_shift((value), 56)); \
	case 14:                                                                                                                        \
		*(dptr)++ = (byte)((value) >> sample_bound_shift((value), 48));                                                         \
	case 12:                                                                                                                        \
		*(dptr)++ = (byte)((value) >> sample_bound_shift((value), 40));                                                         \
	case 10:                                                                                                                        \
		*(dptr)++ = (byte)((value) >> sample_bound_shift((value), 32));                                                         \
	case 8:                                                                                                                         \
		*(dptr)++ = (byte)((value) >> 24);                                                                                      \
	case 6:                                                                                                                         \
		*(dptr)++ = (byte)((value) >> 16);                                                                                      \
