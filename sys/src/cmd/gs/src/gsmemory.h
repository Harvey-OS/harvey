...
/* Copyright (C) 1993, 1996, 1997, 1998, 1999, 2001 Aladdin Enterprises.  All
  rights reserved.
...
#define gs_memory_proc_stable(proc) gs_memory_t_proc_stable(proc, gs_memory_t)
#define gs_memory_proc_status(proc) gs_memory_t_proc_status(proc, gs_memory_t)
...
#define gs_alloc_struct_array_immovable(mem, nelts, typ, pstype, cname)        \
	(typ*) (*(mem)->procs.alloc_struct_array_immovable)(mem, nelts,        \
	                                                    pstype, cname)
...
#define gs_object_size(mem, obj) (*(mem)->procs.object_size)(mem, obj)
...
#define gs_object_type(mem, obj) (*(mem)->procs.object_type)(mem, obj)
...
#define gs_enable_free(mem, enable) (*(mem)->procs.enable_free)(mem, enable)
...
int gs_register_struct_root(gs_memory_t* mem, gs_gc_root_t* root, void** pp,
                            client_name_t cname);
 ...
 *
 * non_gc_memory: a garabge collecting allocator requires a "parent" who doesn't
 *gc
