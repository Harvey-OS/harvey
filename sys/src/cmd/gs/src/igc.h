...
/* Copyright (C) 1994, 1995, 1996, 1998, 1999 Aladdin Enterprises.  All rights
  reserved.
...
#define gc_proc_clear_reloc(proc) void proc(obj_header_t* pre, uint size)
...
#define gc_proc_compact(proc)                                                  \
	void proc(const gs_memory_t* cmem, obj_header_t* pre,                  \
	          obj_header_t* dpre, uint size)
