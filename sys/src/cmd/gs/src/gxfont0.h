...
#define fmap_type_is_modal(fmt)                                                \
	((fmt) == fmap_escape || (fmt) == fmap_double_escape ||                \
	 (fmt) == fmap_shift)
...
#define public_st_gs_font_type0() /* in gsfont0.c */                           \
	gs_public_st_complex_only(st_gs_font_type0, gs_font_type0,             \
	                          "gs_font_type0", 0, font_type0_enum_ptrs,    \
	                          font_type0_reloc_ptrs, gs_font_finalize)
