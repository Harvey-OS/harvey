...
#define gx_path_alloc(mem, cname) gx_path_alloc_shared(NULL, mem, cname)
/*
...
int gx_path_new(gx_path*), gx_path_add_point(gx_path*, fixed, fixed),
    gx_path_add_relative_point(gx_path*, fixed, fixed),
    gx_path_add_line_notes(gx_path*, fixed, fixed, segment_notes),
    gx_path_add_lines_notes(gx_path*, const gs_fixed_point*, int,
                            segment_notes),
    gx_path_add_rectangle(gx_path*, fixed, fixed, fixed, fixed),
    gx_path_add_char_path(gx_path*, gx_path*, gs_char_path_mode),
    gx_path_add_curve_notes(gx_path*, fixed, fixed, fixed, fixed, fixed, fixed,
                            segment_notes),
    gx_path_add_partial_arc_notes(gx_path*, fixed, fixed, fixed, fixed, floatp,
                                  segment_notes),
...
#define gx_path_close_subpath(ppath) gx_path_close_subpath_notes(ppath, sn_none)
#define gx_path_pop_close_subpath(ppath) gx_path_pop_close_notes(ppath, sn_none)
...
gx_path_rectangular_type gx_path_is_rectangular(const gx_path*, gs_fixed_rect*);
...
#define gx_cpath_alloc(mem, cname) gx_cpath_alloc_shared(NULL, mem, cname)
int gx_cpath_init_contained_shared(gx_clip_path* pcpath,
                                   const gx_clip_path* shared, gs_memory_t* mem,
                                   client_name_t cname);

#define gx_cpath_alloc_contained(pcpath, mem, cname)                           \
	gx_cpath_init_contained_shared(pcpath, NULL, mem, cname)
int gx_cpath_init_local_shared(gx_clip_path* pcpath, const gx_clip_path* shared,
                               gs_memory_t* mem);
...
int gx_cpath_reset(gx_clip_path*), /* from_rectangle ((0,0),(0,0)) */
...
bool gx_cpath_inner_box(const gx_clip_path*, gs_fixed_rect*),
    gx_cpath_outer_box(const gx_clip_path*, gs_fixed_rect*),
    gx_cpath_includes_rectangle(const gx_clip_path*, fixed, fixed, fixed,
                                fixed);
...
segment_notes gx_cpath_enum_notes(const gs_cpath_enum*);
