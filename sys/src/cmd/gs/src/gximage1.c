 ...
 */
private
image_proc_sput(gx_image1_sput);
private
image_proc_sget(gx_image1_sget);
private
image_proc_release(gx_image1_release);
const gx_image_type_t gs_image_type_1 = {
    &st_gs_image1, gx_begin_image1, gx_data_image_source_size, gx_image1_sput,
    gx_image1_sget, gx_image1_release, 1};
private
image_proc_sput(gx_image1_mask_sput);
private
image_proc_sget(gx_image1_mask_sget);
/*
...
int
gx_begin_image1(gx_device* dev, const gs_imager_state* pis,
...
private
int
gx_image1_sget(gs_image_common_t* pic, stream* s, const gs_color_space* pcs)
{
...
{
	const gs_image_t* pim = (const gs_image_t*)pic;
	uint control = (gx_image_matrix_is_default((const gs_data_image_t*)pim)
	                    ? 0
	                    : MI_ImageMatrix) |
