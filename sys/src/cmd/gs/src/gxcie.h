 ...
 */
extern int gx_cie_to_xyz_alloc(gs_imager_state**, const gs_color_space*,
                               gs_memory_t*);
 ...
 * structure.
 */
extern int gx_cie_remap_finish(cie_cached_vector3, frac*,
                               const gs_imager_state*, const gs_color_space*);
...
extern void gx_set_common_cie_defaults(gs_cie_common*, void* client_data);
