...
static void
Direct_Move(EXEC_OPS PGlyph_Zone zone,
	    Int point,
	    TT_F26Dot6 distance)
{
	TT_F26Dot6 v;
...
static void
Direct_Move_X(EXEC_OPS PGlyph_Zone zone,
	      Int point,
	      TT_F26Dot6 distance)
{
	(void)exc;
...
static void
Direct_Move_Y(EXEC_OPS PGlyph_Zone zone,
	      Int point,
	      TT_F26Dot6 distance)
{
	(void)exc;
...
static TT_F26Dot6
Round_None(EXEC_OPS TT_F26Dot6 distance,
...
static TT_F26Dot6
Round_To_Grid(EXEC_OPS TT_F26Dot6 distance,
	      TT_F26Dot6 compensation)
{
	TT_F26Dot6 val;
	(void)exc;
...
static TT_F26Dot6
Round_To_Half_Grid(EXEC_OPS TT_F26Dot6 distance,
		   TT_F26Dot6 compensation)
{
	TT_F26Dot6 val;
	(void)exc;
...
static TT_F26Dot6
Round_Down_To_Grid(EXEC_OPS TT_F26Dot6 distance,
		   TT_F26Dot6 compensation)
{
	TT_F26Dot6 val;
	(void)exc;
...
static TT_F26Dot6
Round_Up_To_Grid(EXEC_OPS TT_F26Dot6 distance,
		 TT_F26Dot6 compensation)
{
	TT_F26Dot6 val;
	(void)exc;
...
static TT_F26Dot6
Round_To_Double_Grid(EXEC_OPS TT_F26Dot6 distance,
		     TT_F26Dot6 compensation)
{
	TT_F26Dot6 val;
	(void)exc;
...
static TT_F26Dot6
Round_Super(EXEC_OPS TT_F26Dot6 distance,
	    TT_F26Dot6 compensation)
{
	TT_F26Dot6 val;
...
static TT_F26Dot6
Round_Super_45(EXEC_OPS TT_F26Dot6 distance,
	       TT_F26Dot6 compensation)
{
	TT_F26Dot6 val;
...
static void
SetSuperRound(EXEC_OPS TT_F26Dot6 GridPeriod,
	      Long selector)
{
...
static Bool
Normalize(EXEC_OPS TT_F26Dot6 Vx,
	  TT_F26Dot6 Vy,
	  TT_UnitVector *R)
{
	TT_F26Dot6 W;
...
static Bool
Compute_Point_Displacement(EXEC_OPS
			       PCoordinates x,
			   PCoordinates y,
			   PGlyph_Zone zone,
			   Int *refp)
