...
#define sgi_prn_device(procs, dev_name, num_comp, depth, max_gray, max_color, print_page)                                                                                                                               \
	{                                                                                                                                                                                                               \
		prn_device_body(gx_device_printer, procs, dev_name, DEFAULT_WIDTH_10THS, DEFAULT_HEIGHT_10THS, X_DPI, Y_DPI, 0, 0, 0, 0, num_comp, depth, max_gray, max_color, max_gray + 1, max_color + 1, print_page) \
	}
