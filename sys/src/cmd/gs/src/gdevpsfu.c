			 ...
			 gs_glyph_space_t glyph_space)
{
	...
	ppge->enumerate_next =
	    (subset_list ? enumerate_glyphs_next : subset_size ? enumerate_range_next : enumerate_font_next);
			 ...
			 gs_glyph_space_t glyph_space)
{
	...
	ppge->glyph_space = glyph_space;
	ppge->enumerate_next =
	    (subset_bits ? enumerate_bits_next : subset_size ? enumerate_range_next : enumerate_font_next);
	psf_enumerate_glyphs_reset(ppge);
}
