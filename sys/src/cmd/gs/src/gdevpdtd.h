 ...
 * gs_font.
 */
int pdf_font_descriptor_alloc(gx_device_pdf* pdev, pdf_font_descriptor_t** ppfd,
 ...
 */
int pdf_finish_FontDescriptor(gx_device_pdf* pdev, pdf_font_descriptor_t* pfd);
 ...
 */
int pdf_write_FontDescriptor(gx_device_pdf* pdev, pdf_font_descriptor_t* pfd);

/*
 * Release a FontDescriptor components.
 */
int pdf_release_FontDescriptor_components(gx_device_pdf* pdev,
