...
/* Copyright (C) 1994, 1995, 1996, 1997, 1999 Aladdin Enterprises.  All rights
  reserved.
 ...
 */
int gx_imager_stroke_add(gx_path* ppath, gx_path* to_path, gx_device* dev,
 ...
 * pathbbox.
 */
int gx_stroke_path_expansion(const gs_imager_state* pis, const gx_path* ppath,
                             gs_fixed_point* ppt);
