...
/* Copyright (C) 1989, 1992, 1996, 1998 Aladdin Enterprises.  All rights
  reserved.
...
#include <alloc.h>
#else
#if defined(BSD4_2) || defined(apollo) || defined(vax) || defined(sequent) ||  \
    defined(UTEK)
#if defined(_POSIX_SOURCE) ||                                                  \
    (defined(__STDC__) && (!defined(sun) || defined(__svr4__))) /* >>> */
#include <stdlib.h>
...
#endif
#else
#if defined(_HPUX_SOURCE) || defined(__CONVEX__) || defined(__convex__) ||     \
    defined(__OSF__) || defined(__386BSD__) || defined(_POSIX_SOURCE) ||       \
    defined(__STDC__) || defined(VMS)
#include <stdlib.h>
#else
#include <malloc.h>
#endif /* !_HPUX_SOURCE, ... */
