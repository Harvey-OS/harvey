...
main(int argc, char *argv[])
{
	...
	floats_are_IEEE =
	    (size_of(float) == size_of(int) ? f0.i == 0 && f1.i == (int)0x3f800000 && fm1.i == (int)0xbf800000 : f0.l == 0 && f1.l == 0x3f800000L && fm1.l == 0xbf800000L);
...
#define MAX_NREPS (1 << 10) /* limit the number of reps we try */
     ...
     * never correct.
     */
	ars = (lr2 != -1 || ir1 != -1 || ir2 != -1 ? 0 : lr1 != -1 ? 1 : /* Turbo C problem */
							     2);
