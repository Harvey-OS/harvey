...
pc_8bit_map_rgb_color(gx_device* dev, const gx_color_value cv[])
{
	...
	return (gx_color_index)(rv * 6 + gv) * 6 +
	       b / (gx_max_color_value / 6 + 1);
}
int
                      ...
                      gx_color_value prgb[3])
{
	static const gx_color_value ramp6[6] = {
	    0, gx_max_color_value / 5, 2 * gx_max_color_value / 5,
	    3 * gx_max_color_value / 5,
	    gx_max_color_value - (gx_max_color_value / 5), gx_max_color_value};
