...
/* Copyright (C) 1989, 1992, 1993, 1994, 1997, 1998, 1999 Aladdin Enterprises.
  All rights reserved.
 ...
 */
#if defined(VMS) || defined(_POSIX_SOURCE) ||                                  \
    (defined(__STDC__) && (!defined(sun) || defined(__svr4__))) ||             \
    defined(_HPUX_SOURCE) || defined(__WATCOMC__) || defined(THINK_C) ||       \
    defined(bsdi) || defined(__FreeBSD) ||                                     \
