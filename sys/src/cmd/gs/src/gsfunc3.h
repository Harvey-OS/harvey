 ...
 */
enum { function_type_ExponentialInterpolation = 2,
...
#define private_st_function_ElIn() /* in gsfunc.c */                           \
	gs_private_st_suffix_add2(                                             \
	    st_function_ElIn, gs_function_ElIn_t, "gs_function_ElIn_t",        \
	    function_ElIn_enum_ptrs, function_ElIn_reloc_ptrs, st_function,    \
	    params.C0, params.C1)
...
#define private_st_function_1ItSg() /* in gsfunc.c */                          \
	gs_private_st_suffix_add3(                                             \
	    st_function_1ItSg, gs_function_1ItSg_t, "gs_function_1ItSg_t",     \
	    function_1ItSg_enum_ptrs, function_1ItSg_reloc_ptrs, st_function,  \
	    params.Functions, params.Bounds, params.Encode)
...
#define private_st_function_AdOt() /* in gsfunc.c */                           \
	gs_private_st_suffix_add1(                                             \
	    st_function_AdOt, gs_function_AdOt_t, "gs_function_AdOt_t",        \
	    function_AdOt_enum_ptrs, function_AdOt_reloc_ptrs, st_function,    \
	    params.Functions)
