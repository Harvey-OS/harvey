 ...
 */
const byte byte_count_bits[256] = {bit_table_8(0, 1, 1, 1, 1, 1, 1, 1, 1)};
...
const byte byte_bit_run_length_0[256] = {r128(0), r64(1), r32(2),
                                         r16(3),  r8(4),  t8(5)};
const byte byte_bit_run_length_1[256] = {r64(0), r32(1), r16(2), r8(3), t8(4),
                                         r64(0), r32(1), r16(2), r8(3), t8(4)};
const byte byte_bit_run_length_2[256] = {
    r32(0), r16(1), r8(2), t8(3), r32(0), r16(1), r8(2), t8(3),
    r32(0), r16(1), r8(2), t8(3), r32(0), r16(1), r8(2), t8(3)};
const byte byte_bit_run_length_3[256] = {
    r16(0), r8(1),  t8(2),  r16(0), r8(1),  t8(2),  r16(0), r8(1),
    t8(2),  r16(0), r8(1),  t8(2),  r16(0), r8(1),  t8(2),  r16(0),
    r8(1),  t8(2),  r16(0), r8(1),  t8(2),  r16(0), r8(1),  t8(2)};
const byte byte_bit_run_length_4[256] = {
    r8(0), t8(1), r8(0), t8(1), r8(0), t8(1), r8(0), t8(1), r8(0), t8(1), r8(0),
    t8(1), r8(0), t8(1), r8(0), t8(1), r8(0), t8(1), r8(0), t8(1), r8(0), t8(1),
    r8(0), t8(1), r8(0), t8(1), r8(0), t8(1), r8(0), t8(1), r8(0), t8(1),
};

#define rr8(a, b, c, d, e, f, g, h)                                            \
	a, b, c, d, e, f, g, h, a, b, c, d, e, f, g, h, a, b, c, d, e, f, g,   \
	    h, a, b, c, d, e, f, g, h, a, b, c, d, e, f, g, h, a, b, c, d, e,  \
	    f, g, h, a, b, c, d, e, f, g, h, a, b, c, d, e, f, g, h, a, b, c,  \
	    d, e, f, g, h, a, b, c, d, e, f, g, h, a, b, c, d, e, f, g, h, a,  \
	    b, c, d, e, f, g, h, a, b, c, d, e, f, g, h, a, b, c, d, e, f, g,  \
	    h, a, b, c, d, e, f, g, h, a, b, c, d, e, f, g, h, a, b, c, d, e,  \
	    f, g, h, a, b, c, d, e, f, g, h, a, b, c, d, e, f, g, h, a, b, c,  \
	    d, e, f, g, h, a, b, c, d, e, f, g, h, a, b, c, d, e, f, g, h, a,  \
	    b, c, d, e, f, g, h, a, b, c, d, e, f, g, h, a, b, c, d, e, f, g,  \
...
const byte byte_bit_run_length_5[256] = {rr8(0, 0, 0, 0, 1, 1, 2, 11)};
const byte byte_bit_run_length_6[256] = {rr8(0, 0, 1, 10, 0, 0, 1, 10)};
const byte byte_bit_run_length_7[256] = {rr8(0, 9, 0, 9, 0, 9, 0, 9)};

/* Pointer tables indexed by bit number. */

const byte* const byte_bit_run_length[8] = {
    byte_bit_run_length_0, byte_bit_run_length_1, byte_bit_run_length_2,
    byte_bit_run_length_3, byte_bit_run_length_4, byte_bit_run_length_5,
    byte_bit_run_length_6, byte_bit_run_length_7};
const byte* const byte_bit_run_length_neg[8] = {
    byte_bit_run_length_0, byte_bit_run_length_7, byte_bit_run_length_6,
    byte_bit_run_length_5, byte_bit_run_length_4, byte_bit_run_length_3,
