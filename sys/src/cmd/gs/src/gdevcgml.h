...
/* $Id: gdevcgml.h,v 1.5 2002/06/16 07:25:26 lpd Exp $ */
 ...
 */
typedef enum { cgm_vdc_integer = 0, cgm_vdc_real } cgm_vdc_type;
typedef struct cgm_string_s {
	const char* chars;
	uint length;
} cgm_string;
typedef enum { cgm_scaling_abstract = 0, cgm_scaling_metric } cgm_scaling_mode;
typedef enum {
...
typedef cgm_line_marker_specification_mode cgm_line_width_specification_mode,
    cgm_marker_size_specification_mode, cgm_edge_width_specification_mode;
typedef union cgm_line_marker_extent_s {
	cgm_vdc absolute;
	cgm_real scaled;
} cgm_line_marker_extent;
typedef cgm_line_marker_extent cgm_line_width, cgm_marker_size, cgm_edge_width;
typedef enum { cgm_transparency_off = 0, cgm_transparency_on } cgm_transparency;
typedef enum { cgm_clip_off = 0, cgm_clip_on } cgm_clip_indicator;
typedef struct cgm_precision_s {
	enum { cgm_representation_floating,
	       cgm_representation_fixed } representation;
...
typedef enum { cgm_arc_closure_pie = 0, cgm_arc_closure_chord } cgm_arc_closure;
typedef enum {
...
cgm_result cgm_BEGIN_METAFILE(cgm_state*, const char*, uint),
    cgm_set_metafile_elements(cgm_state*, const cgm_metafile_elements*, long),
...
cgm_result cgm_BEGIN_PICTURE(cgm_state*, const char*, uint),
    cgm_set_picture_elements(cgm_state*, const cgm_picture_elements*, long),
    cgm_BEGIN_PICTURE_BODY(cgm_state*), cgm_END_PICTURE(cgm_state*);

/* ---------------- Control elements ---------------- */

cgm_result cgm_VDC_INTEGER_PRECISION(cgm_state*, int),
...
cgm_result cgm_POLYLINE(cgm_state*, const cgm_point*, int),
    ...
    cgm_CELL_ARRAY(cgm_state*, const cgm_point* /*[3] */, cgm_int, cgm_int,
                   cgm_int, cgm_cell_representation_mode, const byte*, uint,
                   uint),
    cgm_RECTANGLE(cgm_state*, const cgm_point*, const cgm_point*),
    cgm_CIRCLE(cgm_state*, const cgm_point*, const cgm_vdc*),
    cgm_CIRCULAR_ARC_3_POINT(cgm_state*, const cgm_point*, const cgm_point*,
                             const cgm_point*),
    cgm_CIRCULAR_ARC_3_POINT_CLOSE(cgm_state*, const cgm_point*,
                                   const cgm_point*, const cgm_point*,
                                   cgm_arc_closure),
    cgm_CIRCULAR_ARC_CENTER(cgm_state*, const cgm_point*, const cgm_vdc*,
                            const cgm_vdc*, const cgm_vdc*, const cgm_vdc*,
                            const cgm_vdc*),
    cgm_CIRCULAR_ARC_CENTER_CLOSE(cgm_state*, const cgm_point*, const cgm_vdc*,
                                  const cgm_vdc*, const cgm_vdc*,
                                  const cgm_vdc*, const cgm_vdc*,
                                  cgm_arc_closure),
    cgm_ELLIPSE(cgm_state*, const cgm_point*, const cgm_point*,
                const cgm_point*),
    cgm_ELLIPTICAL_ARC(cgm_state*, const cgm_point*, const cgm_point*,
                       const cgm_point*, const cgm_vdc*, const cgm_vdc*,
                       const cgm_vdc*, const cgm_vdc*),
    cgm_ELLIPTICAL_ARC_CLOSE(cgm_state*, const cgm_point*, const cgm_point*,
                             const cgm_point*, const cgm_vdc*, const cgm_vdc*,
                             const cgm_vdc*, const cgm_vdc*, cgm_arc_closure);

/* ---------------- Attribute elements ---------------- */

cgm_result cgm_LINE_BUNDLE_INDEX(cgm_state*, cgm_int),
    ...
    cgm_CHARACTER_ORIENTATION(cgm_state*, const cgm_vdc*, const cgm_vdc*,
                              const cgm_vdc*, const cgm_vdc*),
    ...
    /* PATTERN_TABLE */
    cgm_PATTERN_SIZE(cgm_state*, const cgm_vdc*, const cgm_vdc*, const cgm_vdc*,
                     const cgm_vdc*),
