...
#define TFAX_DEVICE(dname, print_page)                                                                                                                                        \
	{                                                                                                                                                                     \
		FAX_DEVICE_BODY(gx_device_tfax, gdev_tfax_std_procs, dname, print_page), 0 /* unlimited strip size byte count */, 1 /* lowest column in the high-order bit */ \
	}
...
/* Forward references */
private
int tfax_begin_page(gx_device_tfax *, FILE *,
