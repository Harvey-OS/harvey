...
/* Copyright (C) 1992, 1995, 1998, 1999 Aladdin Enterprises.  All rights
  reserved.
...
typedef struct cfont_procs_s {
	...
	int (*scalar_array_create)(i_ctx_t*, ref*, const ref*, int /*size */,
	                           uint /*protection */);
 ...
 */
#define ccfont_proc(proc) int proc(i_ctx_t*, const cfont_procs*, ref*)
