...
#define std_device_part3_()                                                                                                                           \
	0 /*PageCount*/, 0 /*ShowpageCount*/, 1 /*NumCopies*/, 0 /*NumCopies_set*/, 0 /*IgnoreNumCopies*/, 0 /*UseCIEColor*/, 0 /*LockSafetyParams*/, \
	{                                                                                                                                             \
...
#define gx_device_black_inline(dev) \
	((dev)->cached_colors.black == gx_no_color_index ? gx_device_black(dev) : (dev)->cached_colors.black)
gx_color_index gx_device_white(gx_device *dev);
#define gx_device_white_inline(dev) \
	((dev)->cached_colors.white == gx_no_color_index ? gx_device_white(dev) : (dev)->cached_colors.white)
...
#define gx_device_must_halftone(dev) \
	((gx_device_has_color(dev) ? (dev)->color_info.max_color : (dev)->color_info.max_gray) < MIN_CONTONE_LEVELS)
