 ...
 */
private
const gx_device_procs spot_rgb_procs = device_procs(get_spotrgb_color_mapping_procs);
...
private
const gx_device_procs spot_cmyk_procs = device_procs(get_xcf_color_mapping_procs);
