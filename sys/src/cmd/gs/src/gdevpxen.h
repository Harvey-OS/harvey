...
typedef enum {
	eNoColorSpace =
	    0, /* Note: for this enumeration, 0 is not a valid value */
	eGray,
	eRGB,
...
#define pxeMeasure_to_points                                                   \
	{                                                                      \
		72.0, 72.0 / 25.4, 72.0 / 254.0                                \
	}
...
#define px_enumerate_media(m)                                                  \
	m(eDefaultPaperSize, -1, -1, -1) m(eLetterPaper, 300, 2550, 3300) m(   \
	    eLegalPaper, 300, 2550, 4200) m(eA4Paper, 300, 2480, 3507)         \
	    m(eExecPaper, 300, 2175, 3150) m(eLedgerPaper, 300, 3300, 5100) m( \
	        eA3Paper, 300, 3507, 4960) m(eCOM10Envelope, 300, 1237, 2850)  \
	        m(eMonarchEnvelope, 300, 1162, 2250) m(eC5Envelope, 300, 1913, \
	                                               2704)                   \
	            m(eDLEnvelope, 300, 1299, 2598) m(eJB4Paper, -1, -1, -1)   \
	                m(eJB5Paper, 300, 2150,                                \
	                  3035) m(eB5Envelope, 300, 2078, 2952)                \
