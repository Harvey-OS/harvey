...
void refcpy_to_new(ref* to, const ref* from, uint size, gs_dual_memory_t* dmem);
 ...
 */
int obj_string_data(const gs_memory_t* mem, const ref* op, const byte** pchars,
                    uint* plen);
...
int obj_cvp(const ref* op, byte* str, uint len, uint* prlen, int full_print,
 ...
 * obj_string_data.
 */
int obj_cvs(const gs_memory_t* mem, const ref* op, byte* str, uint len,
            uint* prlen, const byte** pchars);
...
#define write_matrix_new(op, pmat, imem) write_matrix_in(op, pmat, NULL, imem)
#define write_matrix(op, pmat) write_matrix_in(op, pmat, idmemory, NULL)
