...
TT_Error TT_Open_Face(TT_Engine engine, const char* fontpathname,
                      TT_Face* face);

/* Open a TrueType font file located inside a collection. */
/* The font is designed by its index in 'fontIndex'.      */

TT_Error TT_Open_Collection(TT_Engine engine, const char* collectionpathname,
                            int fontIndex, TT_Face* face);
...
TT_Error TT_Get_Font_Data(TT_Face face, long tag, long offset, void* buffer,
                          long* length);

/* A simply macro to build table tags from ascii chars */
#define MAKE_TT_TAG(_x1, _x2, _x3, _x4) (_x1 << 24 | _x2 << 16 | _x3 << 8 | _x4)
...
TT_Error TT_Set_Instance_Resolutions(TT_Instance instance, int x_resolution,
                                     int y_resolution);
...
TT_Error TT_Set_Instance_CharSizes(TT_Instance instance, TT_F26Dot6 charWidth,
                                   TT_F26Dot6 charHeight);

#define TT_Set_Instance_PointSize(ins, ptsize)                                 \
	TT_Set_Instance_CharSize(ins, ptsize * 64)

TT_Error TT_Set_Instance_PixelSizes(TT_Instance instance, int pixelWidth,
                                    int pixelHeight, TT_F26Dot6 pointSize);
...
TT_Error TT_Set_Instance_Transform_Flags(TT_Instance instance, int rotated,
                                         int stretched);
...
TT_Error TT_Load_Glyph(TT_Instance instance, TT_Glyph glyph, int glyph_index,
                       int load_flags);
...
TT_Error TT_Get_Glyph_Bitmap(TT_Glyph glyph, TT_Raster_Map* raster_map,
                             TT_F26Dot6 x_offset, TT_F26Dot6 y_offset);
...
TT_Error TT_Get_Glyph_Pixmap(TT_Glyph glyph, TT_Raster_Map* raster_map,
                             TT_F26Dot6 x_offset, TT_F26Dot6 y_offset);
...
TT_Error TT_New_Outline(int num_points, int num_contours, TT_Outline* outline);
...
TT_Error TT_Get_Outline_Bitmap(TT_Engine engine, TT_Outline* outline,
...
TT_Error TT_Get_Outline_Pixmap(TT_Engine engine, TT_Outline* outline,
                               TT_Raster_Map* raster_map);
...
void TT_Translate_Outline(TT_Outline* outline, TT_F26Dot6 x_offset,
                          TT_F26Dot6 y_offset);
...
/* backwards compatibility */
#define TT_Apply_Vector_Matrix(x, y, m) TT_Transform_Vector(x, y, m)

/* Multiply a matrix with another - computes "b := a*b" */

void TT_Matrix_Multiply(TT_Matrix* a, TT_Matrix* b);
...
TT_Error TT_Get_CharMap_ID(TT_Face face, int charmapIndex, short* platformID,
                           short* encodingID);
...
TT_Error TT_Get_CharMap(TT_Face face, int charmapIndex, TT_CharMap* charMap);
...
int TT_Char_Index(TT_CharMap charMap, unsigned short charCode);
...
TT_Error TT_Get_Name_ID(TT_Face face, int nameIndex, short* platformID,
                        short* encodingID, short* languageID, short* nameID);
...
TT_Error TT_Get_Name_String(TT_Face face, int nameIndex,
...
typedef int (*TT_Glyph_Loader_Callback)(void* instance_ptr, int glyph_index,
                                        TT_Outline* outline, TT_F26Dot6* lsb,
                                        TT_F26Dot6* aw);

/* Register a new callback to the TrueType engine - this should */
/* only be used by higher-level libraries, not typical clients  */

TT_Error TT_Register_Callback(TT_Engine engine, int callback_id,
                              void* callback_ptr);
