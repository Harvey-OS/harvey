...
#define DECODE_DEFAULT(i, dd1) ((i) == 1 ? dd1 : (i)&1)
...
#define image_enum_proc_flush(proc) int proc(gx_image_enum_common_t* info)
...
#define public_st_gx_image_enum_common() /* in gdevddrw.c */                   \
	gs_public_st_composite(                                                \
	    st_gx_image_enum_common, gx_image_enum_common_t,                   \
	    "gx_image_enum_common_t", image_enum_common_enum_ptrs,             \
