...
#define mk_fb_ptr(x, y)                                                                                                                                         \
	(fb_dev->fb_byte_mult == 0 ? (fb_ptr)MK_PTR(regen + (y) * (fb_dev->fb_seg_mult), (x) >> 3) : (fb_ptr)MK_PTR(regen + ((y) >> 4) * (fb_dev->fb_seg_mult), \
...
#define ega_device(dev_name, procs, fb_raster, screen_height, aspect_ratio, video_mode)                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \
	{                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \
		std_device_dci_body(gx_device_ega, &procs, dev_name, fb_raster * 8, screen_height, (screen_height * (aspect_ratio)) / PAGE_HEIGHT_INCHES, /* x dpi */ screen_height / PAGE_HEIGHT_INCHES, /* y dpi */ (rgb_max ? 3 : 1), /* num_components */ 4, /* depth */ (rgb_max ? rgb_max : 1), /* max_gray */ rgb_max, (rgb_max ? rgb_max + 1 : 2), /* dither_grays */ (rgb_max ? rgb_max + 1 : 0) /* dither_colors */), {0}, /* std_procs */ fb_raster, (fb_raster & 15 ? fb_raster : fb_raster >> 4), (fb_raster & 15 ? fb_raster : 0), video_mode \
	}
