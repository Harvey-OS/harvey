...
#define cgm_device(dname, depth, max_value, dither, map_rgb_color, map_color_rgb)                                                                                                                                                                                                                                                                                                                                                                                                           \
	{                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \
		std_device_color_stype_body(gx_device_cgm, 0, dname, &st_device_cgm, 850, 1100, 100, 100, depth, max_value, dither), {cgm_open, NULL, /* get_initial_matrix */ NULL, /* sync_output */ cgm_output_page, cgm_close, map_rgb_color, map_color_rgb, cgm_fill_rectangle, cgm_tile_rectangle, cgm_copy_mono, cgm_copy_color, NULL, /* draw_line */ NULL, /* get_bits */ cgm_get_params, cgm_put_params}, {0}, /* fname */ 0, /* file */ 0, /* st */ 0 /*false*/ /* in_picture */ \
	}
...
cgm_begin_picture(gx_device_cgm *cdev)
{
	...
	pic.color_selection_mode =
	    (cdev->color_info.depth <= 8 ? cgm_color_selection_indexed : cgm_color_selection_direct);
