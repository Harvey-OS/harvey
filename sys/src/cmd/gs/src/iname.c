...
private
const byte hash_permutation[256] = {
    NAME_HASH_PERMUTATION_DATA};

/* Define the data for the 1-character names. */
private
const byte nt_1char_names[NT_1CHAR_SIZE] = {
    NT_1CHAR_NAMES_DATA};
		 ...
		 ref *psref /* result, t_string */)
{
	...
	make_const_string(psref,
			  (pnstr->foreign_string ? avm_foreign | a_readonly : nt->name_string_attrs),
			  pnstr->string_size,
...
private
ENUM_PTRS_BEGIN_PROC(name_string_sub_enum_ptrs)
{
	return 0;
}
ENUM_PTRS_END_PROC
