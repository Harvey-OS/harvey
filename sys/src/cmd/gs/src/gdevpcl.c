...
#define CHECK_PAPER_SIZE(w, h, c)                                                                                                                                                                                                                           \
	...
	if((new_width_difference > -0.01) && (new_height_difference > -0.01) && ((width_difference == -1.0) || (new_width_difference < width_difference) || ((new_width_difference == width_difference) && (new_height_difference < height_difference)))) { \
