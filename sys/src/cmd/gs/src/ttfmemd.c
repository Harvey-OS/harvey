...
gs_public_st_ptrs5(st_TFace, TFace, "TFace", st_TFace_enum_ptrs,
                   st_TFace_reloc_ptrs, r, font, fontProgram, cvtProgram, cvt);

gs_public_st_composite(st_TInstance, TInstance, "TInstance",
                       TInstance_enum_ptrs, TInstance_reloc_ptrs);
...
private
RELOC_PTRS_WITH(TInstance_reloc_ptrs, TInstance* mptr)
...
gs_public_st_composite(st_TExecution_Context, TExecution_Context,
                       "TExecution_Context", TExecution_Context_enum_ptrs,
                       TExecution_Context_reloc_ptrs);
...
private
RELOC_PTRS_WITH(TExecution_Context_reloc_ptrs, TExecution_Context* mptr)
{
...
gs_public_st_composite(st_ttfFont, ttfFont, "ttfFont", ttfFont_enum_ptrs,
                       ttfFont_reloc_ptrs);
...
private
RELOC_PTRS_WITH(ttfFont_reloc_ptrs, ttfFont* mptr)
