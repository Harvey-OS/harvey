...
#define vd_set_central_shift                                                                                                                      \
	BEGIN if(vd_trace1) vd_trace1->shift_x = vd_trace1->get_size_x(vd_trace1) / 2, vd_trace1->shift_y = vd_trace1->get_size_y(vd_trace1) / 2; \
	END
#define vd_erase(c)                                         \
...
#define vd_quad(x0, y0, x1, y1, x2, y2, x3, y3, w, c)                           \
	BEGIN if(vd_trace1) vd_impl_quad(x0, y0, x1, y1, x2, y2, x3, y3, w, c); \
	END
#define vd_curve(x0, y0, x1, y1, x2, y2, x3, y3, w, c)                           \
	BEGIN if(vd_trace1) vd_impl_curve(x0, y0, x1, y1, x2, y2, x3, y3, w, c); \
	END
