...
#define psdf_general_param_defaults(ascii)                             \
	ascii, arp_None, binding_Left, 1 /*true*/,                     \
	    ...
	    0 /*false*/, 1 /*true*/, /* Color processing parameters */ \
	    {0}, {0}, {0}, {0},                                        \
...
#define psdf_initial_values(version, ascii)                                                                                                                                   \
	...
	{                                                                                                                                                                     \
		psdf_general_param_defaults(ascii), psdf_color_image_param_defaults, psdf_gray_image_param_defaults, psdf_mono_image_param_defaults, psdf_font_param_defaults \
	}
...
#define public_st_device_psdf() /* in gdevpsdu.c */                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         \
	BASIC_PTRS(device_psdf_ptrs){GC_OBJ_ELT2(gx_device_psdf, params.ColorImage.ACSDict, params.ColorImage.Dict), GC_CONST_STRING_ELT(gx_device_psdf, params.CalCMYKProfile), GC_CONST_STRING_ELT(gx_device_psdf, params.CalGrayProfile), GC_CONST_STRING_ELT(gx_device_psdf, params.CalRGBProfile), GC_CONST_STRING_ELT(gx_device_psdf, params.sRGBProfile), GC_OBJ_ELT2(gx_device_psdf, params.GrayImage.ACSDict, params.GrayImage.Dict), GC_OBJ_ELT2(gx_device_psdf, params.MonoImage.ACSDict, params.MonoImage.Dict), GC_OBJ_ELT2(gx_device_psdf, params.AlwaysEmbed.data, params.NeverEmbed.data)}; \
