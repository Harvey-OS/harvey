...
void trace_copy_rop(const char* cname, gx_device* dev, const byte* sdata,
...
#define private_st_device_rop_texture() /* in gdevrops.c */                    \
	gs_private_st_composite_use_final(                                     \
	    st_device_rop_texture, gx_device_rop_texture,                      \
	    "gx_device_rop_texture", device_rop_texture_enum_ptrs,             \
	    device_rop_texture_reloc_ptrs, gx_device_finalize)
...
void gx_make_rop_texture_device(gx_device_rop_texture* rsdev, gx_device* target,
                                gs_logical_operation_t lop,
