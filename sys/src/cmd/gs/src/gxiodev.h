...
/* Copyright (C) 1993, 1994, 1996, 1998, 1999 Aladdin Enterprises.  All rights
  reserved.
...
#define iodev_proc_init(proc) int proc(gx_io_device* iodev, gs_memory_t* mem)
...
#define iodev_proc_fclose(proc) int proc(gx_io_device* iodev, FILE* file)
...
#define iodev_proc_enumerate_close(proc) void proc(file_enum* pfen)
...
#define streq1(str, chr) ((str)[0] == (chr) && (str)[1] == 0)
