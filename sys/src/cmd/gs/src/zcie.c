...
/* Forward references */
private
int cache_common(i_ctx_t *, gs_cie_common *, const ref_cie_procs *,
		 void *, gs_ref_memory_t *);
private
int cache_abc_common(i_ctx_t *, gs_cie_abc *, const ref_cie_procs *,
		     void *, gs_ref_memory_t *);
		 ...
		 void *container, gs_ref_memory_t *imem)
{
	...
	return (code < 0 ? code : cache_common(i_ctx_p, &pcie->common, pcprocs, pcie, imem));
}
