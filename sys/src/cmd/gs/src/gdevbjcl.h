 ...
 */
#define BJC_OPT_50                                                             \
	(BJC_OPT_NUL | BJC_OPT_LF | BJC_OPT_IDENTIFY_CARTRIDGE |               \
	 BJC_OPT_EXTENDED_MARGINS | BJC_OPT_PAGE_ID | BJC_OPT_RESOLUTION_360 | \
	 BJC_OPT_RESOLUTION_HALF | BJC_OPT_RESOLUTION_QUARTER |                \
	 BJC_OPT_RESOLUTION_2X_1X | BJC_OPT_X_Y_RESOLUTION |                   \
	 BJC_OPT_MOVE_LINES | BJC_OPT_IMAGE_FORMAT | BJC_OPT_CONTINUE_IMAGE)
#define BJC_OPT_70                                                             \
	(BJC_OPT_LF | BJC_OPT_IDENTIFY_CARTRIDGE |                             \
	 BJC_OPT_MONOCHROME_SMOOTHING | BJC_OPT_RESOLUTION_360)
#define BJC_OPT_80 BJC_OPT_50
#define BJC_OPT_210                                                            \
	(BJC_OPT_IDENTIFY_CARTRIDGE | BJC_OPT_MONOCHROME_SMOOTHING |           \
	 BJC_OPT_EXTENDED_MARGINS | BJC_OPT_RESOLUTION_360 |                   \
	 BJC_OPT_X_Y_RESOLUTION | BJC_OPT_MOVE_LINES | BJC_OPT_CONTINUE_IMAGE)
#define BJC_OPT_250                                                            \
	(BJC_OPT_LF | BJC_OPT_IDENTIFY_CARTRIDGE |                             \
	 BJC_OPT_MONOCHROME_SMOOTHING | BJC_OPT_EXTENDED_MARGINS |             \
	 BJC_OPT_PAGE_ID | BJC_OPT_RESOLUTION_360 | BJC_OPT_RESOLUTION_HALF |  \
...
#define BJC_OPT_610 (BJC_OPT_LF | BJC_OPT_RESOLUTION_360)
#define BJC_OPT_620 BJC_OPT_610
#define BJC_OPT_4000                                                           \
	(BJC_OPT_LF | BJC_OPT_IDENTIFY_CARTRIDGE |                             \
	 BJC_OPT_MONOCHROME_SMOOTHING | BJC_OPT_RESOLUTION_360 |               \
	 BJC_OPT_RESOLUTION_HALF | BJC_OPT_RESOLUTION_QUARTER)
#define BJC_OPT_4100                                                           \
	(BJC_OPT_IDENTIFY_CARTRIDGE | BJC_OPT_EXTENDED_MARGINS |               \
	 BJC_OPT_RESOLUTION_360 | BJC_OPT_MOVE_LINES | BJC_OPT_CONTINUE_IMAGE)
#define BJC_OPT_4200                                                           \
	(BJC_OPT_LF | BJC_OPT_IDENTIFY_CARTRIDGE | BJC_OPT_EXTENDED_MARGINS |  \
	 BJC_OPT_PAGE_ID | BJC_OPT_RESOLUTION_360 | BJC_OPT_MOVE_LINES |       \
	 BJC_OPT_IMAGE_FORMAT | BJC_OPT_CONTINUE_IMAGE)
#define BJC_OPT_4300 BJC_OPT_250
#define BJC_OPT_4550 BJC_OPT_250
#define BJC_OPT_4650 BJC_OPT_250
#define BJC_OPT_5500                                                           \
	(BJC_OPT_IDENTIFY_CARTRIDGE | BJC_OPT_MONOCHROME_SMOOTHING |           \
	 BJC_OPT_EXTENDED_MARGINS | BJC_OPT_RESOLUTION_360 |                   \
...
#define BJC_OPT_7000                                                           \
	(BJC_OPT_NUL | BJC_OPT_LF | BJC_OPT_IDENTIFY_CARTRIDGE |               \
	 BJC_OPT_EXTENDED_MARGINS | BJC_OPT_PAGE_ID | BJC_OPT_RESOLUTION_300 | \
	 BJC_OPT_RESOLUTION_2X_1X | BJC_OPT_RESOLUTION_4X_2X |                 \
	 BJC_OPT_MOVE_LINES | BJC_OPT_IMAGE_FORMAT | BJC_OPT_CONTINUE_IMAGE |  \
...
#define BJC_ENUMERATE_OPTIONS(m)                                               \
	m(50, BJC_OPT_50) m(70, BJC_OPT_70) m(80, BJC_OPT_80)                  \
	    m(210, BJC_OPT_210) m(250, BJC_OPT_250) m(610, BJC_OPT_610)        \
	        m(620, BJC_OPT_620) m(4000, BJC_OPT_4000)                      \
	            m(4100, BJC_OPT_4100) m(4200, BJC_OPT_4200)                \
	                m(4300, BJC_OPT_4300) m(4550, BJC_OPT_4550)            \
	                    m(4650, BJC_OPT_4650) m(5500, BJC_OPT_5500)        \
	                        m(7000, BJC_OPT_7000)
...
void bjc_put_page_margins(stream* s, int length10ths, int lm10ths, int rm10ths,
                          int indent60ths);
...
void bjc_put_image_format(stream* s, int depth, bjc_image_format_t format,
