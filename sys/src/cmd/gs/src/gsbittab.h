...
#define btab4_(v0, v8, v4, v2, v1)                                             \
	btab2_(v0, v2, v1), btab2_(v4 + v0, v2, v1), btab2_(v8 + v0, v2, v1),  \
	    btab2_(v8 + v4 + v0, v2, v1)
...
#define btab6_(v0, v20, v10, v8, v4, v2, v1)                                   \
	btab4_(v0, v8, v4, v2, v1), btab4_(v10 + v0, v8, v4, v2, v1),          \
	    btab4_(v20 + v0, v8, v4, v2, v1),                                  \
	    btab4_(v20 + v10 + v0, v8, v4, v2, v1)
#define bit_table_6(v0, v20, v10, v8, v4, v2, v1)                              \
	btab6_(v0, v20, v10, v8, v4, v2, v1)
#define bit_table_8(v0, v80, v40, v20, v10, v8, v4, v2, v1)                    \
	btab6_(v0, v20, v10, v8, v4, v2, v1),                                  \
	    btab6_(v40 + v0, v20, v10, v8, v4, v2, v1),                        \
	    btab6_(v80 + v0, v20, v10, v8, v4, v2, v1),                        \
	    btab6_(v80 + v40 + v0, v20, v10, v8, v4, v2, v1)
 ...
 */
extern const byte byte_bit_run_length_0[256], byte_bit_run_length_1[256],
