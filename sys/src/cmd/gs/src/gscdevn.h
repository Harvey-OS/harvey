 ...
 */
int gs_build_DeviceN(gs_color_space* pcspace, uint num_components,
 ...
 * tint transform Function.
 */
int gs_cspace_build_DeviceN(gs_color_space** ppcspace,
                            gs_separation_name* psnames, uint num_components,
...
extern int gs_cspace_set_devn_proc(gs_color_space* pcspace,
                                   int (*proc)(const float*, float*,
                                               const gs_imager_state*, void*),
                                   void* proc_data);
...
#endif
int gs_cspace_set_devn_function(gs_color_space* pcspace, gs_function_t* pfn);
...
int gx_serialize_device_n_map(const gs_color_space* pcs, gs_device_n_map* m,
                              stream* s);
