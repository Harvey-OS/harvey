...
#define public_st_cmap_adobe1() /* in gsfcmap1.c */                            \
	gs_public_st_suffix_add4(                                              \
	    st_cmap_adobe1, gs_cmap_adobe1_t, "gs_cmap_adobe1_t",              \
	    cmap_adobe1_enum_ptrs, cmap_adobe1_reloc_ptrs, st_cmap,            \
...
int gs_cmap_adobe1_alloc(gs_cmap_adobe1_t** ppcmap, int wmode,
                         const byte* map_name, uint name_size, uint num_fonts,
                         uint num_ranges, uint num_lookups, uint keys_size,
                         uint values_size, const gs_cid_system_info_t* pcidsi,
                         gs_memory_t* mem);
