...
private
iodev_proc_init(iodev_rom_init);
private
iodev_proc_open_file(iodev_rom_open_file);
/* close is handled by stream closure */

/* device definition */
const gx_io_device gs_iodev_rom =
    {
     "%rom%", "FileSystem", {iodev_rom_init, iodev_no_open_device, iodev_rom_open_file, iodev_no_fopen, iodev_no_fclose, iodev_no_delete_file, iodev_no_rename_file, iodev_no_file_status, iodev_no_enumerate_files, NULL, NULL, iodev_no_get_params, iodev_no_put_params}};
