...
private
const gx_device_procs tiffgray_procs =
...
private
const tiff_gray_values val_gray_template = {
    {8}};
...
private
const tiff_cmyk_values val_cmyk_template = {
    {8, 8, 8, 8}};
...
#define device_procs                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \
	{                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
		tiffsep_prn_open, gx_default_get_initial_matrix, NULL, /* sync_output */ gdev_prn_output_page, /* output_page */ tiffsep_prn_close, /* close */ NULL, /* map_rgb_color - not used */ tiffsep_decode_color, /* map_color_rgb */ NULL, /* fill_rectangle */ NULL, /* tile_rectangle */ NULL, /* copy_mono */ NULL, /* copy_color */ NULL, /* draw_line */ NULL, /* get_bits */ tiffsep_get_params, /* get_params */ tiffsep_put_params, /* put_params */ NULL, /* map_cmyk_color - not used */ NULL, /* get_xfont_procs */ NULL, /* get_xfont_device */ NULL, /* map_rgb_alpha_color */ gx_page_device_get_page_device, /* get_page_device */ NULL, /* get_alpha_bits */ NULL, /* copy_alpha */ NULL, /* get_band */ NULL, /* copy_rop */ NULL, /* fill_path */ NULL, /* stroke_path */ NULL, /* fill_mask */ NULL, /* fill_trapezoid */ NULL, /* fill_parallelogram */ NULL, /* fill_triangle */ NULL, /* draw_thin_line */ NULL, /* begin_image */ NULL, /* image_data */ NULL, /* end_image */ NULL, /* strip_tile_rectangle */ NULL, /* strip_copy_rop */ NULL, /* get_clipping_box */ NULL, /* begin_typed_image */ NULL, /* get_bits_rectangle */ NULL, /* map_color_rgb_alpha */ NULL, /* create_compositor */ NULL, /* get_hardware_params */ NULL, /* text_begin */ NULL, /* finish_copydevice */ NULL, /* begin_transparency_group */ NULL, /* end_transparency_group */ NULL, /* begin_transparency_mask */ NULL, /* end_transparency_mask */ NULL, /* discard_transparency_layer */ tiffsep_get_color_mapping_procs, /* get_color_mapping_procs */ tiffsep_get_color_comp_index, /* get_color_comp_index */ tiffsep_encode_color, /* encode_color */ tiffsep_decode_color, /* decode_color */ NULL, /* pattern_manage */ NULL, /* fill_rectangle_hl_color */ NULL, /* include_color_space */ NULL, /* fill_linear_color_scanline */ NULL, /* fill_linear_color_trapezoid */ NULL, /* fill_linear_color_triangle */ tiffsep_update_spot_equivalent_colors /* update_spot_equivalent_colors */ \
	}

#define tiffsep_device_body(procs, dname, ncomp, pol, depth, mg, mc, cn)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                \
	std_device_full_body_type_extended(tiffsep_device, &procs, dname, &st_tiffsep_device, (int)((long)(DEFAULT_WIDTH_10THS) * (X_DPI) / 10), (int)((long)(DEFAULT_HEIGHT_10THS) * (Y_DPI) / 10), X_DPI, Y_DPI, GX_DEVICE_COLOR_MAX_COMPONENTS, /* MaxComponents */ ncomp, /* NumComp */ pol, /* Polarity */ depth, 0, /* Depth, GrayIndex */ mg, mc, /* MaxGray, MaxColor */ mg + 1, mc + 1, /* DitherGray, DitherColor */ GX_CINFO_SEP_LIN, /* Linear & Separable */ cn, /* Process color model name */ 0, 0, /* offsets */ 0, 0, 0, 0 /* margins */), prn_device_body_rest_(tiffsep_print_page), {0}, /* tiff state for comp file */ {{0}}, /* tiff state for separation files */ \
	{                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \
		0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
	} /* separation files */
