 ...
 */
#if defined(__SVR3) || defined(__EMX__) || defined(__DVX__) || defined(OSK) || \
    defined(__MSDOS__) || defined(__QNX__) || defined(VMS) ||                  \
    defined(__WIN32__) || defined(__IBMC__) || defined(__BEOS__) ||            \
    defined(Plan9) || defined(__WATCOMC__)
