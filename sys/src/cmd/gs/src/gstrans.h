...
#define PDF14_OPCODE_NAMES                                                                                                                                                                                                             \
	{                                                                                                                                                                                                                              \
		"PDF14_PUSH_DEVICE      ", "PDF14_POP_DEVICE       ", "PDF14_BEGIN_TRANS_GROUP", "PDF14_END_TRANS_GROUP  ", "PDF14_INIT_TRANS_MASK  ", "PDF14_BEGIN_TRANS_MASK ", "PDF14_END_TRANS_MASK   ", "PDF14_SET_BLEND_PARAMS " \
	}
...
#define ESTIMATED_PDF14_ROW_SIZE(width) ((width)*BITS_PER_CHANNEL * (NUM_ALPHA_CHANNELS + NUM_COLOR_CHANNELS))
