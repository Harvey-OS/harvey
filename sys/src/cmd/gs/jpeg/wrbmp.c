...
/* This version is for writing 24-bit pixels */
{
	...
	image_ptr = (*cinfo->mem->access_virt_sarray)((j_common_ptr)cinfo, dest->whole_image,
...
jinit_write_bmp(j_decompress_ptr cinfo, boolean is_os2)
{
	...
	dest->whole_image = (*cinfo->mem->request_virt_sarray)((j_common_ptr)cinfo, JPOOL_IMAGE, FALSE,
