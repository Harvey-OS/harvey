...
get_memory_row(j_compress_ptr cinfo, cjpeg_source_ptr sinfo)
{
	...
	source->pub.buffer = (*cinfo->mem->access_virt_sarray)((j_common_ptr)cinfo, source->whole_image,
...
jinit_read_targa(j_compress_ptr cinfo)
{
	...
	source = (tga_source_ptr) (*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_IMAGE,
