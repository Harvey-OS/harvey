	...
	} else /* (png_combine_row() is never called with mask == 0) */
	{
		...
		case 8: /* png_ptr->row_info.pixel_depth */
		{
...
#endif
			{
				png_uint_32 len;
				int diff;
				int dummy_value_a; // fix 'forbidden register
				                   // spilled' error
				int dummy_value_d;
				int dummy_value_c;
				int dummy_value_S;
				int dummy_value_D;
				_unmask =
				    ~mask; // global variable for -fPIC version
				...
				__asm__ __volatile__(
				    ...
				    : "=a"(
				          dummy_value_a), // output regs (dummy)
				      "=d"(dummy_value_d),
				      "=c"(dummy_value_c), "=S"(dummy_value_S),
				      "=D"(dummy_value_D)

				    : "3"(srcptr), // esi       // input regs
				      "4"(dstptr), // edi
				      "0"(diff),   // eax
				      // was (unmask)     "b"    RESERVED    //
				      // ebx       // Global Offset Table idx
				      "2"(len), // ecx
				      "1"(mask) // edx
...
#endif                         /* PNG_ASSEMBLER_CODE_SUPPORTED */
			{
				...
				png_uint_32 initial_val =
				    png_pass_start[png_ptr->pass];
				/* png.c:  png_pass_start[] = {0, 4, 0, 2, 0, 1,
				 * 0}; */
				register int stride =
				    png_pass_inc[png_ptr->pass];
				/* png.c:  png_pass_inc[] = {8, 8, 4, 4, 2, 2,
				 * 1}; */
				register int rep_bytes =
				    png_pass_width[png_ptr->pass];
				/* png.c:  png_pass_width[] = {8, 4, 4, 2, 2, 1,
				 * 1}; */
				png_uint_32 len = png_ptr->width &
				                  ~7; /* reduce to mult. of 8 */
				int diff =
				    (int)(png_ptr->width & 7); /* amount lost */
				register png_uint_32 final_val =
				    len; /* GRR bugfix */
				...
				if(diff) /* number of leftover pixels:  3 for
				            pngtest */
				{
					final_val += diff /* *BPP1 */;
		...
		case 16: /* png_ptr->row_info.pixel_depth */
		{
...
#endif
			{
				...
				__asm__ __volatile__(
				    ...
				    : "=a"(
				          dummy_value_a), // output regs (dummy)
				      "=c"(dummy_value_c),
				      "=d"(dummy_value_d), "=S"(dummy_value_S),
				      "=D"(dummy_value_D)
...
#endif                         /* PNG_ASSEMBLER_CODE_SUPPORTED */
			{
				register png_uint_32 i;
				png_uint_32 initial_val =
				    BPP2 * png_pass_start[png_ptr->pass];
				/* png.c:  png_pass_start[] = {0, 4, 0, 2, 0, 1,
				 * 0}; */
				register int stride =
				    BPP2 * png_pass_inc[png_ptr->pass];
				/* png.c:  png_pass_inc[] = {8, 8, 4, 4, 2, 2,
				 * 1}; */
				register int rep_bytes =
				    BPP2 * png_pass_width[png_ptr->pass];
				/* png.c:  png_pass_width[] = {8, 4, 4, 2, 2, 1,
				 * 1}; */
				png_uint_32 len = png_ptr->width &
				                  ~7; /* reduce to mult. of 8 */
		...
		case 24: /* png_ptr->row_info.pixel_depth */
		{
...
#endif                         /* PNG_ASSEMBLER_CODE_SUPPORTED */
			{
				register png_uint_32 i;
				png_uint_32 initial_val =
				    BPP3 * png_pass_start[png_ptr->pass];
				/* png.c:  png_pass_start[] = {0, 4, 0, 2, 0, 1,
				 * 0}; */
				register int stride =
				    BPP3 * png_pass_inc[png_ptr->pass];
				/* png.c:  png_pass_inc[] = {8, 8, 4, 4, 2, 2,
				 * 1}; */
				register int rep_bytes =
				    BPP3 * png_pass_width[png_ptr->pass];
				/* png.c:  png_pass_width[] = {8, 4, 4, 2, 2, 1,
				 * 1}; */
				png_uint_32 len = png_ptr->width &
				                  ~7; /* reduce to mult. of 8 */
		...
		case 32: /* png_ptr->row_info.pixel_depth */
		{
...
#endif                         /* PNG_ASSEMBLER_CODE_SUPPORTED */
			{
				register png_uint_32 i;
				png_uint_32 initial_val =
				    BPP4 * png_pass_start[png_ptr->pass];
				/* png.c:  png_pass_start[] = {0, 4, 0, 2, 0, 1,
				 * 0}; */
				register int stride =
				    BPP4 * png_pass_inc[png_ptr->pass];
				/* png.c:  png_pass_inc[] = {8, 8, 4, 4, 2, 2,
				 * 1}; */
				register int rep_bytes =
				    BPP4 * png_pass_width[png_ptr->pass];
				/* png.c:  png_pass_width[] = {8, 4, 4, 2, 2, 1,
				 * 1}; */
				png_uint_32 len = png_ptr->width &
				                  ~7; /* reduce to mult. of 8 */
		...
		case 48: /* png_ptr->row_info.pixel_depth */
		{
...
#endif                         /* PNG_ASSEMBLER_CODE_SUPPORTED */
			{
				register png_uint_32 i;
				png_uint_32 initial_val =
				    BPP6 * png_pass_start[png_ptr->pass];
				/* png.c:  png_pass_start[] = {0, 4, 0, 2, 0, 1,
				 * 0}; */
				register int stride =
				    BPP6 * png_pass_inc[png_ptr->pass];
				/* png.c:  png_pass_inc[] = {8, 8, 4, 4, 2, 2,
				 * 1}; */
				register int rep_bytes =
				    BPP6 * png_pass_width[png_ptr->pass];
				/* png.c:  png_pass_width[] = {8, 4, 4, 2, 2, 1,
				 * 1}; */
				png_uint_32 len = png_ptr->width &
				                  ~7; /* reduce to mult. of 8 */
		...
		case 64: /* png_ptr->row_info.pixel_depth */
		{
			...
			register png_uint_32 i;
			png_uint_32 initial_val =
			    BPP8 * png_pass_start[png_ptr->pass];
			/* png.c:  png_pass_start[] = {0, 4, 0, 2, 0, 1, 0}; */
			register int stride =
			    BPP8 * png_pass_inc[png_ptr->pass];
			/* png.c:  png_pass_inc[] = {8, 8, 4, 4, 2, 2, 1}; */
			register int rep_bytes =
			    BPP8 * png_pass_width[png_ptr->pass];
			/* png.c:  png_pass_width[] = {8, 4, 4, 2, 2, 1, 1}; */
			png_uint_32 len =
			    png_ptr->width & ~7; /* reduce to mult. of 8 */
		...
		default: /* png_ptr->row_info.pixel_depth !=
    ...
    png_do_read_interlace(png_structp png_ptr)
{
	...
	if(row != NULL && row_info != NULL) {
		...
		default: /* 8-bit or larger (this is where the routine is
		            modified) */
		{
#if 0
...
//          unsigned long long const4 = 0x0000000000FFFFFFLL;          no good
			...
			/* point dp at the last pixel position in the expanded
			 * row: */
...
/* New code by Nirav Chhatrapati - Intel Corporation */
...
#endif
			{
					                    ...
					                    (pass == 5)) */
					{
						...
						if(width_mmx) {
							...
							__asm__ __volatile__(
							    ...
							    : "=c"(
							          dummy_value_c), // output regs (dummy)
							      "=S"(
							          dummy_value_S),
							      "=D"(
							          dummy_value_D)
					                    ...
					                    (pass == 5)) */
					{
						...
						if(width_mmx) {
							...
							__asm__ __volatile__(
							    ...
							    : "=c"(
							          dummy_value_c), // output regs (none)
							      "=S"(
							          dummy_value_S),
							      "=D"(
							          dummy_value_D)
				...
				//--------------------------------------------------------------
					...
					// GRR TEST:  should work, but needs
					// testing (special 64-bit version of
					// rpng2?)
					// GRR NOTE:  no need to combine passes
					// here!
					if(((pass == 0) || (pass == 1)) &&
					   width) {
						int dummy_value_c; // fix
                        ...
                        : "%mm0"                       // clobber list
					          ...
					          width) {
						// source is 8-byte RRGGBBAA
						// dest is 32-byte RRGGBBAA
						// RRGGBBAA RRGGBBAA RRGGBBAA
						// (recall that expansion is _in
						// place_:  sptr and dp
						//  both point at locations
						//  within same row buffer)
						{
							int dummy_value_c; // fix
							                   // 'forbidden
							                   // register
...
union uAll {
	long long use;
	double align;
} _LBCarryMask = {0x0101010101010101LL}, _HBClearMask = {0x7f7f7f7f7f7f7f7fLL},
...
// initialize address pointers and offset
	    ...
	    "incl %%ebx                  \n\t"
	    "shrb %%al                   \n\t" // divide by 2
	    "addb -1(%%edi,%%ebx,),%%al  \n\t" // add Avg(x); -1 to offset inc
	                                       // ebx
	    // pre "cmpl bpp, %%ebx             \n\t" // (bpp is preloaded into
	    // ecx)
	    "cmpl %%ecx, %%ebx           \n\t"
	    "movb %%al,-1(%%edi,%%ebx,)  \n\t" // write Raw(x); -1 to offset inc
	                                       // ebx
	    ...
	    "subl %%eax, %%ecx           \n\t" // drop over bytes from original
	                                       // length
	    "movl %%ecx, _MMXLength      \n\t"
#ifdef __PIC__
	    "popl %%ebx                  \n\t" // restore index to Global Offset
	                                       // Table
#endif
	...
	case 3: {
		...
		__asm__ __volatile__(
		    ...
		    "paddb %%mm1, %%mm0           \n\t" // add (Prev_row/2) to
		                                        // Avg for
		                                        // each byte
		    // add 1st active group (Raw(x-bpp)/2) to average with
		    // LBCarry
		    "movq %%mm3, %%mm1            \n\t" // now use mm1 for
		                                        // getting
		                                        // LBCarrys
		    "pand %%mm2, %%mm1            \n\t" // get LBCarrys for each
		                                        // byte
		                                        // where both
		    ...
		    "paddb %%mm2, %%mm0           \n\t" // add (Raw/2) +
		                                        ...
		                                        // Avg for each Active
		                                        //  byte
		    // add 2nd active group (Raw(x-bpp)/2) to average with
		    // _LBCarry
		    "psllq _ShiftBpp, %%mm6       \n\t" // shift the mm6 mask to
		                                        // cover
		                                        // bytes 3-5
		    "movq %%mm0, %%mm2            \n\t" // mov updated Raws to
		                                        // mm2
		    ...
		    // add 3rd active group (Raw(x-bpp)/2) to average with
		    // _LBCarry
		    "psllq _ShiftBpp, %%mm6       \n\t" // shift mm6 mask to
		                                        // cover last
		                                        // two
	...
	case 6:
	case 4:
		// case 7:   // who wrote this?  PNG doesn't support 5 or 7
		// bytes/pixel
		// case 5:   // GRR BOGUS
		{
			_ActiveMask.use =
			    0xffffffffffffffffLL; // use shift below to clear
			...
			__asm__ __volatile__(
			    ...
			    // load _ActiveMask and clear all bytes except for
			    // 1st active group
			    "movq _ActiveMask, %%mm7     \n\t"
			    // preload  "movl row, %%edi             \n\t" //
			    // edi:  Avg(x)
	...
	case 2: {
		...
		__asm__ __volatile__(
		    ...
		    // add 4th active group (Raw(x-bpp)/2) to average with
		    // _LBCarry
		    "psllq _ShiftBpp, %%mm6      \n\t" // shift the mm6 mask to
		                                       // cover
		                                       // bytes 6 & 7
...
// re-init address pointers and offset
	...
	default: // bpp greater than 8 (!= 1,2,3,4,[5],6,[7],8)
	{
		...
		png_debug(1, "Internal logic error in pnggccrd "
...
// check if any remaining bytes left to decode
	    ...
	    "movb %%al, -1(%%edi,%%ebx,) \n\t" // write back Raw(x) [mov does
	                                       // not
	    "jb avg_lp2                  \n\t" //  affect flags; -1 to offset
	                                       //  inc ebx]

	    "avg_end:                       \n\t"
	    "EMMS                        \n\t" // end MMX; prep for poss. FP
	                                       // instrs.
#ifdef __PIC__
	    "popl %%ebx                  \n\t" // restore index to Global Offset
	                                       // Table
                                  ...
                                  png_bytep prev_row)
{
	...
	case 3: {
		...
		__asm__ __volatile__(
		    ...
		    // pb = abs(p-b) = abs(pbv)
		    // pc = abs(p-c) = abs(pcv)
		    "pcmpgtw %%mm4, %%mm0        \n\t" // create mask pav bytes
		                                       // < 0
		    "paddw %%mm5, %%mm6          \n\t"
		    "pand %%mm4, %%mm0           \n\t" // only pav bytes < 0 in
		                                       // mm7
		    "pcmpgtw %%mm5, %%mm7        \n\t" // create mask pbv bytes
		                                       // < 0
		    "psubw %%mm0, %%mm4          \n\t"
		    "pand %%mm5, %%mm7           \n\t" // only pbv bytes < 0 in
		                                       // mm0
	...
	case 6:
		...
		// case 5:   // GRR BOGUS
		{
			...
			__asm__ __volatile__(
			    ...
			    "paddw %%mm3, %%mm7          \n\t"
			    "pxor %%mm0, %%mm0           \n\t"
			    // step ecx to next set of 8 bytes and repeat loop
			    // til done
			    "addl $8, %%ecx              \n\t"
			    "packuswb %%mm7, %%mm1       \n\t"
			    "paddb -8(%%edi,%%ecx,), %%mm1 \n\t" // add Paeth
    ...
    png_read_filter_row_mmx_sub(png_row_infop row_info, png_bytep row)
{
	...
	bpp =
	    (row_info->pixel_depth + 7) >> 3; // calc number of bytes per pixel
	...
	case 8: {
		__asm__ __volatile__(
		    ...
		    // prime the pump:  load the first Raw(x-bpp) data set
		    "movq -8(%%edi,%%edx,), %%mm7 \n\t"
		    "andl $0x0000003f, %%ecx      \n\t" // calc bytes over mult
		                                        // of 64

		    "sub_8lp:                        \n\t"
		    "movq (%%edi,%%edx,), %%mm0   \n\t" // load Sub(x) for 1st 8
		                                        // bytes
		    "paddb %%mm7, %%mm0           \n\t"
		    "movq 8(%%edi,%%edx,), %%mm1  \n\t" // load Sub(x) for 2nd 8
		                                        // bytes
		    "movq %%mm0, (%%edi,%%edx,)   \n\t" // write Raw(x) for 1st
		                                        // 8 bytes

		    // Now mm0 will be used as Raw(x-bpp) for the 2nd group of 8
		    // bytes.
		    // This will be repeated for each group of 8 bytes with the
		    // 8th
		    // group being used as the Raw(x-bpp) for the 1st group of
		    // the
		    // next loop.

		    "paddb %%mm0, %%mm1           \n\t"
		    "movq 16(%%edi,%%edx,), %%mm2 \n\t" // load Sub(x) for 3rd 8
		                                        // bytes
		    "movq %%mm1, 8(%%edi,%%edx,)  \n\t" // write Raw(x) for 2nd
		                                        // 8 bytes
		    "paddb %%mm1, %%mm2           \n\t"
		    "movq 24(%%edi,%%edx,), %%mm3 \n\t" // load Sub(x) for 4th 8
		                                        // bytes
		    "movq %%mm2, 16(%%edi,%%edx,) \n\t" // write Raw(x) for 3rd
		                                        // 8 bytes
		    "paddb %%mm2, %%mm3           \n\t"
		    "movq 32(%%edi,%%edx,), %%mm4 \n\t" // load Sub(x) for 5th 8
		                                        // bytes
		    "movq %%mm3, 24(%%edi,%%edx,) \n\t" // write Raw(x) for 4th
		                                        // 8 bytes
		    "paddb %%mm3, %%mm4           \n\t"
		    "movq 40(%%edi,%%edx,), %%mm5 \n\t" // load Sub(x) for 6th 8
		                                        // bytes
		    "movq %%mm4, 32(%%edi,%%edx,) \n\t" // write Raw(x) for 5th
		                                        // 8 bytes
		    "paddb %%mm4, %%mm5           \n\t"
		    "movq 48(%%edi,%%edx,), %%mm6 \n\t" // load Sub(x) for 7th 8
		                                        // bytes
		    "movq %%mm5, 40(%%edi,%%edx,) \n\t" // write Raw(x) for 6th
		                                        // 8 bytes
		    "paddb %%mm5, %%mm6           \n\t"
		    "movq 56(%%edi,%%edx,), %%mm7 \n\t" // load Sub(x) for 8th 8
		                                        // bytes
		    "movq %%mm6, 48(%%edi,%%edx,) \n\t" // write Raw(x) for 7th
		                                        // 8 bytes
		    "addl $64, %%edx              \n\t"
...
// get # of bytes to alignment
	    ...
	    "paddb %%mm7, %%mm6           \n\t"
	    "cmpl %%ecx, %%ebx            \n\t"
	    "movq %%mm6, -8(%%edi,%%ebx,) \n\t" // (+56)movq does not affect
	                                        // flags;
	    "jb up_loop                   \n\t" //  -8 to offset addl ebx

	    "cmpl $0, %%edx               \n\t" // test for bytes over mult of
	                                        // 64
	    "jz up_end                    \n\t"
	    ...
	    "up_lt8:                         \n\t"
	    "xorl %%eax, %%eax            \n\t"
	    "addl %%edx, %%ecx            \n\t" // move over byte count into
	                                        // counter

	    "up_lp2:                         \n\t" // use x86 regs for remaining
	                                           // bytes
	    "movb (%%edi,%%ebx,), %%al    \n\t"
	    "addb (%%esi,%%ebx,), %%al    \n\t"
	    "incl %%ebx                   \n\t"
...
png_mmx_support(void)
{
	...
	__asm__ __volatile__(
	    "pushl %%ebx          \n\t" // ebx gets clobbered by CPUID
	                                // instruction
	    "pushl %%ecx          \n\t" // so does ecx...
	    "pushl %%edx          \n\t" // ...and edx (but ecx & edx safe on
	                                // Linux)
	    //      ".byte  0x66          \n\t"  // convert 16-bit pushf to
	    //      32-bit pushfd
	    //      "pushf                \n\t"  // 16-bit pushf
	    "pushfl               \n\t"  // save Eflag to stack
	    "popl %%eax           \n\t"  // get Eflag from stack into eax
	    "movl %%eax, %%ecx    \n\t"  // make another copy of Eflag in ecx
	    "xorl $0x200000, %%eax \n\t" // toggle ID bit in Eflag (i.e., bit
	                                 // 21)
	    "pushl %%eax          \n\t"  // save modified Eflag back to stack
	    //      ".byte  0x66          \n\t"  // convert 16-bit popf to
	    //      32-bit popfd
	    //      "popf                 \n\t"  // 16-bit popf
	    ...
	    "jz 0f                \n\t" // if same, CPUID instr. is not
	                                // supported

	    "xorl %%eax, %%eax    \n\t" // set eax to zero
	    //      ".byte  0x0f, 0xa2    \n\t"  // CPUID instruction (two-byte
	    //      opcode)
	    ...
	    "0:                       \n\t" // .NOT_SUPPORTED: target label for
	                                    // jump instructions
	    "movl $0, %%eax       \n\t"     // set return value to 0
	    "1:                       \n\t" // .RETURN: target label for jump
	                                    // instructions
	    "movl %%eax, _mmx_supported \n\t" // save in global static variable,
	                                      // too
	    "popl %%edx           \n\t"       // restore edx
	    "popl %%ecx           \n\t"       // restore ecx
	    "popl %%ebx           \n\t"       // restore ebx
	    ...
	    : "%eax" // clobber list
	    //      , "%ebx", "%ecx", "%edx"     // GRR:  we handle these
	    //      manually
	    //      , "memory"   // if write to a variable gcc thought was in a
	    //      reg
