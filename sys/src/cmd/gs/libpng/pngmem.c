...
png_voidp
PNG_MALLOC(png_structp png_ptr, png_uint_32 png_size)
{
   png_voidp ret;
   png_size_t size;
   if (png_ptr == NULL || png_size == 0)
      return NULL;

   size=(png_size_t)png_size;
   if((png_uint_32)size != png_size)
      png_error(png_ptr, "Size overflowed in pngmem");
