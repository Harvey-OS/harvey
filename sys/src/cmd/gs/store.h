...
#define make_empty_array(pref,attrs)\
  make_array(pref, attrs, 0, NULL)
#define make_empty_const_array(pref,attrs)\
  make_const_array(pref, attrs, 0, NULL)
...
#define make_empty_string(pref,attrs)\
  make_string(pref, attrs, 0, NULL)
#define make_empty_const_string(pref,attrs)\
  make_const_string(pref, attrs, 0, NULL)

#define make_struct(pref,attrs,ptr)\
  make_tav(pref, t_struct, attrs, pstruct, (void *)(ptr))
#define make_struct_new(pref,attrs,ptr)\
  make_tav_new(pref, t_struct, attrs, pstruct, (void *)(ptr))

#define make_astruct(pref,attrs,ptr)\
  make_tav(pref, t_astruct, attrs, pstruct, (void *)(ptr))
#define make_astruct_new(pref,attrs,ptr)\
  make_tav_new(pref, t_astruct, attrs, pstruct, (void *)(ptr))
