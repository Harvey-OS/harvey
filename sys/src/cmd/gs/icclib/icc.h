...
#define LU_ICM_BASE_MEMBERS                                                                                                                                                                                               \
	...
	void (*lutspaces)(struct _icmLuBase * p, icColorSpaceSignature * ins, int *inn, icColorSpaceSignature *outs, int *outn);                                                                                          \
                                                                                                                                                                                                                          \
	/* External effecive colorspaces */                                                                                                                                                                               \
	void (*spaces)(struct _icmLuBase * p, icColorSpaceSignature * ins, int *inn, icColorSpaceSignature *outs, int *outn, icmLuAlgType *alg, icRenderingIntent *intt, icmLookupFunc *fnc, icColorSpaceSignature *pcs); \
                                                                                                                                                                                                                          \
	/* Get the effective input space and output space ranges */                                                                                                                                                       \
	void (*get_ranges)(struct _icmLuBase * p, double *inmin, double *inmax, /* Maximum range of inspace values */ double *outmin, double *outmax); /* Maximum range of outspace values */                             \
                                                                                                                                                                                                                          \
