 ...
 */
int
bread(Bcache *bc, u32 bno, void *buf)
{
	u64 x = (u64)bno * bc->bsize;
 ...
 */
int
bwrite(Bcache *bc, u32 bno, void *buf)
{
	u64 x = (u64)bno * bc->bsize;
