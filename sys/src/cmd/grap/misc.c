...
void halfrange(Obj* p, int side,
               double val) /* record max and min for one direction */
{
...
double getvar(Obj* p) /* return value of variable */ { return p->fval; }
