...
lw(Opcode *o, Instr *i, char r)
{
	...
	if (i->rs == 30 && mach->sb) {
		...
		if (r == 'F') {
			...
			if (get1(symmap, i->immediate+mach->sb, SEGDATA, (uchar*)&h, 4))
			if (get1(symmap, i->immediate+mach->sb+4, SEGDATA, (uchar*)&l, 4)) {
