/*
 * This file is part of the Harvey distribution (https://harvey-os.org).
 * Copyright (c) 2014 Russ Cox
 *
 ...
 *
 * This file originates from plan9port and is re-licensed GPLv2 for Harvey
 * with permission from Russ Cox
 */
#include <u.h>
#include <libc.h>
#include <draw.h>
...
struct Log
{
	...
	int start; // msg[0] corresponds to 'start' in the global sequence of events
