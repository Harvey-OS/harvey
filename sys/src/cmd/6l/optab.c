...
uint8_t ynone[] = {Ynone, Ynone, Zlit, 1, 0};
uint8_t ytext[] = {Ymb, Yi32, Zpseudo, 1, 0};
uint8_t ynop[] = {Ynone, Ynone, Zpseudo, 1, Ynone, Yml,   Zpseudo, 1,
                  Ynone, Yrf,   Zpseudo, 1, Ynone, Yxr,   Zpseudo, 1,
                  Yml,   Ynone, Zpseudo, 1, Yrf,   Ynone, Zpseudo, 1,
                  Yxr,   Ynone, Zpseudo, 1, 0};
uint8_t yxorb[] = {Yi32, Yal,  Zib_, 1,   Yi32, Ymb,  Zibo_m, 2, Yrb,
                   Ymb,  Zr_m, 1,    Ymb, Yrb,  Zm_r, 1,      0};
uint8_t yxorl[] = {Yi8,  Yml,  Zibo_m, 2,      Yi32, Yax, Zil_,
                   1,    Yi32, Yml,    Zilo_m, 2,    Yrl, Yml,
                   Zr_m, 1,    Yml,    Yrl,    Zm_r, 1,   0};
uint8_t yaddl[] = {Yi8,  Yml,  Zibo_m, 2,      Yi32, Yax, Zil_,
                   1,    Yi32, Yml,    Zilo_m, 2,    Yrl, Yml,
                   Zr_m, 1,    Yml,    Yrl,    Zm_r, 1,   0};
uint8_t yincb[] = {Ynone, Ymb, Zo_m, 2, 0};
uint8_t yincw[] = {Ynone, Yml, Zo_m, 2, 0};
uint8_t yincl[] = {Ynone, Yml, Zo_m, 2, 0};
uint8_t ycmpb[] = {Yal, Yi32, Z_ib, 1,   Ymb, Yi32, Zm_ibo, 2, Ymb,
                   Yrb, Zm_r, 1,    Yrb, Ymb, Zr_m, 1,      0};
uint8_t ycmpl[] = {Yml,  Yi8, Zm_ibo, 2,      Yax,  Yi32, Z_il,
                   1,    Yml, Yi32,   Zm_ilo, 2,    Yml,  Yrl,
                   Zm_r, 1,   Yrl,    Yml,    Zr_m, 1,    0};
uint8_t yshb[] = {Yi1, Ymb, Zo_m, 2,    Yi32, Ymb, Zibo_m,
                  2,   Ycx, Ymb,  Zo_m, 2,    0};
uint8_t yshl[] = {Yi1, Yml,  Zo_m, 2,   Yi32, Yml,  Zibo_m, 2, Ycl,
                  Yml, Zo_m, 2,    Ycx, Yml,  Zo_m, 2,      0};
uint8_t ytestb[] = {Yi32, Yal,  Zib_, 1,   Yi32, Ymb,  Zibo_m, 2, Yrb,
                    Ymb,  Zr_m, 1,    Ymb, Yrb,  Zm_r, 1,      0};
uint8_t ytestl[] = {Yi32, Yax,  Zil_, 1,   Yi32, Yml,  Zilo_m, 2, Yrl,
                    Yml,  Zr_m, 1,    Yml, Yrl,  Zm_r, 1,      0};
uint8_t ymovb[] = {Yrb, Ymb,    Zr_m, 1,    Ymb, Yrb,    Zm_r, 1, Yi32,
                   Yrb, Zib_rp, 1,    Yi32, Ymb, Zibo_m, 2,    0};
uint8_t ymbs[] = {Ymb, Ynone, Zm_o, 2, 0};
uint8_t ybtl[] = {Yi8, Yml, Zibo_m, 2, Yrl, Yml, Zr_m, 1, 0};
uint8_t ymovw[] = {Yrl,    Yml,  Zr_m,   1,    Yml,    Yrl,    Zm_r, 1,    Yi0,
                   Yrl,    Zclr, 1,      Yi32, Yrl,    Zil_rp, 1,    Yi32, Yml,
                   Zilo_m, 2,    Yiauto, Yrl,  Zaut_r, 2,      0};
uint8_t ymovl[] = {Yrl,    Yml, Zr_m,    1, Yml,  Yrl, Zm_r,    1,
                   Yi0,    Yrl, Zclr,    1, Yi32, Yrl, Zil_rp,  1,
                   Yi32,   Yml, Zilo_m,  2, Yml,  Ymr, Zm_r_xm, 1, // MMX MOVD
                   Ymr,    Yml, Zr_m_xm, 1,                        // MMX MOVD
                   Yml,    Yxr, Zm_r_xm, 2, // XMM MOVD (32 bit)
                   Yxr,    Yml, Zr_m_xm, 2, // XMM MOVD (32 bit)
                   Yiauto, Yrl, Zaut_r,  2, 0};
uint8_t yret[] = {Ynone, Ynone, Zo_iw, 1, Yi32, Ynone, Zo_iw, 1, 0};
uint8_t ymovq[] = {Yrl,    Yml, Zr_m,       1, // 0x89
                   Yml,    Yrl, Zm_r,       1, // 0x8b
                   Yi0,    Yrl, Zclr,       1, // 0x31
                   ...
                   0};
uint8_t ym_rl[] = {Ym, Yrl, Zm_r, 1, 0};
uint8_t yrl_m[] = {Yrl, Ym, Zr_m, 1, 0};
uint8_t ymb_rl[] = {Ymb, Yrl, Zmb_r, 1, 0};
uint8_t yml_rl[] = {Yml, Yrl, Zm_r, 1, 0};
uint8_t yrl_ml[] = {Yrl, Yml, Zr_m, 1, 0};
uint8_t yml_mb[] = {Yrb, Ymb, Zr_m, 1, Ymb, Yrb, Zm_r, 1, 0};
uint8_t yrb_mb[] = {Yrb, Ymb, Zr_m, 1, 0};
uint8_t yml_ml[] = {Yrl, Yml, Zr_m, 1, Yml, Yrl, Zm_r, 1, 0};
uint8_t ydivl[] = {Yml, Ynone, Zm_o, 2, 0};
uint8_t ydivb[] = {Ymb, Ynone, Zm_o, 2, 0};
uint8_t yimul[] = {Yml, Ynone,  Zm_o, 2,   Yi8, Yrl,  Zib_rr, 1, Yi32,
                   Yrl, Zil_rr, 1,    Yml, Yrl, Zm_r, 2,      0};
uint8_t ybyte[] = {Yi64, Ynone, Zbyte, 1, 0};
uint8_t yin[] = {Yi32, Ynone, Zib_, 1, Ynone, Ynone, Zlit, 1, 0};
uint8_t yint[] = {Yi32, Ynone, Zib_, 1, 0};
uint8_t ypushl[] = {Yrl,   Ynone, Zrp_, 1,    Ym,    Ynone, Zm_o, 2, Yi8,
                    Ynone, Zib_,  1,    Yi32, Ynone, Zil_,  1,    0};
uint8_t ypopl[] = {Ynone, Yrl, Z_rp, 1, Ynone, Ym, Zo_m, 2, 0};
uint8_t yscond[] = {Ynone, Ymb, Zo_m, 2, 0};
uint8_t yjcond[] = {Ynone, Ybr, Zbr, 1, 0};
uint8_t yloop[] = {Ynone, Ybr, Zloop, 1, 0};
uint8_t ycall[] = {Ynone, Yml, Zo_m64, 2, Ynone, Ybr, Zcall, 1, 0};
uint8_t yjmp[] = {Ynone, Yml, Zo_m64, 2, Ynone, Ybr, Zjmp, 1, 0};

uint8_t yfmvd[] = {Ym,  Yf0,  Zm_o, 2,   Yf0, Ym,   Zo_m, 2, Yrf,
                   Yf0, Zm_o, 2,    Yf0, Yrf, Zo_m, 2,    0};
uint8_t yfmvdp[] = {Yf0, Ym, Zo_m, 2, Yf0, Yrf, Zo_m, 2, 0};
uint8_t yfmvf[] = {Ym, Yf0, Zm_o, 2, Yf0, Ym, Zo_m, 2, 0};
uint8_t yfmvx[] = {Ym, Yf0, Zm_o, 2, 0};
uint8_t yfmvp[] = {Yf0, Ym, Zo_m, 2, 0};
uint8_t yfadd[] = {Ym, Yf0, Zm_o, 2, Yrf, Yf0, Zm_o, 2, Yf0, Yrf, Zo_m, 2, 0};
uint8_t yfaddp[] = {Yf0, Yrf, Zo_m, 2, 0};
uint8_t yfxch[] = {Yf0, Yrf, Zo_m, 2, Yrf, Yf0, Zm_o, 2, 0};
uint8_t ycompp[] = {Yf0, Yrf, Zo_m, 2, /* botch is really f0,f1 */
                    0};
uint8_t ystsw[] = {Ynone, Ym, Zo_m, 2, Ynone, Yax, Zlit, 1, 0};
uint8_t ystcw[] = {Ynone, Ym, Zo_m, 2, Ym, Ynone, Zm_o, 2, 0};
uint8_t ysvrs[] = {Ynone, Ym, Zo_m, 2, Ym, Ynone, Zm_o, 2, 0};
uint8_t ymm[] = {Ymm, Ymr, Zm_r_xm, 1, Yxm, Yxr, Zm_r_xm, 2, 0};
uint8_t yxm[] = {Yxm, Yxr, Zm_r_xm, 1, 0};
uint8_t yxcvm1[] = {Yxm, Yxr, Zm_r_xm, 2, Yxm, Ymr, Zm_r_xm, 2, 0};
uint8_t yxcvm2[] = {Yxm, Yxr, Zm_r_xm, 2, Ymm, Yxr, Zm_r_xm, 2, 0};
uint8_t yxmq[] = {Yxm, Yxr, Zm_r_xm, 2, 0};
uint8_t yxr[] = {Yxr, Yxr, Zm_r_xm, 1, 0};
uint8_t yxr_ml[] = {Yxr, Yml, Zr_m_xm, 1, 0};
uint8_t ymr[] = {Ymr, Ymr, Zm_r, 1, 0};
uint8_t ymr_ml[] = {Ymr, Yml, Zr_m_xm, 1, 0};
uint8_t yxcmp[] = {Yxm, Yxr, Zm_r_xm, 1, 0};
uint8_t yxcmpi[] = {Yxm, Yxr, Zm_r_i_xm, 2, 0};
uint8_t yxmov[] = {Yxm, Yxr, Zm_r_xm, 1, Yxr, Yxm, Zr_m_xm, 1, 0};
uint8_t yxcvfl[] = {Yxm, Yrl, Zm_r_xm, 1, 0};
uint8_t yxcvlf[] = {Yml, Yxr, Zm_r_xm, 1, 0};
uint8_t yxcvfq[] = {Yxm, Yrl, Zm_r_xm, 2, 0};
uint8_t yxcvqf[] = {Yml, Yxr, Zm_r_xm, 2, 0};
uint8_t yps[] = {Ymm, Ymr,     Zm_r_xm, 1,   Yi8, Ymr,       Zibo_m_xm, 2, Yxm,
                 Yxr, Zm_r_xm, 2,       Yi8, Yxr, Zibo_m_xm, 3,         0};
uint8_t yxrrl[] = {Yxr, Yrl, Zm_r, 1, 0};
uint8_t ymfp[] = {
    Ymm, Ymr, Zm_r_3d, 1, 0,
};
uint8_t ymrxr[] = {Ymr, Yxr, Zm_r, 1, Yxm, Yxr, Zm_r_xm, 1, 0};
uint8_t ymshuf[] = {Ymm, Ymr, Zibm_r, 1, 0};
uint8_t yxshuf[] = {Yxm, Yxr, Zibm_r, 1, 0};
uint8_t yextrw[] = {Yxr, Yrl, Zibm_r, 1, 0};
uint8_t ypsdq[] = {Yi8, Yxr, Zibo_m, 2, 0};
uint8_t ymskb[] = {Yxr, Yrl, Zm_r_xm, 2, Ymr, Yrl, Zm_r_xm, 1, 0};
...
Optab optab[] =
    ...
    {{AXXX},
     ...
     {AMOVL, ymovl, Px, 0x89, 0x8b, 0x31, 0xb8, 0xc7, (00), 0x6e, 0x7e, Pe,
      0x6e, Pe, 0x7e},
     ...
     {AMOVQ, ymovq, Pw, 0x89, 0x8b, 0x31, 0xc7, (00), 0xb8, 0xc7, (00), 0x6f,
      0x7f, 0x6e, 0x7e, Pf2, 0xd6, Pe, 0xd6, Pe, 0x6e, Pe, 0x7e},
     ...
     {ASAHF, ynone, Px, 0x86, 0xe0, 0x50,
      0x9d}, /* XCHGB AH,AL; PUSH AX; POPFL */
