...
void (*cvtpixels)(u8*, u8*, int);

static void
chan2fmt(Pixfmt *fmt, u32 chan)
{
	u32 c, rc, shift;
 ...
 */
static void
cvt32to24(u8 *dst, u8 *src, int npixel)
{
	int i;
...
static void
cvtrgb12tocmap8(u8 *dst, u8 *src, int npixel)
{
	int i, s;
...
static void
cvtbgr332tocmap8(u8 *dst, u8 *src, int npixel)
{
	u8 *ed;
