...
Cursor arrow = {
    {-1, -1},
    {
     0xFF, 0xFF, 0x80, 0x01, 0x80, 0x02, 0x80, 0x0C, 0x80, 0x10, 0x80, 0x10,
     0x80, 0x08, 0x80, 0x04, 0x80, 0x02, 0x80, 0x01, 0x80, 0x02, 0x8C, 0x04,
     0x92, 0x08, 0x91, 0x10, 0xA0, 0xA0, 0xC0, 0x40,
    },
    {
     0x00, 0x00, 0x7F, 0xFE, 0x7F, 0xFC, 0x7F, 0xF0, 0x7F, 0xE0, 0x7F, 0xE0,
     0x7F, 0xF0, 0x7F, 0xF8, 0x7F, 0xFC, 0x7F, 0xFE, 0x7F, 0xFC, 0x73, 0xF8,
...
int setcolor(uint32_t, uint32_t, uint32_t, uint32_t) { return 0; }
...
{
	static uint8_t set[CURSORDIM * CURSORDIM],
	    clr[CURSORDIM * CURSORDIM / 8];
	static int ver = -1;
	int i, j, n;
	...
	if(ver != cursorver) {
		...
		loadmemimage(cursorclear, cursorr, clr,
		             CURSORDIM * CURSORDIM / 8);
	} else
		unlock(&cursor);
