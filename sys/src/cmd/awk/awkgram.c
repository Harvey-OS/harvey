...
#line	44	"/sys/src/cmd/awk/awkgram.y"
typedef union  {
	Node	*p;
	Cell	*cp;
	int	i;
...
#line	448	"/sys/src/cmd/awk/awkgram.y"
...
case 1:
#line	101	"/sys/src/cmd/awk/awkgram.y"
{ if (errorflag==0)
			winner = (Node *)stat3(PROGRAM, beginloc, yypt[-0].yyv.p, endloc); } break;
case 2:
#line	103	"/sys/src/cmd/awk/awkgram.y"
...
{inloop++;} break;
case 18:
#line	132	"/sys/src/cmd/awk/awkgram.y"
...
case 20:
#line	137	"/sys/src/cmd/awk/awkgram.y"
{ setfname(yypt[-0].yyv.cp); } break;
case 21:
#line	141	"/sys/src/cmd/awk/awkgram.y"
{ yyval.p = notnull(yypt[-1].yyv.p); } break;
case 26:
#line	153	"/sys/src/cmd/awk/awkgram.y"
{ yyval.i = 0; } break;
case 28:
#line	158	"/sys/src/cmd/awk/awkgram.y"
{ yyval.i = 0; } break;
case 30:
#line	164	"/sys/src/cmd/awk/awkgram.y"
{ yyval.p = 0; } break;
case 32:
#line	169	"/sys/src/cmd/awk/awkgram.y"
{ yyval.p = 0; } break;
case 33:
#line	170	"/sys/src/cmd/awk/awkgram.y"
{ yyval.p = yypt[-1].yyv.p; } break;
case 34:
#line	174	"/sys/src/cmd/awk/awkgram.y"
...
case 39:
#line	182	"/sys/src/cmd/awk/awkgram.y"
{ yyval.p = stat2(PASTAT, NIL, yypt[-1].yyv.p); } break;
case 40:
#line	184	"/sys/src/cmd/awk/awkgram.y"
...
case 56:
#line	217	"/sys/src/cmd/awk/awkgram.y"
{ yyval.p = op2(CAT, yypt[-1].yyv.p, yypt[-0].yyv.p); } break;
case 59:
#line	223	"/sys/src/cmd/awk/awkgram.y"
{ yyval.p = op2(yypt[-1].yyv.i, yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 60:
#line	225	"/sys/src/cmd/awk/awkgram.y"
{ yyval.p = op3(CONDEXPR, notnull(yypt[-4].yyv.p), yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 61:
#line	227	"/sys/src/cmd/awk/awkgram.y"
{ yyval.p = op2(BOR, notnull(yypt[-2].yyv.p), notnull(yypt[-0].yyv.p)); } break;
case 62:
...
{ yyval.p = op2(yypt[-1].yyv.i, yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
case 69:
#line	236	"/sys/src/cmd/awk/awkgram.y"
{ yyval.p = op3(yypt[-1].yyv.i, NIL, yypt[-2].yyv.p, (Node*)makedfa(yypt[-0].yyv.s, 0)); } break;
case 70:
#line	238	"/sys/src/cmd/awk/awkgram.y"
{ if (constnode(yypt[-0].yyv.p))
			yyval.p = op3(yypt[-1].yyv.i, NIL, yypt[-2].yyv.p, (Node*)makedfa(strnode(yypt[-0].yyv.p), 0));
		  else
			yyval.p = op3(yypt[-1].yyv.i, (Node *)1, yypt[-2].yyv.p, yypt[-0].yyv.p); } break;
...
case 106:
#line	311	"/sys/src/cmd/awk/awkgram.y"
{ yyclearin; SYNTAX("illegal statement"); } break;
case 109:
#line	320	"/sys/src/cmd/awk/awkgram.y"
...
case 111:
#line	323	"/sys/src/cmd/awk/awkgram.y"
...
case 116:
#line	328	"/sys/src/cmd/awk/awkgram.y"
...
{ yyval.p = yypt[-1].yyv.p; } break;
case 121:
#line	333	"/sys/src/cmd/awk/awkgram.y"
{ if (infunc)
				SYNTAX("next is illegal inside a function");
			  yyval.p = stat1(NEXT, NIL); } break;
case 122:
#line	336	"/sys/src/cmd/awk/awkgram.y"
{ if (infunc)
...
case 124:
#line	340	"/sys/src/cmd/awk/awkgram.y"
...
case 128:
#line	343	"/sys/src/cmd/awk/awkgram.y"
{ yyval.p = 0; } break;
case 130:
#line	348	"/sys/src/cmd/awk/awkgram.y"
...
case 166:
#line	400	"/sys/src/cmd/awk/awkgram.y"
{ yyval.p = celltonode(yypt[-0].yyv.cp, CCON); } break;
case 167:
#line	402	"/sys/src/cmd/awk/awkgram.y"
{ yyval.p = op4(yypt[-5].yyv.i, NIL, (Node*)makedfa(yypt[-3].yyv.s, 1), yypt[-1].yyv.p, rectonode()); } break;
case 168:
#line	404	"/sys/src/cmd/awk/awkgram.y"
...
case 171:
#line	416	"/sys/src/cmd/awk/awkgram.y"
{ yyval.p = op3(SUBSTR, yypt[-5].yyv.p, yypt[-3].yyv.p, yypt[-1].yyv.p); } break;
case 172:
#line	418	"/sys/src/cmd/awk/awkgram.y"
...
case 177:
#line	426	"/sys/src/cmd/awk/awkgram.y"
...
case 180:
#line	432	"/sys/src/cmd/awk/awkgram.y"
{
...
case 183:
#line	440	"/sys/src/cmd/awk/awkgram.y"
{ yyval.p = op1(VARNF, (Node *) yypt[-0].yyv.cp); } break;
case 184:
#line	445	"/sys/src/cmd/awk/awkgram.y"
{ yyval.p = notnull(yypt[-1].yyv.p); } break;
	}
