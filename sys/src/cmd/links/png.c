...
#ifdef DEBUG
	if (!png_ptr) internal((unsigned char *)"png_create_read_struct failed\n");
#endif /* #ifdef DEBUG */
	info_ptr=png_create_info_struct(png_ptr);
#ifdef DEBUG
	if (!info_ptr) internal ((unsigned char *)"png_create_info_struct failed\n");
#endif /* #ifdef DEBUG */
...
#ifdef DEBUG
	if (!cimg->decoder)
		internal((unsigned char *)"decoder NULL in png_restart\n");
#endif /* #ifdef DEBUG */
