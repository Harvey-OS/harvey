...
Document*
initfilt(Biobuf *b, int argc, char **argv, u8 *buf, int nbuf,
...
Document*
initdvi(Biobuf *b, int argc, char **argv, u8 *buf, int nbuf)
{
	int fd;
	char *name;
	char cmd[256];
...
Document*
inittroff(Biobuf *b, int argc, char **argv, u8 *buf, int nbuf)
{
...
Document*
initmsdoc(Biobuf *b, int argc, char **argv, u8 *buf, int nbuf)
{
