...
static char oemflag[] = {
        [104] 1, [10] 1,  [136] 1, [138] 1, [200] 1, [202] 1, [232] 1,
        [234] 1, [235] 1, [266] 1, [40] 1,  [459] 1, [491] 1, [8] 1,
};
...
undef(uint32_t ir)
{
	 ...
	 * (ir>>19)&0x3f); */
	Bprint(bioout,
	       "illegal_instruction IR #%.8lux (op=%ld/%ld, pc=#%.8lux)\n", ir,
	       getop(ir), getxo(ir), reg.pc);
...
unimp(uint32_t ir)
{
	/*	Bprint(bioout, "op=%d op2=%d op3=%d\n", ir>>30, (ir>>21)&0x7,
	 * (ir>>19)&0x3f); */
	Bprint(bioout, "illegal_instruction IR #%.8lux (op=%ld/%ld, "
	               "pc=#%.8lux) %s not in MPC601\n",
