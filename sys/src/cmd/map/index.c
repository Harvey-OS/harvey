...
static proj
Yaitoff(double, double)
{
	return aitoff();
}
static proj
Yalbers(double p0, double p1)
{
	return albers(p0, p1);
}
static proj
Yazequalarea(double, double)
{
	return azequalarea();
}
static proj
Yazequidistant(double, double)
{
	return azequidistant();
}
static proj
Ybicentric(double p0, double)
{
	return bicentric(p0);
}
static proj
Ybonne(double p0, double)
{
	return bonne(p0);
}
static proj
Yconic(double p0, double)
{
	return conic(p0);
}
static proj
Ycylequalarea(double p0, double)
{
	return cylequalarea(p0);
}
static proj
Ycylindrical(double, double)
{
	return cylindrical();
}
static proj
Yelliptic(double p0, double)
{
	return elliptic(p0);
}
static proj
Yfisheye(double p0, double)
{
	return fisheye(p0);
}
static proj
Ygall(double p0, double)
{
	return gall(p0);
}
static proj
Ygilbert(double, double)
{
	return gilbert();
}
static proj
Yglobular(double, double)
{
	return globular();
}
static proj
Ygnomonic(double, double)
{
	return gnomonic();
}
static proj
Yguyou(double, double)
{
	return guyou();
}
static proj
Yharrison(double p0, double p1)
{
	return harrison(p0, p1);
}
static proj
Yhex(double, double)
{
...
static proj
Yhoming(double p0, double)
{
	return homing(p0);
}
static proj
Ylagrange(double, double)
{
	return lagrange();
}
static proj
Ylambert(double p0, double p1)
{
	return lambert(p0, p1);
}
static proj
Ylaue(double, double)
{
...
static proj
Ylune(double p0, double p1)
{
	return lune(p0, p1);
}
static proj
Ymecca(double p0, double)
{
	return mecca(p0);
}
static proj
Ymercator(double, double)
{
	return mercator();
}
static proj
Ymollweide(double, double)
{
	return mollweide();
}
static proj
Ynewyorker(double p0, double)
{
	return newyorker(p0);
}
static proj
Yorthographic(double, double)
{
	return orthographic();
}
static proj
Yperspective(double p0, double)
{
	return perspective(p0);
}
static proj
Ypolyconic(double, double)
{
	return polyconic();
}
static proj
Yrectangular(double p0, double)
{
	return rectangular(p0);
}
static proj
Ysimpleconic(double p0, double p1)
{
	return simpleconic(p0, p1);
}
static proj
Ysinusoidal(double, double)
{
	return sinusoidal();
}
static proj
Ysp_albers(double p0, double p1)
{
	return sp_albers(p0, p1);
}
static proj
Ysp_mercator(double, double)
{
	return sp_mercator();
}
static proj
Ysquare(double, double)
{
	return square();
}
static proj
Ystereographic(double, double)
{
	return stereographic();
}
static proj
Ytetra(double, double)
{
	return tetra();
}
static proj
Ytrapezoidal(double p0, double p1)
{
	return trapezoidal(p0, p1);
}
static proj
Yvandergrinten(double, double)
{
	return vandergrinten();
}

struct index index[] = {{"aitoff", Yaitoff, 0, picut, 0, 0, 0},
