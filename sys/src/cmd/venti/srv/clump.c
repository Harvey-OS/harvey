 ...
 */
int
storeclump(Index *ix, ZBlock *zb, u8 *sc, int type, u32 creator,
	   IAddr *ia)
{
	ZBlock *cb;
	Clump cl;
 ...
 */
ZBlock*
loadclump(Arena *arena, u64 aa, int blocks, Clump *cl, u8 *score,
	  int verify)
{
	Unwhack uw;
	ZBlock *zb, *cb;
	u8 bh[VtScoreSize], *buf;
	u32 n;
	int nunc;
