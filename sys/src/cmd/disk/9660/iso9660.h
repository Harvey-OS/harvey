 ...
 * iso9660.h
 *
 * Routines and data structures to support reading and writing ISO 9660 CD
 *images.
 * See the ISO 9660 or ECMA 119 standards.
 *
 * Also supports Rock Ridge extensions for int32_t file names and Unix stuff.
 * Also supports Microsoft's Joliet extensions for Unicode and int32_t file
 *names.
...
int parsedir(Cdimg*, Direc*, unsigned char*, int,
