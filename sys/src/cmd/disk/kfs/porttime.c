...
static	void	klocaltime(i32 tim, Tm *ct);
static	void	kgmtime(i32 tim, Tm *ct);
...
static struct
{
	i16	minuteswest;	/* minutes west of Greenwich */
	i16	dsttime;	/* dst correction */
} timezone =
{
	5*60, 1
};
