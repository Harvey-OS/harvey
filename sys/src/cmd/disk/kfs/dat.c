...
Devcall devcall[MAXDEV] = {
    [Devnone] { 0 },
    [Devwren] {
	    wreninit, wrenream, wrencheck, wrensuper, wrenroot, wrensize,
	        wrenread, wrenwrite
    },
};
...
char* errstring[MAXERR] = {
        ...
        [Ebadu] "attach -- privileged user", [Enotu] "wstat -- not owner",
        ...
        [Efidinuse] "fid already in use", [Etoolong] "name too long",
        [Ersc] "it's russ's fault.  bug him.", [Econvert] "protocol botch",
