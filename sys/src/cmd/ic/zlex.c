#include	"../cc/cc.h"
#include	"../cc/y.tab.h"
#include "/usr/miller/lib9pclient/9pclient.h"
...
_real_main(int argc, char *argv[])
{
	...
	if(argc > 1){
		print("can't compile multiple files on risc-v\n");
		errorexit();
	}
