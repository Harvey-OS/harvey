...
static void
    ptree(t, indent, shf) register struct op *t;
int indent;
...
static void
    pioact(shf, indent, iop) register struct shf *shf;
int indent;
...
static void
    vfptreef(shf, indent, fmt, va) register struct shf *shf;
int indent;
const char *fmt;
register va_list va;
{
...
struct op *
    tcopy(t, ap) register struct op *t;
Area *ap;
{
...
char *
    wdscan(wp, c) register const char *wp;
register int c;
{
	register int nest = 0;
...
static struct ioword **
    iocopy(iow, ap) register struct ioword **iow;
Area *ap;
{
...
void
    tfree(t, ap) register struct op *t;
Area *ap;
{
	register char **w;
...
static void
    iofree(iow, ap) struct ioword **iow;
Area *ap;
{
	register struct ioword **iop;
