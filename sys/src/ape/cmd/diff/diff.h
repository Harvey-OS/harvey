...
/* dir.c */
int diff_dirs PARAMS((struct file_data const[],
                      int(*) PARAMS((char const*, char const*, char const*,
                                     char const*, int)),
                      int));
...
void message5
PARAMS((char const*, char const*, char const*, char const*, char const*));
...
void print_script
PARAMS((struct change*, struct change*(*)PARAMS((struct change*)),
        void(*) PARAMS((struct change*))));
