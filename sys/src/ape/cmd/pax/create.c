...
#ifndef lint
static char* ident =
    "$Id: create.c,v 1.3 89/02/12 10:29:37 mark Exp Locker: mark $";
...
static void writetar(name, asb) char* name;
Stat* asb;
...
static void writecpio(name, asb) char* name;
Stat* asb;
...
#endif
{
	...
	sprintf(header + M_STRLEN, "%06o%06o%06o%06o%06o", USH(asb->sb_dev),
...
#endif
	        f_mtime ? asb->sb_mtime : time((time_t*)0), namelen,
	        asb->sb_size);
