 ...
 */
#define DIRENTBASESIZ (((struct dirent *)0)->d_name - (char *)&((struct dirent *)0)->d_ino)
#define DIRENTSIZ(namlen) ((DIRENTBASESIZ + sizeof(long) + (namlen)) / sizeof(long) * sizeof(long))
