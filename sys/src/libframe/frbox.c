...
void _fraddbox(Frame* f, int bn,
               int n) /* add n boxes after bn, shift the rest up,
               * box[bn+n]==box[bn] */
{
	int i;
...
int
_frfindbox(Frame* f, int bn, uint32_t p,
           uint32_t q) /* find box containing q and put q on a box boundary */
{
	Frbox* b;
