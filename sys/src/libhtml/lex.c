...
Rune* tagnames[] = {
    (Rune*)L" ",        (Rune*)L"!",        (Rune*)L"a",
    (Rune*)L"abbr",     (Rune*)L"acronym",  (Rune*)L"address",
    (Rune*)L"applet",   (Rune*)L"area",     (Rune*)L"b",
    (Rune*)L"base",     (Rune*)L"basefont", (Rune*)L"bdo",
    (Rune*)L"big",      (Rune*)L"blink",    (Rune*)L"blockquote",
    (Rune*)L"body",     (Rune*)L"bq",       (Rune*)L"br",
    (Rune*)L"button",   (Rune*)L"caption",  (Rune*)L"center",
    (Rune*)L"cite",     (Rune*)L"code",     (Rune*)L"col",
    (Rune*)L"colgroup", (Rune*)L"dd",       (Rune*)L"del",
    (Rune*)L"dfn",      (Rune*)L"dir",      (Rune*)L"div",
    (Rune*)L"dl",       (Rune*)L"dt",       (Rune*)L"em",
    (Rune*)L"fieldset", (Rune*)L"font",     (Rune*)L"form",
    (Rune*)L"frame",    (Rune*)L"frameset", (Rune*)L"h1",
    (Rune*)L"h2",       (Rune*)L"h3",       (Rune*)L"h4",
    (Rune*)L"h5",       (Rune*)L"h6",       (Rune*)L"head",
    (Rune*)L"hr",       (Rune*)L"html",     (Rune*)L"i",
    (Rune*)L"iframe",   (Rune*)L"img",      (Rune*)L"input",
    (Rune*)L"ins",      (Rune*)L"isindex",  (Rune*)L"kbd",
    (Rune*)L"label",    (Rune*)L"legend",   (Rune*)L"li",
    (Rune*)L"link",     (Rune*)L"map",      (Rune*)L"menu",
    (Rune*)L"meta",     (Rune*)L"nobr",     (Rune*)L"noframes",
    (Rune*)L"noscript", (Rune*)L"object",   (Rune*)L"ol",
    (Rune*)L"optgroup", (Rune*)L"option",   (Rune*)L"p",
    (Rune*)L"param",    (Rune*)L"pre",      (Rune*)L"q",
    (Rune*)L"s",        (Rune*)L"samp",     (Rune*)L"script",
    (Rune*)L"select",   (Rune*)L"small",    (Rune*)L"span",
    (Rune*)L"strike",   (Rune*)L"strong",   (Rune*)L"style",
    (Rune*)L"sub",      (Rune*)L"sup",      (Rune*)L"table",
    (Rune*)L"tbody",    (Rune*)L"td",       (Rune*)L"textarea",
    (Rune*)L"tfoot",    (Rune*)L"th",       (Rune*)L"thead",
    (Rune*)L"title",    (Rune*)L"tr",       (Rune*)L"tt",
    (Rune*)L"u",        (Rune*)L"ul",       (Rune*)L"var"};

// HTML 4.0 attribute names.
// Keep sorted, and in correspondence with enum in impl.h.
Rune* attrnames[] = {
    (Rune*)L"abbr", (Rune*)L"accept-charset", (Rune*)L"access-key",
    (Rune*)L"action", (Rune*)L"align", (Rune*)L"alink", (Rune*)L"alt",
    (Rune*)L"archive", (Rune*)L"axis", (Rune*)L"background", (Rune*)L"bgcolor",
    (Rune*)L"border", (Rune*)L"cellpadding", (Rune*)L"cellspacing",
    (Rune*)L"char", (Rune*)L"charoff", (Rune*)L"charset", (Rune*)L"checked",
    (Rune*)L"cite", (Rune*)L"class", (Rune*)L"classid", (Rune*)L"clear",
    (Rune*)L"code", (Rune*)L"codebase", (Rune*)L"codetype", (Rune*)L"color",
    (Rune*)L"cols", (Rune*)L"colspan", (Rune*)L"compact", (Rune*)L"content",
    (Rune*)L"coords", (Rune*)L"data", (Rune*)L"datetime", (Rune*)L"declare",
    (Rune*)L"defer", (Rune*)L"dir", (Rune*)L"disabled", (Rune*)L"enctype",
    (Rune*)L"face", (Rune*)L"for", (Rune*)L"frame", (Rune*)L"frameborder",
    (Rune*)L"headers", (Rune*)L"height", (Rune*)L"href", (Rune*)L"hreflang",
    (Rune*)L"hspace", (Rune*)L"http-equiv", (Rune*)L"id", (Rune*)L"ismap",
    (Rune*)L"label", (Rune*)L"lang", (Rune*)L"link", (Rune*)L"longdesc",
    (Rune*)L"marginheight", (Rune*)L"marginwidth", (Rune*)L"maxlength",
    (Rune*)L"media", (Rune*)L"method", (Rune*)L"multiple", (Rune*)L"name",
    (Rune*)L"nohref", (Rune*)L"noresize", (Rune*)L"noshade", (Rune*)L"nowrap",
    (Rune*)L"object", (Rune*)L"onblur", (Rune*)L"onchange", (Rune*)L"onclick",
    (Rune*)L"ondblclick", (Rune*)L"onfocus", (Rune*)L"onkeypress",
    (Rune*)L"onkeyup", (Rune*)L"onload", (Rune*)L"onmousedown",
    (Rune*)L"onmousemove", (Rune*)L"onmouseout", (Rune*)L"onmouseover",
    (Rune*)L"onmouseup", (Rune*)L"onreset", (Rune*)L"onselect",
    (Rune*)L"onsubmit", (Rune*)L"onunload", (Rune*)L"profile", (Rune*)L"prompt",
    (Rune*)L"readonly", (Rune*)L"rel", (Rune*)L"rev", (Rune*)L"rows",
    (Rune*)L"rowspan", (Rune*)L"rules", (Rune*)L"scheme", (Rune*)L"scope",
    (Rune*)L"scrolling", (Rune*)L"selected", (Rune*)L"shape", (Rune*)L"size",
    (Rune*)L"span", (Rune*)L"src", (Rune*)L"standby", (Rune*)L"start",
    (Rune*)L"style", (Rune*)L"summary", (Rune*)L"tabindex", (Rune*)L"target",
    (Rune*)L"text", (Rune*)L"title", (Rune*)L"type", (Rune*)L"usemap",
    (Rune*)L"valign", (Rune*)L"value", (Rune*)L"valuetype", (Rune*)L"version",
    (Rune*)L"vlink", (Rune*)L"vspace", (Rune*)L"width"};
...
static int getscriptdata(TokenSource* ts, int firstc, int starti, Token* a,
                         int* pai, int findtag);
...
newtokensource(uint8_t* data, int edata, int chset, int mtype)
{
	...
	assert(chset == US_Ascii || chset == ISO_8859_1 || chset == UTF_8 ||
	       chset == Unicode);
		...
		for(;;) {
			...
			if(c == '<') {
				...
				if(tag == Tscript || tag == Tstyle) {
					...
					starti = ts->i;
					c = getchar(ts);
					tag = getscriptdata(ts, c, starti, a,
					                    &ai, tag);
				}
			} else
	...
	for(c = firstc; c >= 0; c = getchar(ts)) {
		if(c == '&') {
			...
			if(isspace(c)) {
				...
				if(warn)
					fprint(2, "warning: non-whitespace "
					          "control character %d "
					          "ignored\n",
					       c);
				c = 0;
	...
	while(c >= 0) {
		if(c == '<') {
			...
			if(c == '!') {
				...
				// here tag was not the one we were looking for,
				// so take as regular data
				c = getchar(ts);
			}
		}
		if(c < 0)
...
gettag(TokenSource* ts, int starti, Token* a, int* pai)
{
	...
	attrloop_continue:
		...
		valloop_continue:
			...
			if(c == '>') {
				if(quote) {
					// c might be part of string (though not
					// good style)
...
// unless at end of file, in which case caller should just make '<' a data
// token).
static int
...
getchar(TokenSource* ts)
{
	...
	case US_Ascii:
		if(c > 127) {
			if(warn)
				fprint(2, "non-ascii char (%x) when US-ASCII "
				          "specified\n",
				       c);
		}
		ts->i++;
	...
	case UTF_8:
		...
		if(ok) {
			if(warn && c == 0x80)
				fprint(2, "warning: invalid utf-8 sequence "
				          "(starts with %x)\n",
				       ts->data[ts->i]);
			ts->i += n;
			c = r;
...
Tconv(Fmt* f)
{
	...
	if(t == nil)
		...
		tag = t->tag;
		if(tag == Data) {
			i += snprint(buf + i, sizeof(buf) - i - 1, "'%S'",
			             t->text);
		} else {
			srbra = "";
			if(tag >= RBRA) {
			...
			if(tag == Notfound)
				tname = (Rune*)L"?";
			i += snprint(buf + i, sizeof(buf) - i - 1, "<%s%S",
			             srbra, tname);
