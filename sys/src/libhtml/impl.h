...
extern void _splitl(Rune* s, int n, Rune* cl, Rune** p1, int* n1, Rune** p2,
                    int* n2);
extern void _splitr(Rune* s, int n, Rune* cl, Rune** p1, int* n1, Rune** p2,
                    int* n2);
extern int _splitall(Rune* s, int n, Rune* cl, Rune** strarr, int* lenarr,
                     int alen);
...
extern Token* _gettoks(unsigned char* data, int datalen, int chset, int mtype,
                       int* plen);
