...
static struct {
    ...
    "#S/sdC1/nvram", 0, sizeof(Nvrsafe), "pc", "#S/sdC1/9fat", -1,
    sizeof(Nvrsafe), "pc", "#S/sdD0/nvram", 0, sizeof(Nvrsafe), "pc",
    "#S/sdD0/9fat", -1, sizeof(Nvrsafe), "pc", "#S/sdE0/nvram", 0,
    sizeof(Nvrsafe), "pc", "#S/sdE0/9fat", -1, sizeof(Nvrsafe), "pc",
    "#S/sdF0/nvram", 0, sizeof(Nvrsafe), "pc", "#S/sdF0/9fat", -1,
    sizeof(Nvrsafe), "pc", "#S/sd00/nvram", 0, sizeof(Nvrsafe), "pc",
    "#S/sd00/9fat", -1, sizeof(Nvrsafe), "pc", "#S/sd01/nvram", 0,
    sizeof(Nvrsafe), "pc", "#S/sd01/9fat", -1, sizeof(Nvrsafe), "pc",
    "#S/sd10/nvram", 0, sizeof(Nvrsafe), "pc", "#S/sd10/9fat", -1,
    sizeof(Nvrsafe), "pc", "#f/fd0disk", -1,
    512, /* 512: #f requires whole sector reads */
    "pc", "#f/fd1disk", -1, 512, "mips", "#r/nvram", 1024 + 900,
    sizeof(Nvrsafe), "power", "#F/flash/flash0", 0x440000, sizeof(Nvrsafe),
    "power", "#F/flash/flash", 0x440000, sizeof(Nvrsafe), "power", "#r/nvram",
    4352, sizeof(Nvrsafe),                 /* OK for MTX-604e */
    "power", "/nvram", 0, sizeof(Nvrsafe), /* OK for Ucu */
    "arm", "#F/flash/flash0", 0x100000, sizeof(Nvrsafe), "arm",
    "#F/flash/flash", 0x100000, sizeof(Nvrsafe), "debug", "/tmp/nvram", 0,
    sizeof(Nvrsafe),
};
...
readnvram(Nvrsafe* safep, int flag)
{
	...
	if(flag & NVwritemem)
		...
		if(loc.fd >= 0)
			werrstr("");
		if(loc.fd < 0 || seek(loc.fd, loc.safeoff, 0) < 0 ||
			...
			*safep = *safe; /* overwrite arg with data read */
			...
			//			err |= check(safe->config,
			//CONFIGLEN, safe->configsum,
			//						"bad secstore
			//password");
