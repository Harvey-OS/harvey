...
#define	MACHID		0xB8000008	/* cpuid */
#define	LAUNCHADDR	0xA0003000	/* Launchpad structures */
#define	CPUIDMAP	0x80004000	/* phys to virt cpu id */
...
#define KTLBOFF	1	/* first kfault tlb entry */
#define NKTLB	3	/* number of kfault tlb entries */
#define WTLBOFF	(KTLBOFF+NKTLB)	/* first kfault tlb entry */
#define NWTLB	1	/* number of large IO window tlb entries */
