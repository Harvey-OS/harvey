 ...
 */
#define MEMTOP(phys)	((((((phys)/32)*4)/5) * 8*BY2WD) & -128)
// #define MAXMEM		(512*MB)
#define MAXMEM		(256*MB)

/* memory map for rae's virtex5 design */
#define	PHYSDRAM	0
...
#define VECBASE		PHYSDRAM  /* vectors need to be near(ish) handlers */
