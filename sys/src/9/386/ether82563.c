...
static int rbtab[] = {
    0,    9014, 1514, 9234, 9234, 8192, /* terrible performance above 8k */
    1514,
};

static char* tname[] = {
    "any", "i82563", "i82566", "i82571", "i82572", "i82573", "i82575", "i82576",
};
...
i82563txinit(Ctlr* ctlr)
{
	...
	csr32w(ctlr, Tctl, r);
	//	if(ctlr->type == i82671)
	//		csr32w(ctlr, Tarc0, csr32r(ctlr, Tarc0) | 7<<24); /* yb
	//sez? */
}
