...
enum { Nconsdevs = 64, /* max number of consoles */
...
Cmdtab rebootmsg[] = {
    CMhalt, "halt", 1, CMreboot, "reboot", 0, CMpanic, "panic", 0,
};
...
readtime(uint32_t off, char* buf, int n)
{
	...
	snprint(str, sizeof(str), "%*lud %*llud %*llud %*llud ", NUMSIZE - 1,
