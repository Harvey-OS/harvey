...
/* execac */
enum { EXTC = 0, /* exec on time-sharing */
...
struct Proc {
	...
	unsigned char
	    arg[MAXSYSARG * sizeof(void*)]; /* system call arguments */
	int nerrlab;
	Label errlab[NERR];
	...
	int preempted; /* true if this process hasn't finished the interrupt
	                ...
	                */
	Edf*
	    edf; /* if non-null, real-time proc, edf contains scheduling params
	            */
