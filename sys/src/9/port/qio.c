...
static u32 padblockcnt;
static u32 concatblockcnt;
static u32 pullupblockcnt;
static u32 copyblockcnt;
static u32 consumecnt;
static u32 producecnt;
static u32 qcopycnt;
 ...
 */
Block *
qcopy(Queue *q, int len, u32 offset)
{
	int sofar;
	int n;
	Block *b, *nb;
