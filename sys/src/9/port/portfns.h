...
void addwaitstat(uintptr pc, u64 t0, int type);
...
void edfstop(Proc *);
void edfyield(void);
int elf64ldseg(Chan *c, uintptr *entryp, Ldseg **rp, char *mach,
	       u32 minpgsz);
int emptystr(char *);
...
void pahexdump(uintptr pa, int len);
...
Proc *newproc(void);
Rgrp *newrgrp(void);
Segment *newseg(int, uintptr, u64);
...
void *phystag(u64);
void pio(Segment *, uintptr, u32, Page **, int);
void portmwait(void *);
...
void oprofile_add_backtrace(uintptr pc, uintptr fp);
void oprofile_add_userpc(uintptr pc);
