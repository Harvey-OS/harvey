/*
 * XHCI portable hardware definitions
 */
...
/*
 * XHCI interface registers and bits
 */
enum
{
	/* Ecapio->parms reg. */
	...
	Inte		= 0x00004,	/* interrupter enable */
/* old ehci bits */
	...
	Ciasync		= 0x00040,	/* intr. on async advance doorbell */
	...
	/* Debug port csw reg. */
	Cowner	= 0x40000000,		/* port owned by xhci */
