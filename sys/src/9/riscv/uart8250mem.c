...
static int
uart8250_mem_can_tx_byte(void *base)
{
	return uart8250_read(base, UART8250_LSR) & UART8250_LSR_THRE;
}

static void
uart8250_mem_tx_byte(void *base, unsigned char data)
{
...
static void
uart8250_mem_tx_flush(void *base)
{
...
static int
uart8250_mem_can_rx_byte(void *base)
{
...
static void
uart8250_mem_init(void *base, unsigned divisor)
{
	/* Disable interrupts */
...
static unsigned int
uart_baudrate_divisor(unsigned int baudrate,
...
static unsigned int
uart_platform_refclk(void)
{
	return 25 * 1000 * 1000;
}

static unsigned int
uart_input_clock_divider(void)
{
