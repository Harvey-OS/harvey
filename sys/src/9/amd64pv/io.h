...
enum { VectorNMI = 2,   /* non-maskable interrupt */
...
enum { IdtPIC = 32, /* external i8259 interrupts */
...
#define MKBUS(t, b, d, f)                                                      \
	(((t) << 24) | (((b)&0xFF) << 16) | (((d)&0x1F) << 11) |               \
	 (((f)&0x07) << 8))
...
/* capabilities */
enum { PciCapPMG = 0x01, /* power management */
       PciCapAGP = 0x02,
