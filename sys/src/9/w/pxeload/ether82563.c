...
static char* tname[] = {
    "i82563", "i82566", "i82567", "i82571",
    "i82572", "i82573", "i82575", "i82576",
};
...
i82563init(Ether* edev)
{
	...
	ctlr->rdba =
	    mallocalign(Nrdesc * sizeof(Rdesc), 256, 0, 0); /* 256 was 128 */
	...
	ctlr->tdba =
	    mallocalign(Ntdesc * sizeof(Tdesc), 256, 0, 0); /* 256 was 128 */
