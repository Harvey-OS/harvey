...
static char* diskinis[] = {"plan9/plan9.ini", "plan9.ini", 0};
static char* etherinis[] = {"/cfg/pxe/%E", 0};

#define NODISCS

Type types[] = {
    {
     Tfloppy, Fini | Ffs, floppyinit, floppyinitdev, floppygetfspart, 0,
     floppyboot, floppyprintdevs, diskparts, diskinis,
    },
#ifndef NODISCS
    {
     Tcd, Fini | Ffs, cdinit, sdinitdev, sdgetfspart, sdaddconf, sdboot,
     sdprintdevs, diskparts, diskinis,
    },
#endif /* NODISCS */
    {
     Tether, Fini | Fbootp, etherinit, etherinitdev, pxegetfspart, 0, bootpboot,
     etherprintdevs, etherparts, etherinis,
    },
#ifndef NODISCS
    {
     Tsd, Fini | Ffs, sdinit, sdinitdev, sdgetfspart, sdaddconf, sdboot,
     sdprintdevs, diskparts, diskinis,
    },
#endif /* NODISCS */
    {
     Tnil, 0, nil, nil, nil, nil, nil, nil, nil, nil, 0, nil,
    },
};
...
SDifc* sdifc[] = {
    &sdataifc, &sdmylexifc, &sd53c8xxifc, nil,
};
...
static Mode modes[NMode + 1] = {
    [Mauto] { "auto", Mauto, }, [Mlocal] { "local", Mlocal, },
...
warp9(uint32_t entry)
{
	...
	(*(void(*)(void*, void*, void*, void*, ulong, ulong))(PADDR(entry)))(0,
	0, 0, 0, 8196, 640);
