...
int	gettlbp(u64int, u64int*);
u64int	gettlbvirt(int);
...
void	purgetlb(int);
Softtlb*	putstlb(u64int, u64int);
int	puttlb(u64int, u64int, u64int);
void	puttlbx(int, u64int, u64int, u64int, int);
...
void	syncclock(void);
uintptr	syscall(Ureg*);
void	syscallfmt(int syscallno, uintptr pc, va_list list);
void	sysretfmt(int syscallno, va_list list, uintptr ret, uvlong start, uvlong stop);
int	tas(ulong*);
void	tlbinit(void);
u64int	tlbvirt(void);
void	touser(uintptr);
...
#define KADDR(a)	((void*)((uintptr)(a)|KSEG0))
#define PADDR(a)	((uintptr)(a)&~KSEGM)
