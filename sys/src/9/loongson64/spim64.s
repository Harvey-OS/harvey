...
#define TOKSEG0(r)	MOVV $ret0(SB), R(r); JALR(22, r)
#define TOKSEG1(r)	MOVV $ret1(SB), R(r); OR $KSEG1, R(r); JALR(22, r)
...
#define PUTC(c, r1, r2)	CONST(PHYSCONS, r1); MOVV $(c), r2; MOVBU r2, (r1); NOP
