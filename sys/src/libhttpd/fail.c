...
Error errormsg[] = {
    [HInternal] {
	    "500 Internal Error", "Internal Error", "This server could not "
	                                            "process your request due "
	                                            "to an internal error."
    },
    [HTempFail] {
	    "500 Internal Error", "Temporary Failure",
	        "The object %s is currently inaccessible.<p>Please try again "
	        "later."
    },
    [HUnimp] {
    ...
    [HUnkVers] {
	    "501 Not Implemented", "Unknown http version",
	        "This server does not know how to respond to http version %s."
    },
    [HBadCont] {
	    "501 Not Implemented", "Impossible format",
	        "This server cannot produce %s in any of the formats your "
	        "client accepts."
    },
    [HBadReq] {
	    "400 Bad Request", "Strange Request", "Your client sent a query "
	                                          "that this server could not "
	                                          "understand."
    },
    [HSyntax] {
	    "400 Bad Request", "Garbled Syntax",
	        "Your client sent a query with incoherent syntax."
    },
    [HBadSearch] {
	    "400 Bad Request", "Inapplicable Search",
    ...
    [HNoSearch] {
	    "403 Forbidden", "Search not supported",
	        "The object %s does not support the search command."
    },
    [HNoData] {
	    "403 Forbidden", "No data supplied",
	        "Search or forms data must be supplied to %s."
    },
    [HExpectFail] {
	    "403 Expectation Failed", "Expectation Failed",
	        "This server does not support some of your request's "
	        "expectations."
    },
    [HUnauth] {
...
hfail(HConnect* c, int reason, ...)
{
	...
	n = snprint(c->xferbuf, HBufSize,
	            ...
	            err, (c->req.urihost ? c->req.urihost : ""), c->head.host,
	            hmydomain);
