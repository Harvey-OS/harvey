...
static int
_scsicmd(Scsi *s, u8 *cmd, int ccount, void *data, int dcount,
	 int io, int dolock)
{
	u8 resp[16];
	int n;
...
int
scsicmd(Scsi *s, u8 *cmd, int ccount, void *data, int dcount, int io)
{
...
int
scsi(Scsi *s, u8 *cmd, int ccount, void *v, int dcount, int io)
{
	u8 req[6], sense[255], *data;
