...
void
memfillpoly(Memimage* dst, Point* vert, int nvert, int w, Memimage* src,
            Point sp, int op)
{
...
void
_memfillpolysc(Memimage* dst, Point* vert, int nvert, int w, Memimage* src,
