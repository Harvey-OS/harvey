...
static void
horliner(Memimage* dst, Point p0, Point p1, Memimage* src, Point dsrc,
         Rectangle clipr)
{
...
static void
verliner(Memimage* dst, Point p0, Point p1, Memimage* src, Point dsrc,
         Rectangle clipr)
{
...
static void
horline(Memimage* dst, Point p0, Point p1, Memimage* src, Point dsrc,
        Rectangle clipr)
{
...
static void
verline(Memimage* dst, Point p0, Point p1, Memimage* src, Point dsrc,
        Rectangle clipr)
{
...
arrowend(Point tip, Point* pp, int end, int sin, int cos, int radius)
{
	...
	if(end == Endarrow) {
		...
		x3 =
		    (end >> 23) &
		    0x1FF; /* distance perpendicular from edge of line to barb
		              */
	}
...
void
_memimageline(Memimage* dst, Point p0, Point p1, int end0, int end1, int radius,
              Memimage* src, Point sp, Rectangle clipr, int op)
{
	/*
	...
	case Endarrow:
		...
		_memfillpolysc(dst, pp, 5, ~0, src,
		               addpt(pp[0], mulpt(d, ICOSSCALE)), 1, 10, 1, op);
		pp[1] = pp[4];
		pp += 2;
	}
