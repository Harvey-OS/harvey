...
%token	<hp>	INPUTS OUTPUTS EXTERNS FIELDS FUNCS INPUT OUTPUT
%token	<hp>	EQNS EQN TYPES CEQN BOTH BOTHS BURIEDS BURIED ITER YUSED
%token	<hp>	NAME EXTERN FIELD FNCS
...
fdcl:
	NAME '=' { SETLO($1, nextfield); $1->code = FIELD; } ulist
	{
		SETHI($1, nextfield);
	}
