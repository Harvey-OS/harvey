...
void*
insertkey(Intmap *map, u32 id, void *v)
{
	Intlist *f;
	void *ov;
	u32 h;
...
int
caninsertkey(Intmap *map, u32 id, void *v)
{
	Intlist *f;
	int rv;
	u32 h;
