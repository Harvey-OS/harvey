...
/*
 * strcmp of utf treats bytes as unsigned, so some of the signedness tests
 * are wrong.
 */
#undef	NO_UTF
#define	PLAN9			/* definitions differ slightly from unix */
