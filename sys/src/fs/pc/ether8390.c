...
dp8390intr(Ureg *ur, Ctlr *ctlr)
{
	...
	while(isr = dp8390inb(dp8390+Isr)){
		...
		if(isr & Cnt){
			ctlr->ifc.rcverr += dp8390inb(dp8390+Cntr0);
			ctlr->ifc.sumerr += dp8390inb(dp8390+Cntr1);
			ctlr->ifc.rcverr += dp8390inb(dp8390+Cntr2);
