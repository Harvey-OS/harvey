 ...
 *	fn == 0 && var != 0	=> look for var first in text then in data
 *space.
 */
int
...
/*
 * Find text symbol containing addr; binary search assumes text array is sorted
 * by addr
 */
static int
...
/*
 * Find data symbol containing addr; binary search assumes data array is sorted
 * by addr
 */
static int
