...
static Opcode opcodes[64] = {
	...
	"BLEZL",   branch,	0,
	"BGTZL",   branch,	0,
	"instr18",	0,	mipscoxxx,	/* DADDI */
	"instr19",	0,	mipscoxxx,	/* DADDIU */
	"MOVVL",     load,	mipsload,
	"MOVVR",     load,	mipsload,
	"instr1C",	0,	mipscoxxx,
	"instr1D",	0,	mipscoxxx,	/* JALX */
	"instr1E",	0,	mipscoxxx,	/* MDMX */
	"instr1F",	0,	mipscoxxx,
	"MOVB",	     load,	mipsload,
	"MOVH",	     load,	mipsload,
	"lwl",		0,	mipscoload,
