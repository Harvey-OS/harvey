...
static void
dopoly(int cmd, Image* dst, Point* pp, int np, int end0, int end1, int radius,
...
void
poly(Image* dst, Point* p, int np, int end0, int end1, int radius, Image* src,
     Point sp)
{
...
void
polyop(Image* dst, Point* p, int np, int end0, int end1, int radius, Image* src,
       Point sp, Drawop op)
{
...
void
fillpolyop(Image* dst, Point* p, int np, int wind, Image* src, Point sp,
           Drawop op)
{
