...
int
bezier(Image* dst, Point p0, Point p1, Point p2, Point p3, int end0, int end1,
...
int
bezierop(Image* dst, Point p0, Point p1, Point p2, Point p3, int end0, int end1,
...
int
bezspline(Image* dst, Point* pt, int npt, int end0, int end1, int radius,
          Image* src, Point sp)
{
...
int
bezsplineop(Image* dst, Point* pt, int npt, int end0, int end1, int radius,
...
int
fillbezier(Image* dst, Point p0, Point p1, Point p2, Point p3, int w,
           Image* src, Point sp)
{
...
int
fillbezierop(Image* dst, Point p0, Point p1, Point p2, Point p3, int w,
             Image* src, Point sp, Drawop op)
{
	Plist l;
...
int
fillbezsplineop(Image* dst, Point* pt, int npt, int w, Image* src, Point sp,
                Drawop op)
{
	Plist l;
