...
void
fillellipseop(Image* dst, Point c, int a, int b, Image* src, Point sp,
              Drawop op)
{
...
void
arc(Image* dst, Point c, int a, int b, int thick, Image* src, Point sp,
    int alpha, int phi)
{
	alpha |= 1 << 31;
...
void
arcop(Image* dst, Point c, int a, int b, int thick, Image* src, Point sp,
...
void
fillarc(Image* dst, Point c, int a, int b, Image* src, Point sp, int alpha,
        int phi)
{
	alpha |= 1 << 31;
