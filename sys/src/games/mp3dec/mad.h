...
#define MAD_VERSION MAD_VERSION_STRING(MAD_VERSION_MAJOR) "." MAD_VERSION_STRING(MAD_VERSION_MINOR) "." MAD_VERSION_STRING(MAD_VERSION_PATCH) \
    MAD_VERSION_EXTRA
...
#define MAD_NSBSAMPLES(header)                                                         \
	((header)->layer == MAD_LAYER_I ? 12 : (((header)->layer == MAD_LAYER_III &&   \
