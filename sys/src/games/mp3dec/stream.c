 ...
 */
void
mad_stream_init(struct mad_stream* stream)
{
	stream->buffer = 0;
	stream->bufend = 0;
	stream->skiplen = 0;
 ...
 */
void
mad_stream_buffer(struct mad_stream* stream, unsigned char const* buffer,
 ...
 */
void
mad_stream_skip(struct mad_stream* stream, unsigned long length)
{
 ...
 */
int
mad_stream_sync(struct mad_stream* stream)
{
 ...
 */
char const*
mad_stream_errorstr(struct mad_stream const* stream)
{
	switch(stream->error) {
	case MAD_ERROR_NONE:
		return "no error";
