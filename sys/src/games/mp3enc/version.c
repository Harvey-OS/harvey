...
/* Here we can also add informations about compile time configurations */
	...
	static /*@observer@*/ const char* const str =
	    XSTR(LAME_MAJOR_VERSION) "." XSTR(
	        LAME_MINOR_VERSION) " " V
	                            "(alpha " XSTR(
	                                LAME_ALPHA_VERSION) ", " __DATE__
	                                                    " " __TIME__ ")";
...
get_psy_version(void)
{
	...
	static /*@observer@*/ const char* const str =
	    XSTR(PSY_MAJOR_VERSION) "." XSTR(PSY_MINOR_VERSION) " (alpha " XSTR(
	        PSY_ALPHA_VERSION) ", " __DATE__ " " __TIME__ ")";
#elif PSY_BETA_VERSION > 0
	static /*@observer@*/ const char* const str =
	    XSTR(PSY_MAJOR_VERSION) "." XSTR(PSY_MINOR_VERSION) " (beta " XSTR(
	        PSY_BETA_VERSION) ", " __DATE__ ")";
#else
	static /*@observer@*/ const char* const str =
...
get_mp3x_version(void)
{
	...
	static /*@observer@*/ const char* const str =
	    XSTR(MP3X_MAJOR_VERSION) "." XSTR(
	        MP3X_MINOR_VERSION) " (alpha " XSTR(MP3X_ALPHA_VERSION) ","
	                                                                " " __DATE__
	                                                                " " __TIME__
	                                                                ")";
	...
	static /*@observer@*/ const char* const str =
	    XSTR(MP3X_MAJOR_VERSION) "." XSTR(
	        MP3X_MINOR_VERSION) " (beta " XSTR(MP3X_BETA_VERSION) ","
	                                                              " " __DATE__
	                                                              ")";
#else
	static /*@observer@*/ const char* const str =
