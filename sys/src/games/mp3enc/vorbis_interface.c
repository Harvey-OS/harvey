...
int
lame_decode_ogg_initfile(lame_global_flags *gfp,
			 FILE *fd,
...
*/
int
lame_decode_ogg_fromfile(lame_global_flags *gfp,
			 FILE *fd,
			 short int pcm_l[],
			 short int pcm_r[],
			 mp3data_struct *mp3data)
...
int
lame_encode_ogg_finish(lame_global_flags *gfp,
