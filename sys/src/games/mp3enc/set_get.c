...
int
lame_set_disable_waveheader(lame_global_flags* gfp, int disable_waveheader)
{
	/* default = 0 (disabled) */
...
int lame_set_padding_type(lame_global_flags* gfp, int padding_type);
int lame_get_padding_type(const lame_global_flags* gfp);
...
int lame_set_strict_ISO(lame_global_flags* gfp, int strict_ISO);
...
vbr_mode lame_get_exp_VBR(const lame_global_flags* gfp);
...
int lame_set_VBR_mean_bitrate_kbps(lame_global_flags* gfp,
                                   int VBR_mean_bitrate_kbps);
int lame_get_VBR_mean_bitrate_kbps(const lame_global_flags* gfp);

int lame_set_VBR_min_bitrate_kbps(lame_global_flags* gfp,
                                  int VBR_min_bitrate_kbps);
int lame_get_VBR_min_bitrate_kbps(const lame_global_flags* gfp);

int lame_set_VBR_max_bitrate_kbps(lame_global_flags* gfp,
