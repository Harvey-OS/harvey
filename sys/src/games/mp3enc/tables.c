...
static const i16      t1HB[]   = {
  1, 1,
  1, 0};

static const i16      t2HB[]   = {
  1, 2, 1,
  3, 1, 1,
  3, 2, 0};

static const i16      t3HB[]   = {
  3, 2, 1,
  1, 1, 1,
  3, 2, 0};

static const i16      t5HB[]   = {
  1, 2, 6, 5,
  3, 1, 4, 4,
  7, 5, 7, 1,
  6, 1, 1, 0};

static const i16      t6HB[]   = {
  7, 3, 5, 1,
  6, 2, 3, 2,
  5, 4, 4, 1,
  3, 3, 2, 0};

static const i16      t7HB[]   = {
   1, 2,10,19,16,10,
   3, 3, 7,10, 5, 3,
  11, 4,13,17, 8, 4,
  12,11,18,15,11, 2,
...
static const i16      t32HB[]   = {
  1 << 0,  5 << 1,  4 << 1,  5 << 2,  6 << 1,  5 << 2,  4 << 2,  4 << 3,
  7 << 1,  3 << 2,  6 << 2,  0 << 3,  7 << 2,  2 << 3,  3 << 3,  1 << 4};

static const i16      t33HB[]   = {
