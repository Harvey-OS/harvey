...
int bin_search_StepSize(lame_internal_flags* gfc, gr_info* cod_info,
                        int desired_rate, int start, const FLOAT8 xrpow[576],
                        int l3enc[576]);
...
int calc_noise(const lame_internal_flags* gfc, const FLOAT8 xr[576],
               ...
               const III_psy_xmin* l3_xmin, const III_scalefac_t* scalefac,
...
int scale_bitcount_lsf(const lame_internal_flags* gfp,
                       const III_scalefac_t* scalefac, gr_info* cod_info);
