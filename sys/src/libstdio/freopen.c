 ...
 * Legal modes are given below, `additional characters may follow these
 * sequences':
 * r rb		open to read
 ...
 * a+ a+b ab+	open to read and write, positioned at eof, creating if
 * non-existant.
 */
FILE*
freopen(const char* name, const char* mode, FILE* f)
{
	int m;
