 ...
 * Image management
 */
extern Image* _allocimage(Image*, Display*, Rectangle, uint32_t, int, uint32_t,
                          int, int);
extern Image* allocimage(Display*, Rectangle, uint32_t, int, uint32_t);
...
extern int geninitdraw(char*, void (*)(Display*, char*), char*, char*, char*,
                       int);
...
extern Point stringbgop(Image*, Point, Image*, Point, Font*, char*, Image*,
                        Point, Drawop);
extern Point stringnbg(Image*, Point, Image*, Point, Font*, char*, int, Image*,
                       Point);
extern Point stringnbgop(Image*, Point, Image*, Point, Font*, char*, int,
                         Image*, Point, Drawop);
extern Point runestringbg(Image*, Point, Image*, Point, Font*, Rune*, Image*,
                          Point);
extern Point runestringbgop(Image*, Point, Image*, Point, Font*, Rune*, Image*,
                            Point, Drawop);
extern Point runestringnbg(Image*, Point, Image*, Point, Font*, Rune*, int,
                           Image*, Point);
extern Point runestringnbgop(Image*, Point, Image*, Point, Font*, Rune*, int,
                             Image*, Point, Drawop);
extern Point _string(Image*, Point, Image*, Point, Font*, char*, Rune*, int,
                     Rectangle, Image*, Point, Drawop);
...
extern int fillbezierop(Image*, Point, Point, Point, Point, int, Image*, Point,
                        Drawop);
...
extern int cachechars(Font*, char**, Rune**, uint16_t*, int, int*, char**);
