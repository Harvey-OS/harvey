...
enum { AESbsize = 16, AESmaxkey = 32, AESmaxrounds = 14 };
...
enum { SHA1dlen = 20,     /* SHA digest length */
...
DigestState*
hmac_x(uint8_t* p, uint32_t len, uint8_t* key, uint32_t klen, uint8_t* digest,
       DigestState* s,
       DigestState* (*x)(uint8_t*, uint32_t, uint8_t*, DigestState*), int xlen);
DigestState* hmac_md5(uint8_t*, uint32_t, uint8_t*, uint32_t, uint8_t*,
                      DigestState*);
DigestState* hmac_sha1(uint8_t*, uint32_t, uint8_t*, uint32_t, uint8_t*,
                       DigestState*);
DigestState* hmac_sha2_224(uint8_t*, uint32_t, uint8_t*, uint32_t, uint8_t*,
                           DigestState*);
DigestState* hmac_sha2_256(uint8_t*, uint32_t, uint8_t*, uint32_t, uint8_t*,
                           DigestState*);
DigestState* hmac_sha2_384(uint8_t*, uint32_t, uint8_t*, uint32_t, uint8_t*,
                           DigestState*);
DigestState* hmac_sha2_512(uint8_t*, uint32_t, uint8_t*, uint32_t, uint8_t*,
                           DigestState*);
DigestState* hmac_aes(uint8_t*, uint32_t, uint8_t*, uint32_t, uint8_t*,
                      DigestState*);
 ...
 * primes
 */
void genprime(mpint* p, int n,
              int accuracy); /* generate n-bit probable prime */
void gensafeprime(mpint* p, mpint* alpha, int n,
                  int accuracy); /* prime & generator */
void genstrongprime(mpint* p, int n,
                    int accuracy); /* generate n-bit strong prime */
...
uint8_t* X509gen(RSApriv* priv, char* subj, uint32_t valid[2], int* certlen);
...
typedef struct TLSconn {
	...
	int sessionIDlen;
	int (*trace)(char* fmt, ...);
	PEMChain* chain; /* optional extra certificate evidence for servers to
	                    present */
	char* sessionType;
	uint8_t* sessionKey;
	int sessionKeylen;
