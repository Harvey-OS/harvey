...
/*
extern int64_t  gzseek (gzFile file,
...
/*
extern int64_t     gztell (gzFile file);
...
/*
extern int64_t  gzoffset (gzFile file);
...
extern uLong  adler32_combine (uLong adler1, uLong adler2,
   ...
   that the int64_t type (like off_t) is a signed integer.  If len2 is
...
/*
extern uLong  crc32_combine (uLong crc1, uLong crc2, int64_t len2);
 ...
 */
   ...
   extern int64_t  gzseek64 (gzFile, int64_t, int);
   extern int64_t  gztell64 (gzFile);
   extern int64_t  gzoffset64 (gzFile);
   extern uLong  adler32_combine64 (uLong, uLong, int64_t);
   extern uLong  crc32_combine64 (uLong, uLong, int64_t);
#endif
