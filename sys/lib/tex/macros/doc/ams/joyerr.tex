%  JOYERR.TEX                                           February 1990
%
%  This file contains errata to The Joy of TeX, 1986 edition.
%  It must be run with AMSTEX and AMSPPT 2.0; it is incompatible with
%  previous versions.  It also requires the file AMSSYM.TEX and the
%  fonts MSAM10 and MSBM10.
%
