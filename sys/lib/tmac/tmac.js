.\" this was consistent with tmac.s as of April, 1987
.\" and with the awk book version about the same time.
.\" this calls special versions of tmac.sdisp and tmac.skeep.
.\" output is automatically piped through /usr/lib/tmac/pj.
.\"
.pi /usr/lib/tmac/pj
.lg 0
.\"	X - the nameless macro that adds paddable space
.de X
.ie '\\n(.z'' \\!x X \\$1 \\$2 \\$3
.el \\!.X \\$1 \\$2 \\$3
..
.\"	SP - explicit paddable whitespace
.de SP
.if \\n(.$ .sp \\$1
.if \\n(.$ .nr X \\$1v   \" was just \\$1!
.if \\n(.$ .X "SP \\nX SP
...
.if \\n($1>0 .sp .65
..
.\" parameters for P1 and P2... watch out
.nr P1 .4i	\" program indent in .P1
.nr dP 1	\" delta point size for program (was 2, 2.5)
.nr dV 2p	\" delta vertical for programs
.nr dT 5	\" delta tab stop for programs
.\"	P1 - beginning of program in CW font
.de P1
.nr P1 .4i	\" program indent in .P1
.if \\n(.$ .nr P1 \\$1
.br
