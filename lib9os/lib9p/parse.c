...
parsecmd9(char *p, int n)
{
	...
	/* allocate Cmdbuf9 plus string pointers plus copy of string including \0 */
 ...
 */
void
respondcmderror(Req *r, Cmdbuf9 *cb, char *fmt, ...)
{
	int i;
	va_list arg;
	char *p, *e;
 ...
 */
Cmdtab9*
lookupcmd9(Cmdbuf9 *cb, Cmdtab9 *ctab, int nctab)
{
	int i;
	Cmdtab9 *ct;
