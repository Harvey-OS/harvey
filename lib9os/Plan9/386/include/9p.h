#pragma	lib	"/usr/lib9os/Plan9/386/lib/lib9p.a"
/*
 ...
 */
typedef struct Cmdbuf9 Cmdbuf9;
typedef struct Cmdtab9 Cmdtab9;
Cmdbuf9*		parsecmd9(char *a, int n);
void		respondcmderror(Req*, Cmdbuf9*, char*, ...);
Cmdtab9*	lookupcmd9(Cmdbuf9*, Cmdtab9*, int);
