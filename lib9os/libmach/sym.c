...
#define	MAXDOM	256		/* probably too small, but it's a start */
...
// processes will die in the course of an execution context and we want to be able to see what is going on.
static int ndom; /* number of active domains */
struct dom {
